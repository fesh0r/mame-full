...
INPUT_PORTS_START( pc_joystick )
	...
	PORT_START	/* IN16 */
	PORT_ANALOGX(0xff,0x80,IPT_AD_STICK_X,100,1,1,0xff,KEYCODE_LEFT,KEYCODE_RIGHT,JOYCODE_1_LEFT,JOYCODE_1_RIGHT) PORT_REVERSE PORT_CENTER
		
	PORT_START /* IN17 */
	PORT_ANALOGX(0xff,0x80,IPT_AD_STICK_Y,100,1,1,0xff,KEYCODE_UP,KEYCODE_DOWN,JOYCODE_1_UP,JOYCODE_1_DOWN) PORT_REVERSE PORT_CENTER

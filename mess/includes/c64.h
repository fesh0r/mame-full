...
#define C64_DIPS \
	...
	PORT_ANALOGX(0xff,128,IPT_PADDLE, 30,20,0,255,KEYCODE_LEFT,KEYCODE_RIGHT, JOYCODE_1_LEFT,JOYCODE_1_RIGHT) PORT_REVERSE\
	PORT_START \
	PORT_BIT( 0x100, IP_ACTIVE_HIGH, IPT_BUTTON2) PORT_NAME("Paddle 2 Button") PORT_CODE(KEYCODE_LALT) PORT_CODE(JOYCODE_1_BUTTON2)\
	PORT_ANALOGX(0xff,128,IPT_PADDLE,30,20,0,255,KEYCODE_DOWN,KEYCODE_UP,JOYCODE_1_UP,JOYCODE_1_DOWN) PORT_PLAYER(2) PORT_REVERSE\
	PORT_START \
	...
	/*PORT_ANALOGX(0x1ff,0,IPT_PADDLE,30,2,0,320-1,KEYCODE_LEFT,KEYCODE_RIGHT,JOYCODE_1_LEFT,JOYCODE_1_RIGHT) PORT_PLAYER(1)*/\
     PORT_START \
	PORT_BIT( 0x7e, 0x00, IPT_TRACKBALL_Y) PORT_SENSITIVITY(100) PORT_KEYDELTA(0) PORT_MINMAX(0,0)  PORT_PLAYER(1) PORT_REVERSE\
     /*PORT_ANALOGX(0xff,0,IPT_PADDLE,30,2,0,200-1,KEYCODE_UP,KEYCODE_DOWN,JOYCODE_1_UP,JOYCODE_1_DOWN) PORT_PLAYER(2)*/\
	PORT_START \

...
#define QUICKLOAD		(input_port_8_r(0)&0x8000)
#define DATASSETTE (input_port_8_r(0)&0x4000)
#define DATASSETTE_TONE (input_port_8_r(0)&0x2000)
...
#define KEY_ARROW_LEFT (input_port_9_r(0)&0x8000)
#define KEY_1 (input_port_9_r(0)&0x4000)
#define KEY_2 (input_port_9_r(0)&0x2000)
#define KEY_3 (input_port_9_r(0)&0x1000)
#define KEY_4 (input_port_9_r(0)&0x800)
#define KEY_5 (input_port_9_r(0)&0x400)
#define KEY_6 (input_port_9_r(0)&0x200)
#define KEY_7 (input_port_9_r(0)&0x100)
#define KEY_8 (input_port_9_r(0)&0x80)
#define KEY_9 (input_port_9_r(0)&0x40)
#define KEY_0 (input_port_9_r(0)&0x20)
#define KEY_PLUS (input_port_9_r(0)&0x10)
#define KEY_MINUS (input_port_9_r(0)&8)
#define KEY_POUND (input_port_9_r(0)&4)
#define KEY_HOME (input_port_9_r(0)&2)
#define KEY_DEL (input_port_9_r(0)&1)

#define KEY_CTRL (input_port_10_r(0)&0x8000)
#define KEY_Q (input_port_10_r(0)&0x4000)
#define KEY_W (input_port_10_r(0)&0x2000)
#define KEY_E (input_port_10_r(0)&0x1000)
#define KEY_R (input_port_10_r(0)&0x800)
#define KEY_T (input_port_10_r(0)&0x400)
#define KEY_Y (input_port_10_r(0)&0x200)
#define KEY_U (input_port_10_r(0)&0x100)
#define KEY_I (input_port_10_r(0)&0x80)
#define KEY_O (input_port_10_r(0)&0x40)
#define KEY_P (input_port_10_r(0)&0x20)
#define KEY_ATSIGN (input_port_10_r(0)&0x10)
#define KEY_ASTERIX (input_port_10_r(0)&8)
#define KEY_ARROW_UP (input_port_10_r(0)&4)
#define KEY_RESTORE (input_port_10_r(0)&2)
#define KEY_STOP (input_port_10_r(0)&1)

#define KEY_SHIFTLOCK (input_port_11_r(0)&0x8000)
#define KEY_A (input_port_11_r(0)&0x4000)
#define KEY_S (input_port_11_r(0)&0x2000)
#define KEY_D (input_port_11_r(0)&0x1000)
#define KEY_F (input_port_11_r(0)&0x800)
#define KEY_G (input_port_11_r(0)&0x400)
#define KEY_H (input_port_11_r(0)&0x200)
#define KEY_J (input_port_11_r(0)&0x100)
#define KEY_K (input_port_11_r(0)&0x80)
#define KEY_L (input_port_11_r(0)&0x40)
#define KEY_SEMICOLON (input_port_11_r(0)&0x20)
#define KEY_COLON (input_port_11_r(0)&0x10)
#define KEY_EQUALS (input_port_11_r(0)&8)
#define KEY_RETURN (input_port_11_r(0)&4)
#define KEY_CBM (input_port_11_r(0)&2)
#define KEY_LEFT_SHIFT ((input_port_11_r(0)&1)||KEY_SHIFTLOCK)

#define KEY_Z (input_port_12_r(0)&0x8000)
#define KEY_X (input_port_12_r(0)&0x4000)
#define KEY_C (input_port_12_r(0)&0x2000)
#define KEY_V (input_port_12_r(0)&0x1000)
#define KEY_B (input_port_12_r(0)&0x800)
#define KEY_N (input_port_12_r(0)&0x400)
#define KEY_M (input_port_12_r(0)&0x200)
#define KEY_COMMA (input_port_12_r(0)&0x100)
#define KEY_POINT (input_port_12_r(0)&0x80)
#define KEY_SLASH (input_port_12_r(0)&0x40)
#define KEY_RIGHT_SHIFT ((input_port_12_r(0)&0x20)\
			 ||KEY_CURSOR_UP||KEY_CURSOR_LEFT)
#define KEY_CURSOR_DOWN ((input_port_12_r(0)&0x10)||KEY_CURSOR_UP)
#define KEY_CURSOR_RIGHT ((input_port_12_r(0)&8)||KEY_CURSOR_LEFT)
#define KEY_SPACE (input_port_12_r(0)&4)
#define KEY_F1 (input_port_12_r(0)&2)
#define KEY_F3 (input_port_12_r(0)&1)

#define KEY_F5 (input_port_13_r(0)&0x8000)
#define KEY_F7 (input_port_13_r(0)&0x4000)
#define KEY_CURSOR_UP (input_port_13_r(0)&0x2000)
#define KEY_CURSOR_LEFT (input_port_13_r(0)&0x1000)

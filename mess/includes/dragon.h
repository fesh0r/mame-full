...
extern int coco_cassette_init(int id, mame_file *fp, int open_mode);
extern int coco3_cassette_init(int id);
extern int coco_rom_load(int id, mame_file *fp, int open_mode);
extern int coco3_rom_load(int id, mame_file *fp, int open_mode);
...
extern int coco_vhd_init(int id, mame_file *fp, int open_mode);

...
INPUT_PORTS_START(ti99_8)
	...
	PORT_START    /* col 0 */
		...
		PORT_KEY1(0x02, IP_ACTIVE_LOW, "LSHIFT", KEYCODE_LSHIFT, CODE_NONE,	UCHAR_SHIFT_1)
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 1 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "1 ! DEL", KEYCODE_1, CODE_NONE,		'1',	'!')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "q Q", KEYCODE_Q, CODE_NONE,			'q',	'Q')
		PORT_KEY2(0x04, IP_ACTIVE_LOW, "a A", KEYCODE_A, CODE_NONE,			'a',	'A')
		PORT_KEY2(0x02, IP_ACTIVE_LOW, "z Z", KEYCODE_Z, CODE_NONE,			'z',	'Z')
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 2 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "2 @ INS", KEYCODE_2, CODE_NONE,		'2',	'@')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "w W", KEYCODE_W, CODE_NONE,			'w',	'W')
		PORT_KEY2(0x04, IP_ACTIVE_LOW, "s S (LEFT)", KEYCODE_S, CODE_NONE,	's',	'S')
		PORT_KEY2(0x02, IP_ACTIVE_LOW, "x X (DOWN)", KEYCODE_X, CODE_NONE,	'x',	'X')
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 3 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "3 #", KEYCODE_3, CODE_NONE,			'3',	'#')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "e E (UP)", KEYCODE_E, CODE_NONE,		'e',	'E')
		PORT_KEY2(0x04, IP_ACTIVE_LOW, "d D (RIGHT)", KEYCODE_D, CODE_NONE,	'd',	'D')
		PORT_KEY2(0x02, IP_ACTIVE_LOW, "c C", KEYCODE_C, CODE_NONE,			'c',	'C')
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 4 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "4 $ CLEAR", KEYCODE_4, CODE_NONE,		'4',	'$')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "r R", KEYCODE_R, CODE_NONE,			'r',	'R')
		PORT_KEY2(0x04, IP_ACTIVE_LOW, "f F", KEYCODE_F, CODE_NONE,			'f',	'F')
		PORT_KEY2(0x02, IP_ACTIVE_LOW, "v V", KEYCODE_V, CODE_NONE,			'v',	'V')
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 5 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "5 % BEGIN", KEYCODE_5, CODE_NONE,		'5',	'%')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "t T", KEYCODE_T, CODE_NONE,			't',	'T')
		PORT_KEY2(0x04, IP_ACTIVE_LOW, "g G", KEYCODE_G, CODE_NONE,			'g',	'G')
		PORT_KEY2(0x02, IP_ACTIVE_LOW, "b B", KEYCODE_B, CODE_NONE,			'b',	'B')
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 6 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "6 ^ PROC'D", KEYCODE_6, CODE_NONE,	'6',	'^')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "y Y", KEYCODE_Y, CODE_NONE,			'y',	'Y')
		PORT_KEY2(0x04, IP_ACTIVE_LOW, "h H", KEYCODE_H, CODE_NONE,			'h',	'H')
		PORT_KEY2(0x02, IP_ACTIVE_LOW, "n N", KEYCODE_N, CODE_NONE,			'n',	'N')
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 7 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "7 & AID", KEYCODE_7, CODE_NONE,		'7',	'&')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "u U", KEYCODE_U, CODE_NONE,			'u',	'U')
		PORT_KEY2(0x04, IP_ACTIVE_LOW, "j J", KEYCODE_J, CODE_NONE,			'j',	'J')
		PORT_KEY2(0x02, IP_ACTIVE_LOW, "m M", KEYCODE_M, CODE_NONE,			'm',	'M')
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 8 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "8 * REDO", KEYCODE_8, CODE_NONE,		'8',	'*')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "i I", KEYCODE_I, CODE_NONE,			'i',	'I')
		PORT_KEY2(0x04, IP_ACTIVE_LOW, "k K", KEYCODE_K, CODE_NONE,			'k',	'K')
		PORT_KEY2(0x02, IP_ACTIVE_LOW, ", <", KEYCODE_COMMA, CODE_NONE,		',',	'<')
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 9 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "9 ( BACK", KEYCODE_9, CODE_NONE,		'9',	'(')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "o O", KEYCODE_O, CODE_NONE,			'o',	'O')
		PORT_KEY2(0x04, IP_ACTIVE_LOW, "l L", KEYCODE_L, CODE_NONE,			'l',	'L')
		PORT_KEY2(0x02, IP_ACTIVE_LOW, ". >", KEYCODE_STOP, CODE_NONE,		'.',	'>')
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 10 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "0 )", KEYCODE_0, CODE_NONE,			'0',	')')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "p P", KEYCODE_P, CODE_NONE,			'p',	'P')
		PORT_KEY2(0x04, IP_ACTIVE_LOW, "; :", KEYCODE_COLON, CODE_NONE,		';',	':')
		PORT_KEY2(0x02, IP_ACTIVE_LOW, "/ ?", KEYCODE_SLASH, CODE_NONE,		'/',	'?')
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 11 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "= + QUIT", KEYCODE_EQUALS, CODE_NONE,	'=',	'+')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "[ {", KEYCODE_OPENBRACE, CODE_NONE,	'[',	'{')
	...
	PORT_START    /* col 12 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "- _", KEYCODE_MINUS, CODE_NONE,		'-',	'_')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "] }", KEYCODE_CLOSEBRACE, CODE_NONE,	']',	'}')
		PORT_KEY1(0x04, IP_ACTIVE_LOW, "ENTER", KEYCODE_ENTER, CODE_NONE,		13)
		PORT_KEY1(0x02, IP_ACTIVE_LOW, "(SPACE)", KEYCODE_SPACE, CODE_NONE,	' ')
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_START    /* col 13 */
		PORT_KEY2(0x10, IP_ACTIVE_LOW, "\\ |", KEYCODE_BACKSLASH, CODE_NONE,	'\\',	'|')
		PORT_KEY2(0x08, IP_ACTIVE_LOW, "` ~", KEYCODE_BACKSLASH2, CODE_NONE,	'`',	'~')
		PORT_BITX(0x07, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

...
SYSTEM_CONFIG_START(sms)
	CONFIG_DEVICE_CARTSLOT_REQ(1, "sms\0", sms_init_cart, NULL, NULL)
SYSTEM_CONFIG_END

SYSTEM_CONFIG_START(smso)
	CONFIG_DEVICE_CARTSLOT_OPT(1, "sms\0", sms_init_cart, NULL, NULL)
SYSTEM_CONFIG_END

SYSTEM_CONFIG_START(gamegear)
	CONFIG_DEVICE_CARTSLOT_REQ(1, "gg\0", sms_init_cart, NULL, NULL)
SYSTEM_CONFIG_END

SYSTEM_CONFIG_START(gamegearo)
	CONFIG_DEVICE_CARTSLOT_OPT(1, "gg\0", sms_init_cart, NULL, NULL)
SYSTEM_CONFIG_END
...
CONS(	1986,	smsu13,		sms,		sms,		sms,	0,		smso,		"Sega",			"Master System - (NTSC) US/European BIOS v1.3" )
CONS(	1986,	smse13,		sms,		smsm3,		sms,	0,		smso,		"Sega",			"Master System - (PAL) US/European BIOS v1.3" )
CONS(	1986,	smsu13h,	sms,		sms,		sms,	0,		smso,		"Sega",			"Master System - (NTSC) Hacked US/European BIOS v1.3" )
CONS(	1986,	smse13h,	sms,		smsm3,		sms,	0,		smso,		"Sega",			"Master System - (PAL) Hacked US/European BIOS v1.3" )
/* next two systems are disabled because of missing bios roms */
//CONS(	1986,	smsumd3d,	sms,		sms,		sms,	0,		smso,		"Sega",			"Super Master System - (NTSC) US/European Missile Defense 3D BIOS" )
//CONS(	1986,	smsemd3d,	sms,		smsm3,		sms,	0,		smso,		"Sega",			"Super Master System - (PAL) US/European Missile Defense 3D BIOS" )
CONS(	1990,	smsuam,		sms,		sms,		sms,	0,		smso,		"Sega",			"Master System II - (NTSC) US/European BIOS with Alex Kidd in Miracle World" )
CONS(	1990,	smseam,		sms,		smsm3,		sms,	0,		smso,		"Sega",			"Master System II - (PAL) US/European BIOS with Alex Kidd in Miracle World" )
CONS(	1990,	smsesh,		sms,		smsm3,		sms,	0,		smso,		"Sega",			"Master System II - (PAL) European BIOS with Sonic The Hedgehog" )
CONS(	1990,	smsbsh,		sms,		smsm3,		sms,	0,		smso,		"Tec Toy",		"Master System III Compact (Brazil) - (PAL) European BIOS with Sonic The Hedgehog" )
CONS(	1988,	smsuhs24,	sms,		sms,		sms,	0,		smso,		"Sega",			"Master System Plus - (NTSC) US/European BIOS v2.4 with Hang On and Safari Hunt" )
CONS(	1988,	smsehs24,	sms,		smsm3,		sms,	0,		smso,		"Sega",			"Master System Plus - (PAL) US/European BIOS v2.4 with Hang On and Safari Hunt" )
CONS(	1988,	smsuh34,	sms,		sms,		sms,	0,		smso,		"Sega",			"Master System - (NTSC) US/European BIOS v3.4 with Hang On" )
CONS(	1988,	smseh34,	sms,		smsm3,		sms,	0,		smso,		"Sega",			"Master System - (PAL) US/European BIOS v3.4 with Hang On" )
...
CONS(	1984,	smsm3,		sms,		smsm3,		sms,	0,		smso,		"Sega",			"Mark III - (PAL) Japanese SMS BIOS v2.1" )
CONSX(	198?,	smsss,		sms,		smsj21,		sms,	0,		smso,		"Samsung",		"Gamboy - (PAL) Japanese SMS BIOS v2.1", GAME_ALIAS )
CONS(	1990,	gamegear,	0,			gamegear,	sms,	0,		gamegear,	"Sega",			"Game Gear - European/American" )
CONSX(	1990,	gamegj,		gamegear,	gamegear,	sms,	0,		gamegear,	"Sega",			"Game Gear - Japanese", GAME_ALIAS )
CONS(	1990,	gamg,		gamegear,	gamegear,	sms,	0,		gamegearo,	"Majesco",		"Game Gear - European/American Majesco Game Gear BIOS" )
CONSX(	1990,	gamgj,		gamegear,	gamegear,	sms,	0,		gamegearo,	"Majesco",		"Game Gear - Japanese Majesco Game Gear BIOS", GAME_ALIAS )

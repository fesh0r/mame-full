...
static ADDRESS_MAP_START( sms_io, ADDRESS_SPACE_IO, 8 )
	...
	AM_RANGE(0x01, 0x01) AM_MIRROR(0x3e) AM_WRITE(sms_version_w) AM_MIRROR(0x3e)
	...
	AM_RANGE(0xC0, 0xC0) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xC1, 0xC1) AM_READ(sms_version_r)
	AM_RANGE(0xC2, 0xC2) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xC3, 0xC3) AM_READ(sms_version_r)
	AM_RANGE(0xC4, 0xC4) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xC5, 0xC5) AM_READ(sms_version_r)
	AM_RANGE(0xC6, 0xC6) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xC7, 0xC7) AM_READ(sms_version_r)
	AM_RANGE(0xC8, 0xC8) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xC9, 0xC9) AM_READ(sms_version_r)
	AM_RANGE(0xCA, 0xCA) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xCB, 0xCB) AM_READ(sms_version_r)
	AM_RANGE(0xCC, 0xCC) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xCD, 0xCD) AM_READ(sms_version_r)
	AM_RANGE(0xCE, 0xCE) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xCF, 0xCF) AM_READ(sms_version_r)
	AM_RANGE(0xD0, 0xD0) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xD1, 0xD1) AM_READ(sms_version_r)
	AM_RANGE(0xD2, 0xD2) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xD3, 0xD3) AM_READ(sms_version_r)
	AM_RANGE(0xD4, 0xD4) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xD5, 0xD5) AM_READ(sms_version_r)
	AM_RANGE(0xD6, 0xD6) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xD7, 0xD7) AM_READ(sms_version_r)
	AM_RANGE(0xD8, 0xD8) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xD9, 0xD9) AM_READ(sms_version_r)
	AM_RANGE(0xDA, 0xDA) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xDB, 0xDB) AM_READ(sms_version_r)
	AM_RANGE(0xDC, 0xDC) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xDD, 0xDD) AM_READ(sms_version_r)
	AM_RANGE(0xDE, 0xDE) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xDF, 0xDF) AM_READ(sms_version_r)
	AM_RANGE(0xE0, 0xE0) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xE1, 0xE1) AM_READ(sms_version_r)
	AM_RANGE(0xE2, 0xE2) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xE3, 0xE3) AM_READ(sms_version_r)
	AM_RANGE(0xE4, 0xE4) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xE5, 0xE5) AM_READ(sms_version_r)
	AM_RANGE(0xE6, 0xE6) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xE7, 0xE7) AM_READ(sms_version_r)
	AM_RANGE(0xE8, 0xE8) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xE9, 0xE9) AM_READ(sms_version_r)
	AM_RANGE(0xEA, 0xEA) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xEB, 0xEB) AM_READ(sms_version_r)
	AM_RANGE(0xEC, 0xEC) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xED, 0xED) AM_READ(sms_version_r)
	AM_RANGE(0xEE, 0xEE) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xEF, 0xEF) AM_READ(sms_version_r)
	...
	AM_RANGE(0xF4, 0xF4) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xF5, 0xF5) AM_READ(sms_version_r)
	AM_RANGE(0xF6, 0xF6) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xF7, 0xF7) AM_READ(sms_version_r)
	AM_RANGE(0xF8, 0xF8) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xF9, 0xF9) AM_READ(sms_version_r)
	AM_RANGE(0xFA, 0xFA) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xFB, 0xFB) AM_READ(sms_version_r)
	AM_RANGE(0xFC, 0xFC) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xFD, 0xFD) AM_READ(sms_version_r)
	AM_RANGE(0xFE, 0xFE) AM_READ(sms_input_port_0_r)
	AM_RANGE(0xFF, 0xFF) AM_READ(sms_version_r)
ADDRESS_MAP_END

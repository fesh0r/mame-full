...
static MACHINE_DRIVER_START(sms)
	...
	MDRV_SCREEN_MAXSIZE(NTSC_X_PIXELS, NTSC_Y_PIXELS)
	MDRV_SCREEN_VISIBLE_AREA( LBORDER_X_PIXELS, LBORDER_X_PIXELS + 255, TBORDER_Y_PIXELS, TBORDER_Y_PIXELS + 239 )
...
static MACHINE_DRIVER_START(smspal)
	...
	/* video hardware */
	MDRV_VIDEO_ATTRIBUTES(VIDEO_TYPE_RASTER | VIDEO_RGB_DIRECT)
	MDRV_SCREEN_MAXSIZE(PAL_X_PIXELS, PAL_Y_PIXELS)
	MDRV_SCREEN_VISIBLE_AREA( LBORDER_X_PIXELS, LBORDER_X_PIXELS + 255, TBORDER_Y_PIXELS, TBORDER_Y_PIXELS + 239 )
	MDRV_PALETTE_LENGTH(32)
	MDRV_COLORTABLE_LENGTH(0)
	/*MDRV_PALETTE_INIT(sms)*/

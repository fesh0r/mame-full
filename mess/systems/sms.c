...
SYSTEM_CONFIG_START(gamegear)
	CONFIG_DEVICE_CARTSLOT(1, "gg\0", sms_init_cart, NULL, NULL)
SYSTEM_CONFIG_END
...
CONS(	1990,	gamg,		gamegear,	gamegear,	sms,	0,		gamegear,	"Majesco",		"Game Gear - European/American Majesco Game Gear BIOS" )
CONSX(	1990,	gamgj,		gamegear,	gamegear,	sms,	0,		gamegear,	"Majesco",		"Game Gear - Japanese Majesco Game Gear BIOS", GAME_ALIAS )

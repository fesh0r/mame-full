...
ROM_START(smsj21)
	...
	ROM_LOAD("jbios21.rom", 0x0000, 0x2000,CRC( 0x48D44A13))
ROM_END
...
ROM_START(smsu13)
	ROM_REGION(CPU_ADDRESSABLE_SIZE, REGION_CPU1, 0)
	ROM_REGION(0x2000, REGION_USER1, 0)
	ROM_LOAD("bios13.rom", 0x0000, 0x2000,CRC( 0x5AD6EDAC))
ROM_END
...
ROM_START(smsu13h)
	ROM_REGION(CPU_ADDRESSABLE_SIZE, REGION_CPU1, 0)
	ROM_REGION(0x2000, REGION_USER1, 0)
	ROM_LOAD("bios13fx.rom", 0x0000, 0x2000,CRC( 0x0072ED54))
ROM_END
...
ROM_START(smsuam)
	...
	ROM_LOAD("akbios.rom", 0x0000, 0x20000,CRC( 0xCF4A09EA))
ROM_END
...
ROM_START(smsesh)
	...
	ROM_LOAD("sonbios.rom", 0x0000, 0x40000,CRC( 0x81C3476B))
ROM_END
...
ROM_START(smsuhs24)
	ROM_REGION(CPU_ADDRESSABLE_SIZE, REGION_CPU1, 0)
	ROM_REGION(0x20000, REGION_USER1, 0)
	ROM_LOAD("hshbios.rom", 0x0000, 0x20000,CRC( 0x91E93385))
ROM_END
...
ROM_START(smsuh34)
	ROM_REGION(CPU_ADDRESSABLE_SIZE, REGION_CPU1, 0)
	ROM_REGION(0x20000, REGION_USER1, 0)
	ROM_LOAD("hangbios.rom", 0x0000, 0x20000,CRC( 0x8EDF7AC6))
ROM_END
...
ROM_START(gamg)
	...
	ROM_LOAD("majbios.rom", 0x0000, 0x0400,CRC( 0x0EBEA9D4))
ROM_END
...
CONSX(	198?,	smsss,		sms,		0,			smsj21,		sms,	0,		smso,		"Samsung",		"Gamboy - (PAL) Japanese SMS BIOS v2.1", GAME_ALIAS )
CONS(	1990,	gamegear,	0,			sms,		gamegear,	sms,	0,		gamegear,	"Sega",			"Game Gear - European/American" )
CONSX(	1990,	gamegj,		gamegear,	0,			gamegear,	sms,	0,		gamegear,	"Sega",			"Game Gear - Japanese", GAME_ALIAS )
CONS(	1990,	gamg,		gamegear,	0,			gamegear,	sms,	0,		gamegearo,	"Majesco",		"Game Gear - European/American Majesco Game Gear BIOS" )
CONSX(	1990,	gamgj,		gamegear,	0,			gamegear,	sms,	0,		gamegearo,	"Majesco",		"Game Gear - Japanese Majesco Game Gear BIOS", GAME_ALIAS )

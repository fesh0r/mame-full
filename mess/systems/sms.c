...
ROM_START(smsj21)
	...
	ROM_LOAD("jbios21.rom", 0x0000, 0x2000, 0x48D44A13)
ROM_END
...
ROM_START(smsu13)
	ROM_REGION(CPU_ADDRESSABLE_SIZE, REGION_CPU1, 0)
	ROM_REGION(0x2000, REGION_USER1, 0)
	ROM_LOAD("bios13.rom", 0x0000, 0x2000, 0x5AD6EDAC)
ROM_END
...
ROM_START(smsu13h)
	ROM_REGION(CPU_ADDRESSABLE_SIZE, REGION_CPU1, 0)
	ROM_REGION(0x2000, REGION_USER1, 0)
	ROM_LOAD("bios13fx.rom", 0x0000, 0x2000, 0x0072ED54)
ROM_END
...
ROM_START(smsuam)
	...
	ROM_LOAD("akbios.rom", 0x0000, 0x20000, 0xCF4A09EA)
ROM_END
...
ROM_START(smsesh)
	...
	ROM_LOAD("sonbios.rom", 0x0000, 0x40000, 0x81C3476B)
ROM_END
...
ROM_START(smsuhs24)
	ROM_REGION(CPU_ADDRESSABLE_SIZE, REGION_CPU1, 0)
	ROM_REGION(0x20000, REGION_USER1, 0)
	ROM_LOAD("hshbios.rom", 0x0000, 0x20000, 0x91E93385)
ROM_END
...
ROM_START(smsuh34)
	ROM_REGION(CPU_ADDRESSABLE_SIZE, REGION_CPU1, 0)
	ROM_REGION(0x20000, REGION_USER1, 0)
	ROM_LOAD("hangbios.rom", 0x0000, 0x20000, 0x8EDF7AC6)
ROM_END
...
ROM_START(gamg)
	...
	ROM_LOAD("majbios.rom", 0x0000, 0x0400, 0x0EBEA9D4)
ROM_END
...
#define io_smspal io_sms
#define io_smsj21 io_sms
#define io_smsm3 io_sms
#define io_smsss io_sms
#define io_smsu13 io_sms
#define io_smse13 io_sms
#define io_smsu13h io_sms
#define io_smse13h io_sms
#define io_smsuam io_sms
#define io_smseam io_sms
#define io_smsesh io_sms
#define io_smsbsh io_sms
#define io_smsuhs24 io_sms
#define io_smsehs24 io_sms
#define io_smsuh34 io_sms
#define io_smseh34 io_sms
#define io_gamegj io_gamegear
#define io_gamg io_gamegear
#define io_gamgj io_gamegear
...
CONS(	1987,	sms,		0,			sms,		sms,	0,		sms,	"Sega",			"Master System - (NTSC)" )
CONS(	1986,	smsu13,		sms,		sms,		sms,	0,		sms,	"Sega",			"Master System - (NTSC) US/European BIOS v1.3" )
CONS(	1986,	smse13,		sms,		smsm3,		sms,	0,		sms,	"Sega",			"Master System - (PAL) US/European BIOS v1.3" )
CONS(	1986,	smsu13h,	sms,		sms,		sms,	0,		sms,	"Sega",			"Master System - (NTSC) Hacked US/European BIOS v1.3" )
CONS(	1986,	smse13h,	sms,		smsm3,		sms,	0,		sms,	"Sega",			"Master System - (PAL) Hacked US/European BIOS v1.3" )
/* next two systems are disabled because of missing bios roms */
//CONS(	1986,	smsumd3d,	sms,		sms,		sms,	0,		sms,	"Sega",			"Super Master System - (NTSC) US/European Missile Defense 3D BIOS" )
//CONS(	1986,	smsemd3d,	sms,		smsm3,		sms,	0,		sms,	"Sega",			"Super Master System - (PAL) US/European Missile Defense 3D BIOS" )
CONS(	1990,	smsuam,		sms,		sms,		sms,	0,		sms,	"Sega",			"Master System II - (NTSC) US/European BIOS with Alex Kidd in Miracle World" )
CONS(	1990,	smseam,		sms,		smsm3,		sms,	0,		sms,	"Sega",			"Master System II - (PAL) US/European BIOS with Alex Kidd in Miracle World" )
CONS(	1990,	smsesh,		sms,		smsm3,		sms,	0,		sms,	"Sega",			"Master System II - (PAL) European BIOS with Sonic The Hedgehog" )
CONS(	1990,	smsbsh,		sms,		smsm3,		sms,	0,		sms,	"Tec Toy",		"Master System III Compact (Brazil) - (PAL) European BIOS with Sonic The Hedgehog" )
CONS(	1988,	smsuhs24,	sms,		sms,		sms,	0,		sms,	"Sega",			"Master System Plus - (NTSC) US/European BIOS v2.4 with Hang On and Safari Hunt" )
CONS(	1988,	smsehs24,	sms,		smsm3,		sms,	0,		sms,	"Sega",			"Master System Plus - (PAL) US/European BIOS v2.4 with Hang On and Safari Hunt" )
CONS(	1988,	smsuh34,	sms,		sms,		sms,	0,		sms,	"Sega",			"Master System - (NTSC) US/European BIOS v3.4 with Hang On" )
CONS(	1988,	smseh34,	sms,		smsm3,		sms,	0,		sms,	"Sega",			"Master System - (PAL) US/European BIOS v3.4 with Hang On" )
CONS(	1985,	smspal,		sms,		smspal,		sms,	0,		sms,	"Sega",			"Master System - (PAL)" )
CONS(	1985,	smsj21,		sms,		smsj21,		sms,	0,		sms,	"Sega",			"Master System - (PAL) Japanese SMS BIOS v2.1" )
CONS(	1984,	smsm3,		sms,		smsm3,		sms,	0,		sms,	"Sega",			"Mark III - (PAL) Japanese SMS BIOS v2.1" )
CONSX(	198?,	smsss,		sms,		smsj21,		sms,	0,		sms,	"Samsung",		"Gamboy - (PAL) Japanese SMS BIOS v2.1", GAME_ALIAS )
CONS(	1990,	gamegear,	0,			gamegear,	sms,	0,		sms,	"Sega",			"Game Gear - European/American" )
CONSX(	1990,	gamegj,		gamegear,	gamegear,	sms,	0,		sms,	"Sega",			"Game Gear - Japanese", GAME_ALIAS )
CONS(	1990,	gamg,		gamegear,	gamegear,	sms,	0,		sms,	"Majesco",		"Game Gear - European/American Majesco Game Gear BIOS" )
CONSX(	1990,	gamgj,		gamegear,	gamegear,	sms,	0,		sms,	"Majesco",		"Game Gear - Japanese Majesco Game Gear BIOS", GAME_ALIAS )

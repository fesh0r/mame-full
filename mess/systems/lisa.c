...
INPUT_PORTS_START( lisa )
	...
	PORT_START	/* 2 */
	PORT_BITX(0x0001, IP_ACTIVE_HIGH, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

	PORT_BIT(0x0040, IP_ACTIVE_HIGH, IPT_BUTTON1) PORT_NAME("mouse button")

	PORT_START	/* 3 */
	PORT_BITX(0xFFFF, IP_ACTIVE_HIGH, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)
...
#if 1
	/* US layout */
	PORT_BITX(0x0008, IP_ACTIVE_HIGH, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)
#else
	/* European layout */
	...
	PORT_BITX(0x0080, IP_ACTIVE_HIGH, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)
	...
	PORT_BITX(0x0C00, IP_ACTIVE_HIGH, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)
	...
	PORT_BITX(0x8000, IP_ACTIVE_HIGH, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

...
#ifdef M6504_MEMORY_LAYOUT
	ROM_LOAD("024_1879", 0x0c00, 0x0400,CRC( 0x4f28c443))
	ROM_LOAD("005_2179", 0x1000, 0x1000,CRC( 0x6f10991b)) // chess mate 7.5
#else
	ROM_LOAD("024_1879", 0x8c00, 0x0400,CRC( 0x4f28c443))
	ROM_LOAD("005_2179", 0xf000, 0x1000,CRC( 0x6f10991b)) // chess mate 7.5
#endif
ROM_END

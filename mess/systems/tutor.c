...
INPUT_PORTS_START(tutor)
	...
	PORT_START    /* col 5 */
		/* Unused? */
		PORT_BITX(0x03, IP_ACTIVE_HIGH, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)
	...
	PORT_START    /* col 6 */
		/* Unused? */
		PORT_BITX(0x21, IP_ACTIVE_HIGH, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)
	...
	PORT_START    /* col 7 */
		...
		/* Unused? */
		PORT_BITX(0xf0, IP_ACTIVE_HIGH, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

...
ROM_START (atom)
	...
	ROM_LOAD ("akernel.rom", 0xf000, 0x1000,CRC( 0xc604db3d))
	ROM_LOAD ("dosrom.rom", 0xe000, 0x1000,CRC( 0xc431a9b7))
	ROM_LOAD ("afloat.rom", 0xd000, 0x1000,CRC( 0x81d86af7))
	ROM_LOAD ("abasic.rom", 0xc000, 0x1000,CRC( 0x43798b9b))
ROM_END
...
ROM_START (atomeb)
	...
	ROM_LOAD ("axr1.rom",0x010000,0x1000,CRC( 0x868fda8b))
	ROM_LOAD ("pcharme.rom",0x011000,0x1000,CRC(0x9e8bd79f))
	ROM_LOAD ("gags.rom",0x012000,0x1000,CRC(0x35e1d713))
	ROM_LOAD ("werom.rom",0x013000,0x1000,CRC(0xdfcb3bf8))
	ROM_LOAD ("unknown.rom",0x014000,0x1000,CRC(0x013b8f93))
	ROM_LOAD ("combox.rom",0x015000,0x1000,CRC(0x9c8210ab))
	ROM_LOAD ("salfaa.rom",0x016000,0x1000,CRC(0x0ef857b25))
	ROM_LOAD ("mousebox.rom",0x017000,0x01000,CRC(0x0dff30e4))
	ROM_LOAD ("atomicw.rom",0x018000,0x1000,CRC(0xa3fd737d))
ROM_END

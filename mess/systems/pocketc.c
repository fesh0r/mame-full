...
ROM_START(pc1401)
	...
	ROM_LOAD("sc61860.a08", 0x0000, 0x2000,CRC( 0x44bee438))
/* 5S1 SC613256 D30
   or SC43536LD 5G 13 (LCD chip?) */
	ROM_LOAD("sc613256.d30", 0x8000, 0x8000,CRC( 0x69b9d587))
...
ROM_START(pc1251)
	ROM_REGION(0x10000,REGION_CPU1,0)
	/* sc61860a13 6c 13 ld */
	ROM_LOAD("cpu1251.rom", 0x0000, 0x2000,CRC( 0xf7287aca))
	ROM_LOAD("bas1251.rom", 0x4000, 0x4000,CRC( 0x93ecb629))
	ROM_REGION(0x80,REGION_GFX1,0)
ROM_END
...
ROM_START(pc1350)
	ROM_REGION(0x10000,REGION_CPU1,0)
	/* sc61860a13 6c 13 ld */
	ROM_LOAD("cpu.rom", 0x0000, 0x2000,CRC( 0x79a924bc))
	ROM_LOAD("basic.rom", 0x8000, 0x8000,CRC( 0x158b28e2))
	ROM_REGION(0x100,REGION_GFX1,0)
ROM_END

ROM_START(pc1403)
	ROM_REGION(0x10000,REGION_CPU1,0)
    ROM_LOAD("introm.bin", 0x0000, 0x2000,CRC( 0x588c500b ))
	ROM_REGION(0x10000,REGION_USER1,0)
    ROM_LOAD("extrom08.bin", 0x0000, 0x4000,CRC( 0x1fa65140 ))
    ROM_LOAD("extrom09.bin", 0x4000, 0x4000,CRC( 0x4a7da6ab ))
    ROM_LOAD("extrom0a.bin", 0x8000, 0x4000,CRC( 0x9925174f ))
    ROM_LOAD("extrom0b.bin", 0xc000, 0x4000,CRC( 0xfa5df9ec ))
	ROM_REGION(0x100,REGION_GFX1,0)
ROM_END

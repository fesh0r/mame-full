...
INPUT_PORTS_START( mc10 )
	...
	PORT_BITX(0x38, IP_ACTIVE_LOW, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "ENTER", KEYCODE_ENTER, CODE_NONE,		13)
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "SPACE", KEYCODE_SPACE, CODE_NONE,		10)
	...
	PORT_KEY0(0x01, IP_ACTIVE_LOW, "CONTROL", KEYCODE_LCONTROL, CODE_NONE)
	...
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "SHIFT", KEYCODE_LSHIFT, CODE_NONE,	UCHAR_SHIFT_1)

...
INPUT_PORTS_START( a2600 )
	...
	PORT_DIPNAME( 0x08, 0x08, "TV" )
	PORT_DIPSETTING(    0x08, "Color" )
	PORT_DIPSETTING(    0x00, "B/W" )
	PORT_BIT ( 0x10, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT ( 0x20, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_DIPNAME( 0x40, 0x00, "P0 level" )
	PORT_DIPSETTING(    0x00, "Amateur" )
	PORT_DIPSETTING(    0x40, "Pro" )
	PORT_DIPNAME( 0x80, 0x00, "P1 level" )
	PORT_DIPSETTING(    0x00, "Amateur" )
	PORT_DIPSETTING(    0x80, "Pro" )

	PORT_START
	PORT_DIPNAME( 0xF0, 0x00, "Left control" )
	PORT_DIPSETTING(    0x00, "Joystick" )
	PORT_DIPSETTING(    0x10, "Paddles" )
	PORT_DIPNAME( 0x0F, 0x00, "Right control" )
	PORT_DIPSETTING(    0x00, "Joystick" )

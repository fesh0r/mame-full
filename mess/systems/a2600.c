...
INPUT_PORTS_START( a2600 )
	...
	PORT_START
	PORT_DIPNAME( 0xff, 0xff, "Bank Mode" )
	PORT_DIPSETTING(    0xff, "Auto" )
	PORT_DIPSETTING(    mode2K, "2K" )
	PORT_DIPSETTING(    mode4K, "4K" )
	PORT_DIPSETTING(    mode8K, "8K" )
	PORT_DIPSETTING(    mode12, "12K" )
	PORT_DIPSETTING(    mode16, "16K" )
	PORT_DIPSETTING(    mode32, "32K" )
	PORT_DIPSETTING(    modeAV, "Activision" )
	PORT_DIPSETTING(    modeCV, "CommaVid" )
	PORT_DIPSETTING(    modeDC, "Dynacom" )
	PORT_DIPSETTING(    modeMN, "M Network" )
	PORT_DIPSETTING(    modePB, "Parker Brothers" )
	PORT_DIPSETTING(    modeTV, "Tigervision" )
	PORT_DIPSETTING(    modeUA, "UA Limited" )

	PORT_START
	PORT_DIPNAME( 0xff, 0xff, "Super Chip" )
	PORT_DIPSETTING(    0xff, "Auto" )

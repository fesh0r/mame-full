...
#define KEYBOARD_PORTS \
	/* keyboard row 0 */ \
	PORT_START \
	PORT_KEY1(0x01, IP_ACTIVE_LOW, "\x18", KEYCODE_UP,		IP_JOY_NONE, UCHAR_MAMEKEY(UP) )	\
	PORT_KEY1(0x02, IP_ACTIVE_LOW, "\x1a", KEYCODE_RIGHT,		IP_JOY_NONE, UCHAR_MAMEKEY(RIGHT) )	\
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "\x19", KEYCODE_DOWN,		IP_JOY_NONE, UCHAR_MAMEKEY(DOWN) )	\
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "Keypad 9", KEYCODE_9_PAD, IP_JOY_NONE, UCHAR_MAMEKEY(9_PAD) )	\
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "Keypad 6", KEYCODE_6_PAD, IP_JOY_NONE, UCHAR_MAMEKEY(6_PAD) ) \
...
\
	/* keyboard line 1 */ \
	PORT_START \
	PORT_KEY1(0x01, IP_ACTIVE_LOW, "\x1b", KEYCODE_LEFT, IP_JOY_NONE, UCHAR_MAMEKEY(LEFT) ) \
	PORT_KEY0(0x02, IP_ACTIVE_LOW, "Copy", KEYCODE_LALT, IP_JOY_NONE) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "Keypad 7", KEYCODE_7_PAD, IP_JOY_NONE, UCHAR_MAMEKEY(7_PAD) ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "Keypad 8", KEYCODE_8_PAD, IP_JOY_NONE, UCHAR_MAMEKEY(8_PAD) ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "Keypad 5", KEYCODE_5_PAD, IP_JOY_NONE, UCHAR_MAMEKEY(5_PAD) ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "Keypad 1", KEYCODE_1_PAD, IP_JOY_NONE, UCHAR_MAMEKEY(1_PAD) ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "Keypad 2", KEYCODE_2_PAD, IP_JOY_NONE, UCHAR_MAMEKEY(2_PAD) ) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "Keypad 0", KEYCODE_0_PAD, IP_JOY_NONE, UCHAR_MAMEKEY(0_PAD) ) \
\
	/* keyboard row 2 */ \
	PORT_START \
	PORT_KEY1(0x01, IP_ACTIVE_LOW, "Clr", KEYCODE_HOME, IP_JOY_NONE, UCHAR_MAMEKEY(HOME) ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "@ |", KEYCODE_ASTERISK, IP_JOY_NONE, '@', '|' ) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "Enter", KEYCODE_ENTER, IP_JOY_NONE, 13) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "]", KEYCODE_CLOSEBRACE, IP_JOY_NONE, ']' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "Keypad 4", KEYCODE_4_PAD, IP_JOY_NONE, UCHAR_MAMEKEY(4_PAD) ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "Left Shift", KEYCODE_LSHIFT, IP_JOY_NONE, UCHAR_SHIFT_1 ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "Right Shift", KEYCODE_RSHIFT, IP_JOY_NONE, UCHAR_SHIFT_1 ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "\\", KEYCODE_BACKSLASH, IP_JOY_NONE, '\\' ) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "Ctrl", KEYCODE_LCONTROL, IP_JOY_NONE, UCHAR_SHIFT_2 ) \
\
	/* keyboard row 3 */ \
	PORT_START \
	PORT_KEY2(0x01, IP_ACTIVE_LOW, "^ \xa3", KEYCODE_SLASH_PAD, IP_JOY_NONE, '^', '\xa3' ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "- =", KEYCODE_MINUS, IP_JOY_NONE, '-', '=') \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "[", KEYCODE_OPENBRACE, IP_JOY_NONE, '[' ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "p P", KEYCODE_P, IP_JOY_NONE, 'P' ) \
	PORT_KEY2(0x10, IP_ACTIVE_LOW, "; +", KEYCODE_QUOTE, IP_JOY_NONE, ';', '+' ) \
	PORT_KEY2(0x20, IP_ACTIVE_LOW, ": *", KEYCODE_COLON, IP_JOY_NONE, ':', '*' ) \
	PORT_KEY2(0x40, IP_ACTIVE_LOW, "/ ?", KEYCODE_SLASH, IP_JOY_NONE, '/', '?' ) \
	PORT_KEY2(0x80, IP_ACTIVE_LOW, ". >", KEYCODE_STOP, IP_JOY_NONE, '.', '>' ) \
\
	/* keyboard line 4 */ \
	PORT_START \
	PORT_KEY2(0x01, IP_ACTIVE_LOW, "0 _", KEYCODE_0, IP_JOY_NONE, '0', '_' ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "9 )", KEYCODE_9, IP_JOY_NONE, '9', ')' ) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "o O", KEYCODE_O, IP_JOY_NONE, 'O' ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "i I", KEYCODE_I, IP_JOY_NONE, 'I' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "l L", KEYCODE_L, IP_JOY_NONE, 'L' ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "k K", KEYCODE_K, IP_JOY_NONE, 'K' ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "m M", KEYCODE_M, IP_JOY_NONE, 'M' ) \
	PORT_KEY2(0x80, IP_ACTIVE_LOW, ", <", KEYCODE_COMMA, IP_JOY_NONE, ',', '<' ) \
\
	/* keyboard line 5 */ \
	PORT_START \
	PORT_KEY2(0x01, IP_ACTIVE_LOW, "8 (", KEYCODE_8, IP_JOY_NONE, '8', '(' ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "7 '", KEYCODE_7, IP_JOY_NONE, '7', '\'' ) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "u U", KEYCODE_U, IP_JOY_NONE, 'U' ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "y Y", KEYCODE_Y, IP_JOY_NONE, 'Y' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "h H", KEYCODE_H, IP_JOY_NONE, 'H' ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "j J", KEYCODE_J, IP_JOY_NONE, 'J' ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "n N", KEYCODE_N, IP_JOY_NONE, 'N' ) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "Space", KEYCODE_SPACE, IP_JOY_NONE, ' ') \
\
	/* keyboard line 6 */ \
	PORT_START \
	PORT_KEY2(0x01, IP_ACTIVE_LOW, "6 &", KEYCODE_6, IP_JOY_NONE, '6', '&' ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "5 %", KEYCODE_5, IP_JOY_NONE, '5', '%' ) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "r R", KEYCODE_R, IP_JOY_NONE, 'R' ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "t T", KEYCODE_T, IP_JOY_NONE, 'T' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "g G", KEYCODE_G, IP_JOY_NONE, 'G' ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "f F", KEYCODE_F, IP_JOY_NONE, 'F' ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "b B", KEYCODE_B, IP_JOY_NONE, 'B' ) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "v V", KEYCODE_V, IP_JOY_NONE, 'V' ) \
\
	/* keyboard line 7 */ \
	PORT_START \
	PORT_KEY2(0x01, IP_ACTIVE_LOW, "4 $", KEYCODE_4, IP_JOY_NONE, '4', '$' ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "3 #", KEYCODE_3, IP_JOY_NONE, '3', '#' ) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "e E", KEYCODE_E, IP_JOY_NONE, 'E' ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "w W", KEYCODE_W, IP_JOY_NONE, 'W' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "s S", KEYCODE_S, IP_JOY_NONE, 'S' ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "d D", KEYCODE_D, IP_JOY_NONE, 'D' ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "c C", KEYCODE_C, IP_JOY_NONE, 'C' ) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "x X", KEYCODE_X, IP_JOY_NONE, 'X' ) \
\
	/* keyboard line 8 */ \
	PORT_START \
	PORT_KEY2(0x01, IP_ACTIVE_LOW, "1 !", KEYCODE_1, IP_JOY_NONE, '1', '!' ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "2 \"", KEYCODE_2, IP_JOY_NONE, '2', '\"' ) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "Esc", KEYCODE_ESC, IP_JOY_NONE, 26) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "q Q", KEYCODE_Q, IP_JOY_NONE, 'Q' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "Tab", KEYCODE_TAB, IP_JOY_NONE, 9 ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "a A", KEYCODE_A, IP_JOY_NONE, 'A' ) \
	PORT_KEY0(0x40, IP_ACTIVE_LOW, "Caps Lock", KEYCODE_CAPSLOCK, IP_JOY_NONE) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "z Z", KEYCODE_Z, IP_JOY_NONE, 'Z') \
\
	/* keyboard line 9 */ \
	PORT_START \

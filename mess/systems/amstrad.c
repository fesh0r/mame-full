...
#define KEYBOARD_PORTS \
	...
	PORT_KEY1(0x02, IP_ACTIVE_LOW, "\x1a", KEYCODE_RIGHT,		CODE_NONE, UCHAR_MAMEKEY(RIGHT) )	\
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "\x19", KEYCODE_DOWN,		CODE_NONE, UCHAR_MAMEKEY(DOWN) )	\
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "Keypad 9", KEYCODE_9_PAD, CODE_NONE, UCHAR_MAMEKEY(9_PAD) )	\
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "Keypad 6", KEYCODE_6_PAD, CODE_NONE, UCHAR_MAMEKEY(6_PAD) ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "Keypad 3", KEYCODE_3_PAD, CODE_NONE, UCHAR_MAMEKEY(3_PAD) ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "Keypad Enter", KEYCODE_ENTER_PAD, CODE_NONE, UCHAR_MAMEKEY(ENTER_PAD) ) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "Keypad .", KEYCODE_DEL_PAD, CODE_NONE, UCHAR_MAMEKEY(DEL_PAD) ) \
\
	/* keyboard line 1 */ \
	PORT_START \
	PORT_KEY1(0x01, IP_ACTIVE_LOW, "\x1b", KEYCODE_LEFT, CODE_NONE, UCHAR_MAMEKEY(LEFT) ) \
	PORT_KEY0(0x02, IP_ACTIVE_LOW, "Copy", KEYCODE_LALT, CODE_NONE) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "Keypad 7", KEYCODE_7_PAD, CODE_NONE, UCHAR_MAMEKEY(7_PAD) ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "Keypad 8", KEYCODE_8_PAD, CODE_NONE, UCHAR_MAMEKEY(8_PAD) ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "Keypad 5", KEYCODE_5_PAD, CODE_NONE, UCHAR_MAMEKEY(5_PAD) ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "Keypad 1", KEYCODE_1_PAD, CODE_NONE, UCHAR_MAMEKEY(1_PAD) ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "Keypad 2", KEYCODE_2_PAD, CODE_NONE, UCHAR_MAMEKEY(2_PAD) ) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "Keypad 0", KEYCODE_0_PAD, CODE_NONE, UCHAR_MAMEKEY(0_PAD) ) \
\
	/* keyboard row 2 */ \
	PORT_START \
	PORT_KEY1(0x01, IP_ACTIVE_LOW, "Clr", KEYCODE_HOME, CODE_NONE, UCHAR_MAMEKEY(HOME) ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "@ |", KEYCODE_ASTERISK, CODE_NONE, '@', '|' ) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "Enter", KEYCODE_ENTER, CODE_NONE, 13) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "]", KEYCODE_CLOSEBRACE, CODE_NONE, ']' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "Keypad 4", KEYCODE_4_PAD, CODE_NONE, UCHAR_MAMEKEY(4_PAD) ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "Left Shift", KEYCODE_LSHIFT, CODE_NONE, UCHAR_SHIFT_1 ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "Right Shift", KEYCODE_RSHIFT, CODE_NONE, UCHAR_SHIFT_1 ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "\\", KEYCODE_BACKSLASH, CODE_NONE, '\\' ) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "Ctrl", KEYCODE_LCONTROL, CODE_NONE, UCHAR_SHIFT_2 ) \
\
	/* keyboard row 3 */ \
	PORT_START \
	PORT_KEY2(0x01, IP_ACTIVE_LOW, "^ \xa3", KEYCODE_SLASH_PAD, CODE_NONE, '^', '\xa3' ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "- =", KEYCODE_MINUS, CODE_NONE, '-', '=') \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "[", KEYCODE_OPENBRACE, CODE_NONE, '[' ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "p P", KEYCODE_P, CODE_NONE, 'P' ) \
	PORT_KEY2(0x10, IP_ACTIVE_LOW, "; +", KEYCODE_QUOTE, CODE_NONE, ';', '+' ) \
	PORT_KEY2(0x20, IP_ACTIVE_LOW, ": *", KEYCODE_COLON, CODE_NONE, ':', '*' ) \
	PORT_KEY2(0x40, IP_ACTIVE_LOW, "/ ?", KEYCODE_SLASH, CODE_NONE, '/', '?' ) \
	PORT_KEY2(0x80, IP_ACTIVE_LOW, ". >", KEYCODE_STOP, CODE_NONE, '.', '>' ) \
\
	/* keyboard line 4 */ \
	PORT_START \
	PORT_KEY2(0x01, IP_ACTIVE_LOW, "0 _", KEYCODE_0, CODE_NONE, '0', '_' ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "9 )", KEYCODE_9, CODE_NONE, '9', ')' ) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "o O", KEYCODE_O, CODE_NONE, 'O' ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "i I", KEYCODE_I, CODE_NONE, 'I' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "l L", KEYCODE_L, CODE_NONE, 'L' ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "k K", KEYCODE_K, CODE_NONE, 'K' ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "m M", KEYCODE_M, CODE_NONE, 'M' ) \
	PORT_KEY2(0x80, IP_ACTIVE_LOW, ", <", KEYCODE_COMMA, CODE_NONE, ',', '<' ) \
\
	/* keyboard line 5 */ \
	PORT_START \
	PORT_KEY2(0x01, IP_ACTIVE_LOW, "8 (", KEYCODE_8, CODE_NONE, '8', '(' ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "7 '", KEYCODE_7, CODE_NONE, '7', '\'' ) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "u U", KEYCODE_U, CODE_NONE, 'U' ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "y Y", KEYCODE_Y, CODE_NONE, 'Y' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "h H", KEYCODE_H, CODE_NONE, 'H' ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "j J", KEYCODE_J, CODE_NONE, 'J' ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "n N", KEYCODE_N, CODE_NONE, 'N' ) \
...
\
	...
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "r R", KEYCODE_R, CODE_NONE, 'R' ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "t T", KEYCODE_T, CODE_NONE, 'T' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "g G", KEYCODE_G, CODE_NONE, 'G' ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "f F", KEYCODE_F, CODE_NONE, 'F' ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "b B", KEYCODE_B, CODE_NONE, 'B' ) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "v V", KEYCODE_V, CODE_NONE, 'V' ) \
\
	/* keyboard line 7 */ \
	PORT_START \
	PORT_KEY2(0x01, IP_ACTIVE_LOW, "4 $", KEYCODE_4, CODE_NONE, '4', '$' ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "3 #", KEYCODE_3, CODE_NONE, '3', '#' ) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "e E", KEYCODE_E, CODE_NONE, 'E' ) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "w W", KEYCODE_W, CODE_NONE, 'W' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "s S", KEYCODE_S, CODE_NONE, 'S' ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "d D", KEYCODE_D, CODE_NONE, 'D' ) \
	PORT_KEY1(0x40, IP_ACTIVE_LOW, "c C", KEYCODE_C, CODE_NONE, 'C' ) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "x X", KEYCODE_X, CODE_NONE, 'X' ) \
\
	/* keyboard line 8 */ \
	PORT_START \
	PORT_KEY2(0x01, IP_ACTIVE_LOW, "1 !", KEYCODE_1, CODE_NONE, '1', '!' ) \
	PORT_KEY2(0x02, IP_ACTIVE_LOW, "2 \"", KEYCODE_2, CODE_NONE, '2', '\"' ) \
	PORT_KEY1(0x04, IP_ACTIVE_LOW, "Esc", KEYCODE_ESC, CODE_NONE, 26) \
	PORT_KEY1(0x08, IP_ACTIVE_LOW, "q Q", KEYCODE_Q, CODE_NONE, 'Q' ) \
	PORT_KEY1(0x10, IP_ACTIVE_LOW, "Tab", KEYCODE_TAB, CODE_NONE, 9 ) \
	PORT_KEY1(0x20, IP_ACTIVE_LOW, "a A", KEYCODE_A, CODE_NONE, 'A' ) \
	PORT_KEY0(0x40, IP_ACTIVE_LOW, "Caps Lock", KEYCODE_CAPSLOCK, CODE_NONE) \
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "z Z", KEYCODE_Z, CODE_NONE, 'Z') \
\
	/* keyboard line 9 */ \
	PORT_START \
	PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP, IP_NAME_DEFAULT, CODE_NONE, JOYCODE_1_UP)	 PORT_PLAYER(1)\
	PORT_BITX(0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN, IP_NAME_DEFAULT, CODE_NONE, JOYCODE_1_DOWN)	 PORT_PLAYER(1)\
	PORT_BITX(0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT, IP_NAME_DEFAULT, CODE_NONE, JOYCODE_1_LEFT)	 PORT_PLAYER(1)\
	PORT_BITX(0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT, IP_NAME_DEFAULT, CODE_NONE, JOYCODE_1_RIGHT)	 PORT_PLAYER(1)\
	PORT_BITX(0x10, IP_ACTIVE_LOW, IPT_BUTTON1, IP_NAME_DEFAULT, CODE_NONE, JOYCODE_1_BUTTON1)	 PORT_PLAYER(1)\
	PORT_BITX(0x20, IP_ACTIVE_LOW, IPT_BUTTON2, IP_NAME_DEFAULT, CODE_NONE, JOYCODE_1_BUTTON2)	 PORT_PLAYER(1)\
	PORT_BITX(0x40, IP_ACTIVE_LOW, IPT_BUTTON3, IP_NAME_DEFAULT, CODE_NONE, JOYCODE_1_BUTTON3)	 PORT_PLAYER(1)\
	PORT_KEY1(0x80, IP_ACTIVE_LOW, "Del", KEYCODE_BACKSPACE, CODE_NONE, 8) \

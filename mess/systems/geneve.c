...
INPUT_PORTS_START(geneve)
	...
	PORT_START	/* col 1: "wired handset 1" (= joystick 1) */
		...
		PORT_BITX(0x0007, IP_ACTIVE_HIGH, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)
		...
		PORT_BITX(0x0700, IP_ACTIVE_HIGH, IPT_UNUSED, DEF_STR( Unused ), CODE_NONE, CODE_NONE)

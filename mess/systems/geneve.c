...
INPUT_PORTS_START(geneve)
	...
	PORT_BITX( 0x04, IP_ACTIVE_HIGH, IPT_BUTTON1, "mouse button 1", KEYCODE_NONE, IP_JOY_DEFAULT)
	PORT_BITX( 0x02, IP_ACTIVE_HIGH, IPT_BUTTON2, "mouse button 2", KEYCODE_NONE, IP_JOY_DEFAULT)
	PORT_BITX( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON3, "mouse button 3", KEYCODE_NONE, IP_JOY_DEFAULT)

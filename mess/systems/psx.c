...
CONSX( 1995, psxe20, psx,    0,      psx,     psx,   psx,  psx,    "Sony",   "Sony PSX (scph1002 E v2.0 05/10/95)", GAME_NO_SOUND | GAME_NOT_WORKING )
...
CONSX( 1997, psxe30, psx,    0,      psx,     psx,   psx,  psx,    "Sony",   "Sony PSX (scph5502/scph5552 E v3.0 01/06/97)", GAME_NO_SOUND | GAME_NOT_WORKING )
/* PU-20 */
...
/* PU-23 */
/* PM-41 */
CONSX( 2000, psxa45, psx,    0,      psx,     psx,   psx,  psx,    "Sony",   "Sony PS one (scph101 A v4.5 05/25/00)", GAME_NO_SOUND | GAME_NOT_WORKING )

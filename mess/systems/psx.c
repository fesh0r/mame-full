...
INPUT_PORTS_START( psx )
	...
	PORT_START		/* IN1 */
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1) PORT_PLAYER(1) /* Square */
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON2) PORT_PLAYER(1) /* Cross */
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON3) PORT_PLAYER(1) /* Circle */
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON4) PORT_PLAYER(1) /* Triangle */
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON5) PORT_PLAYER(1) /* R1 */
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON6) PORT_PLAYER(1) /* L1 */
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON7) PORT_PLAYER(1) /* R2 */
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON8) PORT_PLAYER(1) /* L2 */
	...
	PORT_START		/* IN3 */
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1) PORT_PLAYER(2) /* Square */
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON2) PORT_PLAYER(2) /* Cross */
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON3) PORT_PLAYER(2) /* Circle */
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON4) PORT_PLAYER(2) /* Triangle */
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON5) PORT_PLAYER(2) /* R1 */
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON6) PORT_PLAYER(2) /* L1 */
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON7) PORT_PLAYER(2) /* R2 */
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON8) PORT_PLAYER(2) /* L2 */
INPUT_PORTS_END

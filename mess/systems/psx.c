...
ROM_START( psx )
	...
	ROM_LOAD32_DWORD( "scph7502.bin",  0x0000000, 0x080000, CRC(318178bf) )
ROM_END
...
ROM_START( psxa )
	...
	ROM_REGION32_LE( 0x080000, REGION_USER1, 0 )
	ROM_LOAD32_DWORD( "scph7001.bin",  0x0000000, 0x080000, CRC(502224b6) )
ROM_END
...
ROM_START( psxb )
	...
	ROM_REGION32_LE( 0x080000, REGION_USER1, 0 )
	ROM_LOAD32_DWORD( "scph7000.bin",  0x0000000, 0x080000, CRC(ec541cd0) )
ROM_END
...
ROM_START( psxc )
	...
	ROM_REGION32_LE( 0x080000, REGION_USER1, 0 )
	ROM_LOAD32_DWORD( "scph5502.bin",  0x0000000, 0x080000, CRC(4d9e7c86) )
ROM_END
...
ROM_START( psxd )
	...
	ROM_REGION32_LE( 0x080000, REGION_USER1, 0 )
	ROM_LOAD32_DWORD( "scph5500.bin",  0x0000000, 0x080000, CRC(ff3eeb8c) )
ROM_END
...
ROM_START( psxe )
	...
	ROM_REGION32_LE( 0x080000, REGION_USER1, 0 )
	ROM_LOAD32_DWORD( "scph7003.bin",  0x0000000, 0x080000, CRC(8d8cb7e4) )
ROM_END
...
ROM_START( psxf )
	...
	ROM_REGION32_LE( 0x080000, REGION_USER1, 0 )
	ROM_LOAD32_DWORD( "dtlh3002.bin",  0x0000000, 0x080000, CRC(1e26792f) )
ROM_END
...
ROM_START( psxg )
	...
	ROM_REGION32_LE( 0x080000, REGION_USER1, 0 )
	ROM_LOAD32_DWORD( "scph1001.bin",  0x0000000, 0x080000, CRC(37157331) )
ROM_END
...
ROM_START( psxh )
	...
	ROM_REGION32_LE( 0x080000, REGION_USER1, 0 )
	ROM_LOAD32_DWORD( "scph5000.bin",  0x0000000, 0x080000, CRC(24fc7e17) ) /* 0x8c93a399 */
ROM_END
...
ROM_START( psxi )
	...
	ROM_REGION32_LE( 0x080000, REGION_USER1, 0 )
	ROM_LOAD32_DWORD( "scph1000.bin",  0x0000000, 0x080000, CRC(3b601fc8) )
ROM_END
...
COMPX( 1997,	psx,	0,		0,		psx,	psx,	0,		psx,	"Sony",		"Sony PSX (scph7502 E v4.1 12/16/97)", GAME_NO_SOUND | GAME_NOT_WORKING )
COMPX( 1997,	psxa,	psx,	0,		psx,	psx,	0,		psx,	"Sony",		"Sony PSX (scph7001 A v4.1 12/16/97)", GAME_NO_SOUND | GAME_NOT_WORKING )
COMPX( 1997,	psxb,	psx,	0,		psx,	psx,	0,		psx,	"Sony",		"Sony PSX (scph7000 J v4.0 08/18/97)", GAME_NO_SOUND | GAME_NOT_WORKING )
COMPX( 1997,	psxc,	psx,	0,		psx,	psx,	0,		psx,	"Sony",		"Sony PSX (scph5502 E v3.0 01/06/97)", GAME_NO_SOUND | GAME_NOT_WORKING )
COMPX( 1996,	psxd,	psx,	0,		psx,	psx,	0,		psx,	"Sony",		"Sony PSX (scph7003 A v3.0 11/18/96)", GAME_NO_SOUND | GAME_NOT_WORKING )
COMPX( 1996,	psxe,	psx,	0,		psx,	psx,	0,		psx,	"Sony",		"Sony PSX (scph5500 J v3.0 09/09/96)", GAME_NO_SOUND | GAME_NOT_WORKING )
COMPX( 1995,	psxf,	psx,	0,		psx,	psx,	0,		psx,	"Sony",		"Sony PSX (dtlh3002 E v2.2 12/04/95)", GAME_NO_SOUND | GAME_NOT_WORKING )
COMPX( 1995,	psxg,	psx,	0,		psx,	psx,	0,		psx,	"Sony",		"Sony PSX (scph1001 A v2.2 12/04/95)", GAME_NO_SOUND | GAME_NOT_WORKING )
COMPX( 1995,	psxh,	psx,	0,		psx,	psx,	0,		psx,	"Sony",		"Sony PSX (scph5000 J v2.2 12/04/95)", GAME_NO_SOUND | GAME_NOT_WORKING )
COMPX( 1994,	psxi,	psx,	0,		psx,	psx,	0,		psx,	"Sony",		"Sony PSX (scph1000)", GAME_NO_SOUND | GAME_NOT_WORKING )

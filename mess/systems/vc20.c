...
#define DIPS_INPUT \
	...
	PORT_BIT( 0x4000, IP_ACTIVE_HIGH, 0) PORT_NAME("SHIFT-LOCK (switch)") PORT_CODE(KEYCODE_CAPSLOCK) PORT_TOGGLE\
...
INPUT_PORTS_START (vic20)
	...
	PORT_ANALOGX (0xff, 0, IPT_PADDLE, 30, 2, 0, (VIC6560_MAME_XSIZE - 1), KEYCODE_LEFT, KEYCODE_RIGHT, JOYCODE_1_LEFT, JOYCODE_1_RIGHT) PORT_PLAYER(3)
	PORT_START							   /* in 17 lightpen Y */
	PORT_ANALOGX (0xff, 0, IPT_PADDLE, 30, 2, 0, (VIC6560_MAME_YSIZE - 1), KEYCODE_UP, KEYCODE_DOWN, JOYCODE_1_UP, JOYCODE_1_DOWN) PORT_PLAYER(4)
	DIPS_INPUT
	DIPS_BOTH
INPUT_PORTS_END
...
INPUT_PORTS_START (vc20)
	DIPS_JOY
	PORT_START							   /* in 16 lightpen X */
	PORT_ANALOGX (0xff, 0, IPT_PADDLE, 30, 2, 0, (VIC6561_MAME_XSIZE - 1), KEYCODE_LEFT, KEYCODE_RIGHT, JOYCODE_1_LEFT, JOYCODE_1_RIGHT) PORT_PLAYER(3)
	PORT_START							   /* in 17 lightpen Y */
	PORT_ANALOGX (0x1ff, 0, IPT_PADDLE, 30, 2, 0, (VIC6561_MAME_YSIZE - 1), KEYCODE_UP, KEYCODE_DOWN, JOYCODE_1_UP, JOYCODE_1_DOWN) PORT_PLAYER(4)
	DIPS_INPUT
	DIPS_BOTH
INPUT_PORTS_END

...
static ADDRESS_MAP_START(a7800_mem, ADDRESS_SPACE_PROGRAM, 8)
	...
	AM_RANGE(0x0280, 0x02FF) AM_READWRITE(a7800_RIOT_r, a7800_RIOT_w)
...
INPUT_PORTS_START( a7800 )
	...
	PORT_START      /* IN3 */
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN) PORT_NAME("Reset") PORT_CODE(KEYCODE_R)
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN) PORT_NAME("Start") PORT_CODE(KEYCODE_S)

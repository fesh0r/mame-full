...
ROM_START (a7800)
    ...
    ROM_LOAD ("7800.rom", 0xf000, 0x1000,CRC( 0x649913e5))
/*      ROM_LOAD ("7800a.rom", 0xc000, 0x4000,CRC( 0x649913e5)) */

ROM_END

ROM_START (a7800p)
    ROM_REGION(0x30000,REGION_CPU1,0)
    //ROM_LOAD ("7800pal.rom", 0xF000, 0x1000,CRC( 0xd5b61170 ))
    ROM_LOAD ("7800pal.rom", 0xc000, 0x4000,CRC( 0xd5b61170 ))
ROM_END

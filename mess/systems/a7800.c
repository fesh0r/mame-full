...
static MEMORY_READ_START( readmem )
    ...
    { 0x0040, 0x00FF, MRA8_BANK5 },		/* RAM0 */
    { 0x0100, 0x011f, a7800_TIA_r },
    { 0x0120, 0x013f, a7800_MARIA_r },
    { 0x0140, 0x01FF, MRA8_BANK6 },		/* RAM1 */
    ...
    { 0x2800, 0x2FFF, MRA8_BANK7 },		/* MAINRAM */
    { 0x3000, 0x37FF, MRA8_BANK7 },		/* MAINRAM */
    { 0x3800, 0x3FFF, MRA8_BANK7 },		/* MAINRAM */
    { 0x4000, 0x7FFF, MRA8_BANK1 },		/* f18 hornet */
    { 0x8000, 0x9FFF, MRA8_BANK2 },		/* sc */
    { 0xA000, 0xBFFF, MRA8_BANK3 },		/* sc + ac */
    { 0xC000, 0xDFFF, MRA8_BANK4 },		/* ac */
...
static MEMORY_WRITE_START( writemem )
    ...
    { 0x2800, 0x2FFF, MWA8_BANK7 },		/* MAINRAM */
    { 0x3000, 0x37FF, MWA8_BANK7 },		/* MAINRAM */
    { 0x3800, 0x3FFF, MWA8_BANK7 },		/* MAINRAM */

...
INPUT_PORTS_START( pc88sr )
	/* [0] */
	PORT_START
	PORT_KEY1 (0x01, IP_ACTIVE_LOW, "pad 0", KEYCODE_0_PAD, CODE_NONE, UCHAR_MAMEKEY(0_PAD))
	PORT_KEY1 (0x02, IP_ACTIVE_LOW, "pad 1", KEYCODE_1_PAD, CODE_NONE, UCHAR_MAMEKEY(1_PAD))
	PORT_KEY1 (0x04, IP_ACTIVE_LOW, "pad 2", KEYCODE_2_PAD, CODE_NONE, UCHAR_MAMEKEY(2_PAD))
	PORT_KEY1 (0x08, IP_ACTIVE_LOW, "pad 3", KEYCODE_3_PAD, CODE_NONE, UCHAR_MAMEKEY(3_PAD))
	PORT_KEY1 (0x10, IP_ACTIVE_LOW, "pad 4", KEYCODE_4_PAD, CODE_NONE, UCHAR_MAMEKEY(4_PAD))
	PORT_KEY1 (0x20, IP_ACTIVE_LOW, "pad 5", KEYCODE_5_PAD, CODE_NONE, UCHAR_MAMEKEY(5_PAD))
	PORT_KEY1 (0x40, IP_ACTIVE_LOW, "pad 6", KEYCODE_6_PAD, CODE_NONE, UCHAR_MAMEKEY(6_PAD))
	PORT_KEY1 (0x80, IP_ACTIVE_LOW, "pad 7", KEYCODE_7_PAD, CODE_NONE, UCHAR_MAMEKEY(7_PAD))

	/* [1] */
	PORT_START
	PORT_KEY1 (0x01, IP_ACTIVE_LOW, "pad 8", KEYCODE_8_PAD, CODE_NONE, UCHAR_MAMEKEY(8_PAD))
	PORT_KEY1 (0x02, IP_ACTIVE_LOW, "pad 9", KEYCODE_9_PAD, CODE_NONE, UCHAR_MAMEKEY(9_PAD))
	PORT_KEY1 (0x04, IP_ACTIVE_LOW, "pad *", KEYCODE_ASTERISK, CODE_NONE, UCHAR_MAMEKEY(ASTERISK))
	PORT_KEY1 (0x08, IP_ACTIVE_LOW, "pad +", KEYCODE_PLUS_PAD, CODE_NONE, UCHAR_MAMEKEY(PLUS_PAD))
	PORT_KEY1 (0x10, IP_ACTIVE_LOW, "pad =", KEYCODE_END, CODE_NONE, UCHAR_MAMEKEY(END)) /* BAD */
	PORT_KEY1 (0x20, IP_ACTIVE_LOW, "pad ,", KEYCODE_NUMLOCK, CODE_NONE, UCHAR_MAMEKEY(NUMLOCK)) /* BAD */
	PORT_KEY1 (0x40, IP_ACTIVE_LOW, "pad .", KEYCODE_DEL_PAD, CODE_NONE, UCHAR_MAMEKEY(DEL_PAD))
	PORT_KEY1 (0x80, IP_ACTIVE_LOW, "pad return", KEYCODE_ENTER, KEYCODE_ENTER_PAD, 13)

	/* [2] */
	PORT_START
	PORT_KEY2 (0x01, IP_ACTIVE_LOW, "@ ~", KEYCODE_OPENBRACE, CODE_NONE, '@', '~')
	PORT_KEY2 (0x02, IP_ACTIVE_LOW, "a A", KEYCODE_A, CODE_NONE, 'a', 'A')
	PORT_KEY2 (0x04, IP_ACTIVE_LOW, "b B", KEYCODE_B, CODE_NONE, 'b', 'B')
	PORT_KEY2 (0x08, IP_ACTIVE_LOW, "c C", KEYCODE_C, CODE_NONE, 'c', 'C')
	PORT_KEY2 (0x10, IP_ACTIVE_LOW, "d D", KEYCODE_D, CODE_NONE, 'd', 'D')
	PORT_KEY2 (0x20, IP_ACTIVE_LOW, "e E", KEYCODE_E, CODE_NONE, 'e', 'E')
	PORT_KEY2 (0x40, IP_ACTIVE_LOW, "f F", KEYCODE_F, CODE_NONE, 'f', 'F')
	PORT_KEY2 (0x80, IP_ACTIVE_LOW, "g G", KEYCODE_G, CODE_NONE, 'g', 'G')

	/* [3] */
	PORT_START
	PORT_KEY2 (0x01, IP_ACTIVE_LOW, "h H", KEYCODE_H, CODE_NONE, 'h', 'H')
	PORT_KEY2 (0x02, IP_ACTIVE_LOW, "i I", KEYCODE_I, CODE_NONE, 'i', 'I')
	PORT_KEY2 (0x04, IP_ACTIVE_LOW, "j J", KEYCODE_J, CODE_NONE, 'j', 'J')
	PORT_KEY2 (0x08, IP_ACTIVE_LOW, "k K", KEYCODE_K, CODE_NONE, 'k', 'K')
	PORT_KEY2 (0x10, IP_ACTIVE_LOW, "l L", KEYCODE_L, CODE_NONE, 'l', 'L')
	PORT_KEY2 (0x20, IP_ACTIVE_LOW, "m M", KEYCODE_M, CODE_NONE, 'm', 'M')
	PORT_KEY2 (0x40, IP_ACTIVE_LOW, "n N", KEYCODE_N, CODE_NONE, 'n', 'N')
	PORT_KEY2 (0x80, IP_ACTIVE_LOW, "o O", KEYCODE_O, CODE_NONE, 'o', 'O')

	/* [4] */
	PORT_START
	PORT_KEY2 (0x01, IP_ACTIVE_LOW, "p P", KEYCODE_P, CODE_NONE, 'p', 'P')
	PORT_KEY2 (0x02, IP_ACTIVE_LOW, "q Q", KEYCODE_Q, CODE_NONE, 'q', 'Q')
	PORT_KEY2 (0x04, IP_ACTIVE_LOW, "r R", KEYCODE_R, CODE_NONE, 'r', 'R')
	PORT_KEY2 (0x08, IP_ACTIVE_LOW, "s S", KEYCODE_S, CODE_NONE, 's', 'S')
	PORT_KEY2 (0x10, IP_ACTIVE_LOW, "t T", KEYCODE_T, CODE_NONE, 't', 'T')
	PORT_KEY2 (0x20, IP_ACTIVE_LOW, "u U", KEYCODE_U, CODE_NONE, 'u', 'U')
	PORT_KEY2 (0x40, IP_ACTIVE_LOW, "v V", KEYCODE_V, CODE_NONE, 'v', 'V')
	PORT_KEY2 (0x80, IP_ACTIVE_LOW, "w W", KEYCODE_W, CODE_NONE, 'w', 'W')

	/* [5] */
	PORT_START
	PORT_KEY2 (0x01, IP_ACTIVE_LOW, "x X", KEYCODE_X, CODE_NONE, 'x', 'X')
	PORT_KEY2 (0x02, IP_ACTIVE_LOW, "y Y", KEYCODE_Y, CODE_NONE, 'y', 'Y')
	PORT_KEY2 (0x04, IP_ACTIVE_LOW, "z Z", KEYCODE_Z, CODE_NONE, 'z', 'Z')
	PORT_KEY2 (0x08, IP_ACTIVE_LOW, "[ {", KEYCODE_CLOSEBRACE, CODE_NONE, '[', '{')
	PORT_KEY2 (0x10, IP_ACTIVE_LOW, "\\ |", KEYCODE_BACKSLASH2, CODE_NONE, '\\', '|')
	PORT_KEY2 (0x20, IP_ACTIVE_LOW, "] }", KEYCODE_BACKSLASH, CODE_NONE, ']', '}')
	PORT_KEY2 (0x40, IP_ACTIVE_LOW, "^ ~", KEYCODE_EQUALS, CODE_NONE, '^', '~')
	PORT_KEY2 (0x80, IP_ACTIVE_LOW, "- =", KEYCODE_MINUS, CODE_NONE, '-', '=')
	...
	PORT_KEY2 (0x04, IP_ACTIVE_LOW, ": *", KEYCODE_QUOTE, CODE_NONE, ':', '*')
	PORT_KEY2 (0x08, IP_ACTIVE_LOW, "; +", KEYCODE_COLON, CODE_NONE, ';', '+')
	PORT_KEY2 (0x10, IP_ACTIVE_LOW, ", <", KEYCODE_COMMA, CODE_NONE, ',', '<')
	PORT_KEY2 (0x20, IP_ACTIVE_LOW, ". >", KEYCODE_STOP, CODE_NONE, '.', '>') 
	PORT_KEY2 (0x40, IP_ACTIVE_LOW, "/ ?", KEYCODE_SLASH, CODE_NONE, '/', '?')
	PORT_KEY2 (0x80, IP_ACTIVE_LOW, "  _", KEYCODE_END, CODE_NONE, 0, '_')
	...
	PORT_KEY1 (0x04, IP_ACTIVE_LOW, "RIGHT", KEYCODE_RIGHT, CODE_NONE, UCHAR_MAMEKEY(RIGHT))
	...
	PORT_BIT (0x20, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("KANA") PORT_CODE(KEYCODE_SCRLOCK) PORT_CODE(CODE_NONE /* BAD */) PORT_TOGGLE
	...
	PORT_KEY1 (0x02, IP_ACTIVE_LOW, "F1", KEYCODE_F1, CODE_NONE, UCHAR_MAMEKEY(F1))
	PORT_KEY1 (0x04, IP_ACTIVE_LOW, "F2", KEYCODE_F2, CODE_NONE, UCHAR_MAMEKEY(F2))
	PORT_KEY1 (0x08, IP_ACTIVE_LOW, "F3", KEYCODE_F3, CODE_NONE /* BAD */, UCHAR_MAMEKEY(F3))
	PORT_KEY1 (0x10, IP_ACTIVE_LOW, "F4", KEYCODE_F4, CODE_NONE /* BAD */, UCHAR_MAMEKEY(F4))
	PORT_KEY1 (0x20, IP_ACTIVE_LOW, "F5", KEYCODE_F5, CODE_NONE, UCHAR_MAMEKEY(F5))
	PORT_KEY1 (0x40, IP_ACTIVE_LOW, "SPACE", KEYCODE_SPACE, CODE_NONE, ' ')
	PORT_KEY1 (0x80, IP_ACTIVE_LOW, "ESC", KEYCODE_ESC, CODE_NONE, 27 /* BAD */)

	/* [10] */
	PORT_START
	PORT_KEY1 (0x01, IP_ACTIVE_LOW, "TAB", KEYCODE_TAB, CODE_NONE, 9 /* BAD */)
	PORT_KEY1 (0x02, IP_ACTIVE_LOW, "DOWN", KEYCODE_DOWN, CODE_NONE, UCHAR_MAMEKEY(DOWN))
	PORT_KEY1 (0x04, IP_ACTIVE_LOW, "LEFT", KEYCODE_LEFT, CODE_NONE, UCHAR_MAMEKEY(LEFT))
	...
	PORT_KEY1 (0x20, IP_ACTIVE_LOW, "-", KEYCODE_MINUS_PAD, CODE_NONE, '-')
	PORT_KEY1 (0x40, IP_ACTIVE_LOW, "/", KEYCODE_SLASH_PAD, CODE_NONE, '/')
	PORT_BIT (0x80, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("CAPS") PORT_CODE(KEYCODE_CAPSLOCK) PORT_CODE(CODE_NONE /* BAD? */) PORT_TOGGLE

	/* [11] */
	PORT_START
	PORT_KEY1 (0x01, IP_ACTIVE_LOW, "ROLL UP", KEYCODE_PGUP, CODE_NONE /* BAD? */, UCHAR_MAMEKEY(PGUP))
	PORT_KEY1 (0x02, IP_ACTIVE_LOW, "ROLL DOWN", KEYCODE_PGDN, CODE_NONE /* BAD? */, UCHAR_MAMEKEY(PGDN))

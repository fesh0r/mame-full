...
ROM_START(nc100)
        ...
        ROM_LOAD("nc100.rom", 0x010000, 0x040000, CRC(0a699eca3))
ROM_END

ROM_START(nc100a)
        ROM_REGION(((64*1024)+(256*1024)), REGION_CPU1,0)
        ROM_LOAD("nc100a.rom", 0x010000, 0x040000, CRC(0849884f9))
ROM_END

ROM_START(nc200)
        ROM_REGION(((64*1024)+(512*1024)), REGION_CPU1,0)
        ROM_LOAD("nc200.rom", 0x010000, 0x080000, CRC(0bb8180e7))
ROM_END

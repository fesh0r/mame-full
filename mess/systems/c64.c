...
#define C64_KEYBOARD																								\
	PORT_START																										\
	PORT_KEY0( 0x8000, IP_ACTIVE_HIGH, "Arrow-Left",		KEYCODE_TILDE,		CODE_NONE)						\
	PORT_KEY2( 0x4000, IP_ACTIVE_HIGH, "1 !   BLK   ORNG",	KEYCODE_1,			CODE_NONE, '1', '!')				\
	PORT_KEY2( 0x2000, IP_ACTIVE_HIGH, "2 \"   WHT   BRN",	KEYCODE_2,			CODE_NONE, '2', '\"')				\
	PORT_KEY2( 0x1000, IP_ACTIVE_HIGH, "3 #   RED   L RED", KEYCODE_3,			CODE_NONE, '3', '#')				\
	PORT_KEY2( 0x0800, IP_ACTIVE_HIGH, "4 $   CYN   D GREY",KEYCODE_4,			CODE_NONE, '4', '$')				\
	PORT_KEY2( 0x0400, IP_ACTIVE_HIGH, "5 %   PUR   GREY",  KEYCODE_5,			CODE_NONE, '5', '%')				\
	PORT_KEY2( 0x0200, IP_ACTIVE_HIGH, "6 &   GRN   L GRN", KEYCODE_6,			CODE_NONE, '6', '&')				\
	PORT_KEY2( 0x0100, IP_ACTIVE_HIGH, "7 '   BLU   L BLU", KEYCODE_7,			CODE_NONE, '7', '\'')				\
	PORT_KEY2( 0x0080, IP_ACTIVE_HIGH, "8 (   YEL   L GREY",KEYCODE_8,			CODE_NONE, '8', '(')				\
	PORT_KEY2( 0x0040, IP_ACTIVE_HIGH, "9 )   RVS-ON",		KEYCODE_9,			CODE_NONE, '9', ')')				\
	PORT_KEY1( 0x0020, IP_ACTIVE_HIGH, "0     RVS-OFF",		KEYCODE_0,			CODE_NONE, '0')					\
	PORT_KEY1( 0x0010, IP_ACTIVE_HIGH, "+",					KEYCODE_PLUS_PAD,	CODE_NONE, '+')					\
	PORT_KEY1( 0x0008, IP_ACTIVE_HIGH, "-",					KEYCODE_MINUS_PAD,	CODE_NONE, '-')					\
	PORT_KEY1( 0x0004, IP_ACTIVE_HIGH, "Pound",				KEYCODE_MINUS,		CODE_NONE, '\xA3')				\
	PORT_KEY1( 0x0002, IP_ACTIVE_HIGH, "HOME CLR",			KEYCODE_EQUALS,		CODE_NONE, UCHAR_MAMEKEY(HOME))	\
	PORT_KEY2( 0x0001, IP_ACTIVE_HIGH, "DEL INST",			KEYCODE_BACKSPACE,	CODE_NONE, 8, UCHAR_MAMEKEY(INSERT))	\
	PORT_START																										\
	PORT_KEY0( 0x8000, IP_ACTIVE_HIGH, "CTRL",			KEYCODE_RCONTROL, KEYCODE_LCONTROL)							\
	PORT_KEY1( 0x4000, IP_ACTIVE_HIGH, "Q",					KEYCODE_Q,			CODE_NONE, 'Q' )					\
	PORT_KEY1( 0x2000, IP_ACTIVE_HIGH, "W",					KEYCODE_W,			CODE_NONE, 'W' )					\
	PORT_KEY1( 0x1000, IP_ACTIVE_HIGH, "E",					KEYCODE_E,			CODE_NONE, 'E' )					\
	PORT_KEY1( 0x0800, IP_ACTIVE_HIGH, "R",					KEYCODE_R,			CODE_NONE, 'R' )					\
	PORT_KEY1( 0x0400, IP_ACTIVE_HIGH, "T",					KEYCODE_T,			CODE_NONE, 'T' )					\
	PORT_KEY1( 0x0200, IP_ACTIVE_HIGH, "Y",					KEYCODE_Y,			CODE_NONE, 'Y' )					\
	PORT_KEY1( 0x0100, IP_ACTIVE_HIGH, "U",					KEYCODE_U,			CODE_NONE, 'U' )					\
	PORT_KEY1( 0x0080, IP_ACTIVE_HIGH, "I",					KEYCODE_I,			CODE_NONE, 'I' )					\
	PORT_KEY1( 0x0040, IP_ACTIVE_HIGH, "O",					KEYCODE_O,			CODE_NONE, 'O' )					\
	PORT_KEY1( 0x0020, IP_ACTIVE_HIGH, "P",					KEYCODE_P,			CODE_NONE, 'P' )					\
	PORT_KEY0( 0x0010, IP_ACTIVE_HIGH, "At",				KEYCODE_OPENBRACE,	CODE_NONE)						\
    PORT_KEY1( 0x0008, IP_ACTIVE_HIGH, "*", 				KEYCODE_ASTERISK,	CODE_NONE, '*')					\
	PORT_KEY0( 0x0004, IP_ACTIVE_HIGH, "Arrow-Up Pi",		KEYCODE_CLOSEBRACE,	CODE_NONE)						\
    PORT_KEY0( 0x0002, IP_ACTIVE_HIGH, "RESTORE",			KEYCODE_PRTSCR,		CODE_NONE)						\
	PORT_KEY0( 0x0001, IP_ACTIVE_HIGH, "STOP RUN",			KEYCODE_TAB,		CODE_NONE)						\
	PORT_START																										\
	PORT_DIPNAME( 0x8000, IP_ACTIVE_HIGH,												 "SHIFT-LOCK (switch)") PORT_CODE(KEYCODE_CAPSLOCK)\
	PORT_DIPSETTING( 0x0000, DEF_STR( Off ) )																		\
	PORT_DIPSETTING( 0x8000, DEF_STR( On ) )																		\
	PORT_KEY1( 0x4000, IP_ACTIVE_HIGH, "A",					KEYCODE_A,			CODE_NONE, 'A' )					\
	PORT_KEY1( 0x2000, IP_ACTIVE_HIGH, "S",					KEYCODE_S,			CODE_NONE, 'S' )					\
	PORT_KEY1( 0x1000, IP_ACTIVE_HIGH, "D",					KEYCODE_D,			CODE_NONE, 'D' )					\
	PORT_KEY1( 0x0800, IP_ACTIVE_HIGH, "F",					KEYCODE_F,			CODE_NONE, 'F' )					\
	PORT_KEY1( 0x0400, IP_ACTIVE_HIGH, "G",					KEYCODE_G,			CODE_NONE, 'G' )					\
	PORT_KEY1( 0x0200, IP_ACTIVE_HIGH, "H",					KEYCODE_H,			CODE_NONE, 'H' )					\
	PORT_KEY1( 0x0100, IP_ACTIVE_HIGH, "J",					KEYCODE_J,			CODE_NONE, 'J' )					\
	PORT_KEY1( 0x0080, IP_ACTIVE_HIGH, "K",					KEYCODE_K,			CODE_NONE, 'K' )					\
	PORT_KEY1( 0x0040, IP_ACTIVE_HIGH, "L",					KEYCODE_L,			CODE_NONE, 'L' )					\
	PORT_KEY2( 0x0020, IP_ACTIVE_HIGH, ": [",				KEYCODE_COLON,		CODE_NONE, ':', '[' )				\
	PORT_KEY2( 0x0010, IP_ACTIVE_HIGH, "; ]",				KEYCODE_QUOTE,		CODE_NONE, 'I', 'i' )				\
	PORT_KEY1( 0x0008, IP_ACTIVE_HIGH, "=",					KEYCODE_BACKSLASH,	CODE_NONE, '=' )					\
	PORT_KEY1( 0x0004, IP_ACTIVE_HIGH, "RETURN",			KEYCODE_ENTER,		CODE_NONE, '\r' )					\
	PORT_KEY0( 0x0002, IP_ACTIVE_HIGH, "CBM",				KEYCODE_RALT,		CODE_NONE)						\
	PORT_KEY1( 0x0001, IP_ACTIVE_HIGH, "Left-Shift",		KEYCODE_LSHIFT,		CODE_NONE, UCHAR_SHIFT_1)			\
	PORT_START																										\
	PORT_KEY1( 0x8000, IP_ACTIVE_HIGH, "Z",					KEYCODE_Z,			CODE_NONE, 'Z' )					\
	PORT_KEY1( 0x4000, IP_ACTIVE_HIGH, "X",					KEYCODE_X,			CODE_NONE, 'X' )					\
	PORT_KEY1( 0x2000, IP_ACTIVE_HIGH, "C",					KEYCODE_C,			CODE_NONE, 'C' )					\
	PORT_KEY1( 0x1000, IP_ACTIVE_HIGH, "V",					KEYCODE_V,			CODE_NONE, 'V' )					\
	PORT_KEY1( 0x0800, IP_ACTIVE_HIGH, "B",					KEYCODE_B,			CODE_NONE, 'B' )					\
	PORT_KEY1( 0x0400, IP_ACTIVE_HIGH, "N",					KEYCODE_N,			CODE_NONE, 'N' )					\
	PORT_KEY1( 0x0200, IP_ACTIVE_HIGH, "M",					KEYCODE_M,			CODE_NONE, 'M' )					\
	PORT_KEY2( 0x0100, IP_ACTIVE_HIGH, ", <",				KEYCODE_COMMA,		CODE_NONE, ',', '<' )				\
	PORT_KEY2( 0x0080, IP_ACTIVE_HIGH, ". >",				KEYCODE_STOP,		CODE_NONE, '.', '>' )				\
	PORT_KEY2( 0x0040, IP_ACTIVE_HIGH, "/ ?",				KEYCODE_SLASH,		CODE_NONE, '/', '?' )				\
	PORT_KEY1( 0x0020, IP_ACTIVE_HIGH, "Right-Shift",		KEYCODE_RSHIFT,		CODE_NONE, UCHAR_SHIFT_1)			\
	PORT_KEY0( 0x0010, IP_ACTIVE_HIGH, "CRSR-DOWN UP",		KEYCODE_2_PAD,		CODE_NONE)						\
	PORT_KEY0( 0x0008, IP_ACTIVE_HIGH, "CRSR-RIGHT LEFT",	KEYCODE_6_PAD,		CODE_NONE)						\
	PORT_KEY1( 0x0004, IP_ACTIVE_HIGH, "Space",				KEYCODE_SPACE,		CODE_NONE, ' ' )					\
	PORT_KEY2( 0x0002, IP_ACTIVE_HIGH, "F1 F2",				KEYCODE_F1,			CODE_NONE, UCHAR_MAMEKEY(F1), UCHAR_MAMEKEY(F2) )\
	PORT_KEY2( 0x0001, IP_ACTIVE_HIGH, "F3 F4",				KEYCODE_F2,			CODE_NONE, UCHAR_MAMEKEY(F3), UCHAR_MAMEKEY(F4) )\
	PORT_START \
	PORT_KEY2( 0x8000, IP_ACTIVE_HIGH, "F5 F6",				KEYCODE_F3,			CODE_NONE, UCHAR_MAMEKEY(F5), UCHAR_MAMEKEY(F6) )\
	PORT_KEY2( 0x4000, IP_ACTIVE_HIGH, "F7 F8",				KEYCODE_F4,			CODE_NONE, UCHAR_MAMEKEY(F7), UCHAR_MAMEKEY(F8) )\
	PORT_KEY0( 0x2000, IP_ACTIVE_HIGH, "(Right-Shift Cursor-Down)Special CRSR Up", \
															KEYCODE_8_PAD,		CODE_NONE)				\
	PORT_KEY0( 0x1000, IP_ACTIVE_HIGH, "(Right-Shift Cursor-Right)Special CRSR Left", \
															KEYCODE_4_PAD,		CODE_NONE)				\

...
INPUT_PORTS_START( vc4000 )
    ...
    PORT_START
PORT_ANALOGX(0x1ff,0x70,IPT_AD_STICK_X,100,1,20,225,KEYCODE_LEFT,KEYCODE_RIGHT,JOYCODE_1_LEFT,JOYCODE_1_RIGHT) PORT_CENTER
    PORT_START
PORT_ANALOGX(0x1ff,0x70,IPT_AD_STICK_Y,100,1,20,225,KEYCODE_UP,KEYCODE_DOWN,JOYCODE_1_UP,JOYCODE_1_DOWN) PORT_CENTER
    PORT_START
PORT_ANALOGX(0x1ff,0x70,IPT_AD_STICK_X,100,1,20,225,KEYCODE_DEL,KEYCODE_PGDN,JOYCODE_2_LEFT,JOYCODE_2_RIGHT) PORT_PLAYER(2) PORT_CENTER
    PORT_START
PORT_ANALOGX(0x1ff,0x70,IPT_AD_STICK_Y,100,1,20,225,KEYCODE_HOME,KEYCODE_END,JOYCODE_2_UP,JOYCODE_2_DOWN) PORT_PLAYER(2) PORT_CENTER
#else
	PORT_START

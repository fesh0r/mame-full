...
INPUT_PORTS_START( arcadia )
    ...
    PORT_START
PORT_ANALOGX(0x1ff,0x10,IPT_AD_STICK_X,1,2000,0,0x1f,KEYCODE_LEFT,KEYCODE_RIGHT,JOYCODE_1_LEFT,JOYCODE_1_RIGHT) PORT_CENTER
    PORT_START
PORT_ANALOGX(0x1ff,0x10,IPT_AD_STICK_Y,1,2000,0,0x1f,KEYCODE_UP,KEYCODE_DOWN,JOYCODE_1_UP,JOYCODE_1_DOWN) PORT_CENTER
    PORT_START
PORT_ANALOGX(0x1ff,0x10,IPT_AD_STICK_X,100,10,0,0x1f,KEYCODE_DEL,KEYCODE_PGDN,JOYCODE_2_LEFT,JOYCODE_2_RIGHT) PORT_PLAYER(2) PORT_CENTER
    PORT_START
PORT_ANALOGX(0x1ff,0x10,IPT_AD_STICK_Y,100,10,0,0x1f,KEYCODE_HOME,KEYCODE_END,JOYCODE_2_UP,JOYCODE_2_DOWN) PORT_PLAYER(2) PORT_CENTER
#else
	PORT_START

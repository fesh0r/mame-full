...
ROM_START(kc85_4)
    ...
    ROM_LOAD("basic_c0.854", 0x10000, 0x2000,CRC( 0xdfe34b08))
    ROM_LOAD("caos__c0.854", 0x12000, 0x1000,CRC( 0x57d9ab02))
    ROM_LOAD("caos__e0.854", 0x13000, 0x2000,CRC( 0xd64cd50b))
ROM_END
...
ROM_START(kc85_3)
    ...
    ROM_LOAD("basic_c0.854", 0x10000, 0x2000,CRC( 0xdfe34b08))
	ROM_LOAD("caos__e0.853", 0x12000, 0x2000,CRC( 0x52bc2199))
ROM_END

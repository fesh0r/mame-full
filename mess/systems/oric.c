...
SYSTEM_CONFIG_START(oric1)
	...
	CONFIG_DEVICE_LEGACY(IO_FLOPPY, 4, "dsk\0", DEVICE_LOAD_RESETS_NONE, OSD_FOPEN_RW_CREATE_OR_READ, oric_floppy_init, oric_floppy_exit, floppy_status)
SYSTEM_CONFIG_END

SYSTEM_CONFIG_START(prav8)
	CONFIG_IMPORT_FROM(oric_common)
	CONFIG_DEVICE_LEGACY(IO_FLOPPY, 1, "dsk\0bin\0", DEVICE_LOAD_RESETS_NONE, OSD_FOPEN_READ, apple2_floppy_init, NULL, NULL)
SYSTEM_CONFIG_END

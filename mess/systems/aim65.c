...
//	DIPS_HELPER( 0x0800, "???", KEYCODE_EQUALS, CODE_NONE)
//	DIPS_HELPER( 0x1000, "???", KEYCODE_BACKSPACE, CODE_NONE)
	PORT_START
	// maybe 1 key
	...
	DIPS_HELPER( 0x0400, "??[", KEYCODE_OPENBRACE, CODE_NONE)
	DIPS_HELPER( 0x0800, "??]", KEYCODE_CLOSEBRACE, CODE_NONE)
	DIPS_HELPER( 0x1000, "Return", KEYCODE_ENTER, CODE_NONE)
	PORT_START
...
//	DIPS_HELPER( 0x1000, "???", KEYCODE_BACKSLASH, CODE_NONE)
//	DIPS_HELPER( 0x2000, "???", KEYCODE_0_PAD, CODE_NONE)
	PORT_START
	...
	PORT_START
	DIPS_HELPER( 0x8000, "??-     =", KEYCODE_EQUALS, CODE_NONE)
	DIPS_HELPER( 0x4000, "??^     F3", KEYCODE_BACKSLASH, CODE_NONE)
	DIPS_HELPER( 0x2000, "??PRINT", KEYCODE_TILDE, CODE_NONE)
	DIPS_HELPER( 0x1000, "??DEL", KEYCODE_BACKSPACE, CODE_NONE)
	DIPS_HELPER( 0x0800, "??ESC", KEYCODE_ESC, CODE_NONE)

...
//	ROM_LOAD ("aim65bas.z26", 0xb000, 0x1000,CRC( 0x36a61f39))
//	ROM_LOAD ("aim65bas.z25", 0xc000, 0x1000,CRC( 0xd7b42d2a))
//	ROM_LOAD ("aim65ass.z24", 0xd000, 0x1000,CRC( 0x0878b399))
	ROM_LOAD ("aim65mon.z23", 0xe000, 0x1000,CRC( 0x90e44afe))
	ROM_LOAD ("aim65mon.z22", 0xf000, 0x1000,CRC( 0xd01914b0))

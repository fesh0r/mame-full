...
ROM_START(bbca)
	ROM_REGION(0x04000,REGION_CPU1) /* RAM */

	ROM_REGION(0x14000,REGION_CPU2) /* ROM */
...
ROM_START(bbcb)
	ROM_REGION(0x08000,REGION_CPU1) /* RAM */

	ROM_REGION(0x44000,REGION_CPU2) /* ROM */
...
ROM_START(bbcbp)
	ROM_REGION(0x10000,REGION_CPU1) /* ROM MEMORY */

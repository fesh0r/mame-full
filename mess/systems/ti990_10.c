...
ROM_START(ti990_10)
	...
	ROM_LOAD16_BYTE("975383.31", 0x1FFC00, 0x100,CRC( 0x64fcd040))
	ROM_LOAD16_BYTE("975383.32", 0x1FFC01, 0x100,CRC( 0x64277276))
	ROM_LOAD16_BYTE("975383.29", 0x1FFE00, 0x100,CRC( 0xaf92e7bf))
	ROM_LOAD16_BYTE("975383.30", 0x1FFE01, 0x100,CRC( 0xb7b40cdc))
	...
	ROM_LOAD16_BYTE("975383.45", 0x1FFC00, 0x100,CRC( 0x391943c7))
	ROM_LOAD16_BYTE("975383.46", 0x1FFC01, 0x100,CRC( 0xf40f7c18))
	ROM_LOAD16_BYTE("975383.47", 0x1FFE00, 0x100,CRC( 0x1ba571d8))
	ROM_LOAD16_BYTE("975383.48", 0x1FFE01, 0x100,CRC( 0x8852b09e))
	...
	ROM_LOAD16_BYTE("ti2025-7", 0x1FFC00, 0x1000,CRC( 0x4824f89c))
	ROM_LOAD16_BYTE("ti2025-8", 0x1FFC01, 0x1000,CRC( 0x51fef543))

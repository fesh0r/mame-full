...
SYSTEM_CONFIG_START(ti990_10)
	CONFIG_DEVICE_LEGACY(IO_HARDDISK, 4, "hd\0", DEVICE_LOAD_RESETS_NONE, OSD_FOPEN_RW_OR_READ, NULL, NULL, device_load_ti990_hd, device_unload_ti990_hd, NULL)
	CONFIG_DEVICE_LEGACY(IO_CASSETTE, 4, "tap\0", DEVICE_LOAD_RESETS_NONE, OSD_FOPEN_RW_OR_READ, NULL, NULL, device_load_ti990_cassette, device_unload_ti990_cassette, NULL)
SYSTEM_CONFIG_END

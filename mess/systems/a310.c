...
ROM_START(a310)
	ROM_REGION(0x00400000,REGION_CPU1,0)
		ROM_LOAD("ic24.rom", 0x00200000, 0x00080000, CRC(c1adde84))
		ROM_LOAD("ic25.rom", 0x00280000, 0x00080000, CRC(15d89664))
		ROM_LOAD("ic26.rom", 0x00300000, 0x00080000, CRC(a81ceb7c))
		ROM_LOAD("ic27.rom", 0x00380000, 0x00080000, CRC(707b0c6c))

...
PALETTE_INIT( ql )
{
	palette_set_color(machine,  0x00, 0x00, 0x00, 0x00 );
	palette_set_color(machine,  0x01, 0x00, 0x00, 0xff );
	palette_set_color(machine,  0x02, 0x00, 0xff, 0x00 );
	palette_set_color(machine,  0x03, 0x00, 0xff, 0xff );
	palette_set_color(machine,  0x04, 0xff, 0x00, 0x00 );
	palette_set_color(machine,  0x05, 0xff, 0x00, 0xff );
	palette_set_color(machine,  0x06, 0xff, 0xff, 0x00 );
	palette_set_color(machine,  0x07, 0xff, 0xff, 0xff );
}
...
INPUT_PORTS_START( ql )
	...
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_KEYBOARD ) PORT_CODE(KEYCODE_LEFT) PORT_CHAR(UCHAR_MAMEKEY(LEFT)) PORT_NAME("\xE2\x86\x90") 
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_KEYBOARD ) PORT_CODE(KEYCODE_ESC) PORT_CHAR(UCHAR_MAMEKEY(ESC)) PORT_NAME("ESC \xC2\xA9") 
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_KEYBOARD ) PORT_CODE(KEYCODE_RIGHT) PORT_CHAR(UCHAR_MAMEKEY(RIGHT)) PORT_NAME("\xE2\x86\x92") 
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_KEYBOARD ) PORT_CODE(KEYCODE_SPACE) PORT_CHAR(' ') PORT_NAME("SPACE") 
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_KEYBOARD ) PORT_CODE(KEYCODE_4) PORT_CHAR('4') PORT_CHAR('$')
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_KEYBOARD ) PORT_CODE(KEYCODE_DOWN) PORT_CHAR(UCHAR_MAMEKEY(DOWN)) PORT_NAME("\xE2\x86\x93") 

...
INPUT_PORTS_START( adam )
    ...
    PORT_BIT( 0x0f, 0x00, IPT_TRACKBALL_Y) PORT_SENSITIVITY(20) PORT_KEYDELTA(10) PORT_MINMAX(0,0) PORT_CODE_DEC(KEYCODE_I) PORT_CODE_INC(KEYCODE_K) PORT_CODE_INC(CODE_NONE ) PORT_PLAYER(2) PORT_RESET
...
ROM_START (adam)
	...
	ROM_CART_LOAD(0, "rom\0col\0bin\0", 0x28000, 0x8000, ROM_NOMIRROR | ROM_OPTIONAL)

...
static PALETTE_INIT( c65 )
{
	...
	ROM_LOAD ("910111.bin", 0x20000, 0x20000,CRC( 0xc5d8d32e))
	/* b96b */
	/* dma routine alpha 2 */
	ROM_LOAD ("910523.bin", 0x20000, 0x20000,CRC( 0xe8235dd4))
	/* 888c */
	/* dma routine alpha 2 */
	ROM_LOAD ("910626.bin", 0x20000, 0x20000,CRC( 0x12527742))
	/* c9cd */
	/* dma routine alpha 2 */
	ROM_LOAD ("910828.bin", 0x20000, 0x20000,CRC( 0x3ee40b06))
	/* 4bcf loading demo disk??? */
	/* basic program stored at 0x4000 ? */
	/* dma routine alpha 2 */
	ROM_LOAD ("911001.bin", 0x20000, 0x20000,CRC( 0x0888b50f))
	/* german e96a */
	/* dma routine alpha 1 */
	ROM_LOAD ("910429.bin", 0x20000, 0x20000,CRC( 0xb025805c))
#endif

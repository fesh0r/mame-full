...
INPUT_PORTS_START( jaguar )
	...
	PORT_BIT ( 0x0fff, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_START  /* [8] */
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, 0| IPT_BUTTON5) PORT_NAME("Pause") PORT_CODE(KEYCODE_P) PORT_CODE(JOYCODE_1_BUTTON5 ) PORT_PLAYER(1)
	...
	PORT_BIT ( 0xfffd, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_START  /* [15] */
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, 0| IPT_BUTTON5) PORT_NAME("Pause") PORT_CODE(KEYCODE_ENTER_PAD) PORT_CODE(JOYCODE_2_BUTTON5 ) PORT_PLAYER(2)

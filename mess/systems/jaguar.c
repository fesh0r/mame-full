...
INPUT_PORTS_START( jaguar )
    PORT_START  /* [0] */
    PORT_BIT( 0x0800, IP_ACTIVE_LOW, 0| IPT_JOYSTICK_RIGHT) PORT_NAME("Right") PORT_CODE(KEYCODE_RIGHT) PORT_CODE(JOYCODE_1_RIGHT ) PORT_PLAYER(1)
    PORT_BIT( 0x0400, IP_ACTIVE_LOW, 0| IPT_JOYSTICK_LEFT) PORT_NAME("Left") PORT_CODE(KEYCODE_LEFT) PORT_CODE(JOYCODE_1_LEFT ) PORT_PLAYER(1)
    PORT_BIT( 0x0200, IP_ACTIVE_LOW, 0| IPT_JOYSTICK_DOWN) PORT_NAME("Down") PORT_CODE(KEYCODE_DOWN) PORT_CODE(JOYCODE_1_DOWN ) PORT_PLAYER(1)
    PORT_BIT( 0x0100, IP_ACTIVE_LOW, 0| IPT_JOYSTICK_UP) PORT_NAME("Up") PORT_CODE(KEYCODE_UP) PORT_CODE(JOYCODE_1_UP ) PORT_PLAYER(1)
	PORT_BIT ( 0xf0ff, IP_ACTIVE_LOW, IPT_UNUSED )
    PORT_START  /* [1] */
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, 0) PORT_NAME("*") PORT_CODE(KEYCODE_K) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, 0) PORT_NAME("7") PORT_CODE(KEYCODE_7) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, 0) PORT_NAME("4") PORT_CODE(KEYCODE_4) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, 0) PORT_NAME("1") PORT_CODE(KEYCODE_1) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT ( 0xf0ff, IP_ACTIVE_LOW, IPT_UNUSED )
    PORT_START  /* [2] */
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, 0) PORT_NAME("2") PORT_CODE(KEYCODE_2) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, 0) PORT_NAME("5") PORT_CODE(KEYCODE_5) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, 0) PORT_NAME("8") PORT_CODE(KEYCODE_8) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, 0) PORT_NAME("0") PORT_CODE(KEYCODE_0) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT ( 0xf0ff, IP_ACTIVE_LOW, IPT_UNUSED )
    PORT_START  /* [3] */
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, 0) PORT_NAME("3") PORT_CODE(KEYCODE_3) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, 0) PORT_NAME("6") PORT_CODE(KEYCODE_6) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, 0) PORT_NAME("9") PORT_CODE(KEYCODE_9) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, 0) PORT_NAME("#") PORT_CODE(KEYCODE_L) PORT_CODE(CODE_NONE ) PORT_PLAYER(1)
	PORT_BIT ( 0xf0ff, IP_ACTIVE_LOW, IPT_UNUSED )
    PORT_START  /* [4] */
	PORT_BIT( 0x8000, IP_ACTIVE_LOW, 0) PORT_NAME("3") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT( 0x4000, IP_ACTIVE_LOW, 0) PORT_NAME("6") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, 0) PORT_NAME("9") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT( 0x1000, IP_ACTIVE_LOW, 0) PORT_NAME("#") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT ( 0x0fff, IP_ACTIVE_LOW, IPT_UNUSED )
    PORT_START  /* [5] */
	PORT_BIT( 0x8000, IP_ACTIVE_LOW, 0) PORT_NAME("2") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT( 0x4000, IP_ACTIVE_LOW, 0) PORT_NAME("5") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, 0) PORT_NAME("8") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT( 0x1000, IP_ACTIVE_LOW, 0) PORT_NAME("0") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT ( 0x0fff, IP_ACTIVE_LOW, IPT_UNUSED )
    PORT_START  /* [6] */
	PORT_BIT( 0x8000, IP_ACTIVE_LOW, 0) PORT_NAME("*") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT( 0x4000, IP_ACTIVE_LOW, 0) PORT_NAME("7") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, 0) PORT_NAME("4") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT( 0x1000, IP_ACTIVE_LOW, 0) PORT_NAME("1") PORT_CODE(CODE_NONE ) PORT_PLAYER(2)
	PORT_BIT ( 0x0fff, IP_ACTIVE_LOW, IPT_UNUSED )
    PORT_START  /* [7] */
    PORT_BIT( 0x8000, IP_ACTIVE_LOW, 0| IPT_JOYSTICK_RIGHT) PORT_NAME("Right") PORT_CODE(KEYCODE_6_PAD) PORT_CODE(JOYCODE_2_RIGHT ) PORT_PLAYER(2)
    PORT_BIT( 0x4000, IP_ACTIVE_LOW, 0| IPT_JOYSTICK_LEFT) PORT_NAME("Left") PORT_CODE(KEYCODE_4_PAD) PORT_CODE(JOYCODE_2_LEFT ) PORT_PLAYER(2)
    PORT_BIT( 0x2000, IP_ACTIVE_LOW, 0| IPT_JOYSTICK_DOWN) PORT_NAME("Down") PORT_CODE(KEYCODE_2_PAD) PORT_CODE(JOYCODE_2_DOWN ) PORT_PLAYER(2)
    PORT_BIT( 0x1000, IP_ACTIVE_LOW, 0| IPT_JOYSTICK_UP) PORT_NAME("Up") PORT_CODE(KEYCODE_8_PAD) PORT_CODE(JOYCODE_2_UP ) PORT_PLAYER(2)
	PORT_BIT ( 0x0fff, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_START  /* [8] */
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, 0| IPT_BUTTON5) PORT_NAME(DEF_STR(Pause)) PORT_CODE(KEYCODE_P) PORT_CODE(JOYCODE_1_BUTTON5 ) PORT_PLAYER(1)
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0| IPT_BUTTON1) PORT_NAME("A") PORT_CODE(KEYCODE_A) PORT_CODE(JOYCODE_1_BUTTON1 ) PORT_PLAYER(1)
	PORT_BIT ( 0xfffc, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_START  /* [9] */
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0| IPT_BUTTON2) PORT_NAME("B") PORT_CODE(KEYCODE_S) PORT_CODE(JOYCODE_1_BUTTON2 ) PORT_PLAYER(1)
	PORT_BIT ( 0xfffd, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_START  /* [10] */
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0| IPT_BUTTON3) PORT_NAME("C") PORT_CODE(KEYCODE_X) PORT_CODE(JOYCODE_1_BUTTON3 ) PORT_PLAYER(1)
	PORT_BIT ( 0xfffd, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_START  /* [11] */
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0| IPT_BUTTON4) PORT_NAME("Option") PORT_CODE(KEYCODE_O) PORT_CODE(JOYCODE_1_BUTTON4 ) PORT_PLAYER(1)
	PORT_BIT ( 0xfffd, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_START  /* [12] */
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0| IPT_BUTTON4) PORT_NAME("Option") PORT_CODE(KEYCODE_PLUS_PAD) PORT_CODE(JOYCODE_2_BUTTON4 ) PORT_PLAYER(2)
	PORT_BIT ( 0xfffd, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_START  /* [13] */
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0| IPT_BUTTON3) PORT_NAME("C") PORT_CODE(KEYCODE_MINUS_PAD) PORT_CODE(JOYCODE_2_BUTTON3 ) PORT_PLAYER(2)
	PORT_BIT ( 0xfffd, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_START  /* [14] */
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0| IPT_BUTTON2) PORT_NAME("B") PORT_CODE(KEYCODE_ASTERISK) PORT_CODE(JOYCODE_2_BUTTON2 ) PORT_PLAYER(2)
	PORT_BIT ( 0xfffd, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_START  /* [15] */
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, 0| IPT_BUTTON5) PORT_NAME(DEF_STR(Pause)) PORT_CODE(KEYCODE_ENTER_PAD) PORT_CODE(JOYCODE_2_BUTTON5 ) PORT_PLAYER(2)
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0| IPT_BUTTON1) PORT_NAME("A") PORT_CODE(KEYCODE_SLASH_PAD) PORT_CODE(JOYCODE_2_BUTTON1 ) PORT_PLAYER(2)
	PORT_BIT ( 0xfffc, IP_ACTIVE_LOW, IPT_UNUSED )
INPUT_PORTS_END

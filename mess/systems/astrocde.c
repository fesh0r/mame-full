...
INPUT_PORTS_START( astrocde )
	...
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("%   \xf7         [   ]   LIST") PORT_CODE(KEYCODE_O)
	...
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("\x19   HALT              RUN") PORT_CODE(KEYCODE_PGDN)
	...
	PORT_BIT(0x08, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("6   3     \x18   .   \x19   BOX") PORT_CODE(KEYCODE_6)
	...
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("\x18   PAUSE     /   \\") PORT_CODE(KEYCODE_PGUP)
	...
	PORT_BIT(0x08, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("5   2     \x1b   '   \x1a   LINE") PORT_CODE(KEYCODE_5)

...
#else
	PORT_ANALOGX( 0xff, 0x00, IPT_PADDLE , 85, 20, 0, 255, KEYCODE_X, KEYCODE_Z, CODE_NONE, CODE_NONE )

	PORT_START /* IN9 */	/* Player 2 Knob */
	PORT_ANALOGX( 0xff, 0x00, IPT_PADDLE , 85, 20, 0, 255, KEYCODE_M, KEYCODE_N, CODE_NONE, CODE_NONE )
#endif

...
unsigned DasmCP1600(char *buffer, unsigned pc)
{
	UINT16 op = cp1600_readop(pc);
	UINT16 subop;
	UINT16 ea, ea1, ea2;
	unsigned size = 1;
//	const char *sym, *sym2;
...
//		sym = set_ea_info( 0, 12, EA_UINT8, EA_ZPG_RD );
	...
	case 0x001: /* 0 000 000 001 */
		...
		switch (subop & 0x3f8)
		{
			...
			case 0x2b8: /* 1 010 111 xxx */
				ea1 = cp1600_readop(pc+2);
				ea2 = cp1600_readop(pc+3);
	...
	case 0x004: /* 0 000 000 100 */
		size += 2;
		ea1 = cp1600_readop(pc+1);
		ea2 = cp1600_readop(pc+2);

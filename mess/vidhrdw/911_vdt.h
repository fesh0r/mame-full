...
#define VDT911_KEY_PORTS																		\
	...
	PORT_START	/* keys 81-91 */																\
		...
		PORT_BITX(0x0100, IP_ACTIVE_HIGH, IPT_KEYBOARD, "(not on US keyboard)", KEYCODE_PLUS_PAD, IP_JOY_NONE)	\
		PORT_BITX(0x0200, IP_ACTIVE_HIGH, IPT_KEYBOARD, "SPACE",  KEYCODE_SPACE, IP_JOY_NONE)	\
		PORT_BITX(0x0400, IP_ACTIVE_HIGH, IPT_KEYBOARD, "(not on US keyboard)", KEYCODE_MINUS_PAD, IP_JOY_NONE)

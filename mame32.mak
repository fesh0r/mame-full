...
{src/mess}.c{$(OBJ)/mess}.o:
	$(CC) $(DEFS) $(CFLAGS) -Fo$@ -c $<

{src/mess/systems}.c{$(OBJ)/mess/systems}.o:
	$(CC) $(DEFS) $(CFLAGS) -Fo$@ -c $<

{src/mess/vidhrdw}.c{$(OBJ)/mess/vidhrdw}.o:
	$(CC) $(DEFS) $(CFLAGS) -Fo$@ -c $<

{src/mess/sndhrdw}.c{$(OBJ)/mess/sndhrdw}.o:
	$(CC) $(DEFS) $(CFLAGS) -Fo$@ -c $<

{src/mess/machine}.c{$(OBJ)/mess/machine}.o:
	$(CC) $(DEFS) $(CFLAGS) -Fo$@ -c $<

{src/mess/tools}.c{$(OBJ)/mess/tools}.o:
	$(CC) $(DEFS) $(CFLAGS) -Fo$@ -c $<

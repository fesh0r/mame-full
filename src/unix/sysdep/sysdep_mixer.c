...
static struct rc_option sysdep_mixer_opts[] =
{
	...
	{ "Sound mixer related", NULL, rc_seperator, NULL, NULL, 0, 0, NULL,
 NULL },
	{ "sound-mixer-plugin", "smp", rc_string, &sysdep_mixer_plugin,
 NULL, 0, 0, NULL, "Select which plugin to use for the sound mixer" },
	{ "list-mixer-plugins", "lmp", rc_use_function_no_arg, NULL, NULL, 0, 0, sysdep_mixer_list_plugins, "List available sound mixer plugins" },

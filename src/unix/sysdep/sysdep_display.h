...
#define SYSDEP_DISPLAY_EFFECT_HQ2X      2
#define SYSDEP_DISPLAY_EFFECT_SCAN2_H   3
#define SYSDEP_DISPLAY_EFFECT_RGBSCAN_H 4
#define SYSDEP_DISPLAY_EFFECT_SCAN3_H   5
#define SYSDEP_DISPLAY_EFFECT_SCAN2_V   6
#define SYSDEP_DISPLAY_EFFECT_RGBSCAN_V 7
#define SYSDEP_DISPLAY_EFFECT_SCAN3_V   8
...
/* garbage */
#define SYSDEP_DISPLAY_EFFECT_LQ2X      9

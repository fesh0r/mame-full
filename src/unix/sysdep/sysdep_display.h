...
#define SYSDEP_DISPLAY_EFFECT_SCAN2_H   4
#define SYSDEP_DISPLAY_EFFECT_RGBSCAN_H 5
#define SYSDEP_DISPLAY_EFFECT_SCAN3_H   6
#define SYSDEP_DISPLAY_EFFECT_SCAN2_V   7
#define SYSDEP_DISPLAY_EFFECT_RGBSCAN_V 8
#define SYSDEP_DISPLAY_EFFECT_SCAN3_V   9

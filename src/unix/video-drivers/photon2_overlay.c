...
static void ph_ovr_update_8_to_8bpp (struct osd_bitmap *bitmap);
static void ph_ovr_update_8_to_16bpp (struct osd_bitmap *bitmap);
static void ph_ovr_update_8_to_24bpp (struct osd_bitmap *bitmap);
static void ph_ovr_update_8_to_32bpp (struct osd_bitmap *bitmap);
static void ph_ovr_update_8_to_8bpp_direct (struct osd_bitmap *bitmap);
static void ph_ovr_update_16_to_16bpp (struct osd_bitmap *bitmap);
static void ph_ovr_update_16_to_24bpp (struct osd_bitmap *bitmap);
static void ph_ovr_update_16_to_32bpp (struct osd_bitmap *bitmap);
static void ph_window_update_32_to_32bpp_direct (struct osd_bitmap *bitmap);
static void (*ph_ovr_update_display_func) (struct osd_bitmap *bitmap) = NULL;

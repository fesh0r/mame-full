...
#  ifdef DOUBLEBUFFER
#    define EFFECT(FUNC) \
       effect_##FUNC##_func(effect_dbbuf, effect_dbbuf+visual_width*widthscale*DEST_PIXEL_SIZE, line_src, visual_width, INDIRECT); \
...
#    define EFFECT2X(FUNC) \
       effect_##FUNC##_func(effect_dbbuf, effect_dbbuf+visual_width*2*DEST_PIXEL_SIZE, rotate_dbbuf0, rotate_dbbuf1, rotate_dbbuf2, visual_width, INDIRECT); \
...
#    define EFFECT3X(FUNC) \
       effect_##FUNC##_func(effect_dbbuf, effect_dbbuf+visual_width*widthscale*DEST_PIXEL_SIZE, effect_dbbuf+visual_width*widthscale*DEST_PIXEL_SIZE*2, line_src, visual_width, INDIRECT); \
       MEMCPY(line_dest, effect_dbbuf, visual_width*widthscale*DEST_PIXEL_SIZE); \
       MEMCPY(line_dest+CORRECTED_DEST_WIDTH, effect_dbbuf+visual_width*widthscale*DEST_PIXEL_SIZE, visual_width*widthscale*DEST_PIXEL_SIZE); \
...
#    define EFFECT3X(FUNC) \
       effect_##FUNC##_func(line_dest, line_dest+CORRECTED_DEST_WIDTH, line_dest+CORRECTED_DEST_WIDTH*2, line_src, visual_width, INDIRECT)
#  endif
#else
#  ifdef DOUBLEBUFFER
#    define EFFECT(FUNC) \
       effect_##FUNC##_direct_func(effect_dbbuf, effect_dbbuf+visual_width*widthscale*DEST_PIXEL_SIZE, line_src, visual_width); \
       MEMCPY(line_dest, effect_dbbuf, visual_width*widthscale*DEST_PIXEL_SIZE); \
       MEMCPY(line_dest+CORRECTED_DEST_WIDTH, effect_dbbuf+visual_width*widthscale*DEST_PIXEL_SIZE, visual_width*widthscale*DEST_PIXEL_SIZE)
#    define EFFECT2X(FUNC) \
       effect_##FUNC##_direct_func(effect_dbbuf, effect_dbbuf+visual_width*2*DEST_PIXEL_SIZE, rotate_dbbuf0, rotate_dbbuf1, rotate_dbbuf2, visual_width); \
       MEMCPY(line_dest, effect_dbbuf, visual_width*2*DEST_PIXEL_SIZE); \
       MEMCPY(line_dest+CORRECTED_DEST_WIDTH, effect_dbbuf+visual_width*2*DEST_PIXEL_SIZE, visual_width*2*DEST_PIXEL_SIZE)
#    define EFFECT3X(FUNC) \
       effect_##FUNC##_direct_func(effect_dbbuf, effect_dbbuf+visual_width*widthscale*DEST_PIXEL_SIZE, effect_dbbuf+visual_width*widthscale*DEST_PIXEL_SIZE*2, line_src, visual_width); \
       MEMCPY(line_dest, effect_dbbuf, visual_width*widthscale*DEST_PIXEL_SIZE); \
       MEMCPY(line_dest+CORRECTED_DEST_WIDTH, effect_dbbuf+visual_width*widthscale*DEST_PIXEL_SIZE, visual_width*widthscale*DEST_PIXEL_SIZE); \
       MEMCPY(line_dest+CORRECTED_DEST_WIDTH*2, effect_dbbuf+visual_width*widthscale*DEST_PIXEL_SIZE*2, visual_width*widthscale*DEST_PIXEL_SIZE)
#  else
...
#    define EFFECT3X(FUNC) \
       effect_##FUNC##_direct_func(line_dest, line_dest+CORRECTED_DEST_WIDTH, line_dest+CORRECTED_DEST_WIDTH*2, line_src, visual_width)
#  endif
#endif
...
#	ifdef INDIRECT
       ...
       effect_6tap_addline_func(rotate_dbbuf0, visual_width, INDIRECT);
...
#	else
       rotate_func(rotate_dbbuf0, bitmap, visual.min_y);
       effect_6tap_addline_direct_func(rotate_dbbuf0, visual_width);
       rotate_func(rotate_dbbuf0, bitmap, visual.min_y+1);
       effect_6tap_addline_direct_func(rotate_dbbuf0, visual_width);
       rotate_func(rotate_dbbuf0, bitmap, visual.min_y+2);
       effect_6tap_addline_direct_func(rotate_dbbuf0, visual_width);

...
struct rc_option display_opts[] = {
	...
	{ "tweak", NULL, rc_bool, &use_tweak, "0", 0, 0, NULL,
 "Enable/disable svgalib tweaked video modes" },
	{ "planar", NULL, rc_bool, &use_planar, "1", 0, 0, NULL, "Enable/disable use of planar (modeX) modes (slow)" },
	{ "linear", NULL, rc_bool, &use_linear, "0", 0, 0, NULL, "Enable/disable use of linear framebuffer (fast)" },
	{ "centerx", NULL, rc_int, &center_x, "0", 0, 0, NULL, "Adjust the horizontal center of tweaked vga modes" },
	{ "centery", NULL, rc_int, &center_y, "0", 0, 0, NULL, "Adjust the vertical center of tweaked vga modes" },
...
static void svgalib_update_planar(struct mame_bitmap *bitmap)
{
	...
	if (page)
		...
		page=131072;
	vga_copytoplanar256((unsigned char *)bitmap->line[visual.min_y] + visual.min_x,
...
#define SRC_PIXEL  unsigned char
#define DEST_PIXEL unsigned char
#define DEST bitmap->line[0]
#define DEST_WIDTH bitmap_linewidth

...
#ifdef MESS
	SoftwareDirectories_GetList(hWnd, lpGameOpts->extra_software_paths, sizeof(lpGameOpts->extra_software_paths) / sizeof(lpGameOpts->extra_software_paths[0]));
#endif
}
...
#ifdef MESS
	SoftwareDirectories_InitList(hWnd, lpGameOpts->extra_software_paths);
#endif

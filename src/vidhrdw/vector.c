...
static void vector_restore_artwork (struct osd_bitmap *bitmap, struct artwork_ *a, int full_refresh)
{
	int i, x, y;
...
static void vector_vh_update_backdrop(struct osd_bitmap *bitmap, struct artwork_ *a, int full_refresh)
{
	int i, x, y;
	unsigned int coords;
	int newcol, bdcol;

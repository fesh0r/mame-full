 ...
 ***************************************************************/
#define MODE6(s) COPY8(dst, &antic.pf_3210b2[video->data[s]])
 ...
 ***************************************************************/
#define MODE7(s) COPY8(dst, &antic.pf_3210b2[video->data[s]])
 ...
 ***************************************************************/
#define MODE8(s) COPY16(dst, &antic.pf_210b4[video->data[s]])
 ...
 ***************************************************************/
#define MODE9(s) COPY8(dst, &antic.pf_3210b2[video->data[s]])
 ...
 ***************************************************************/
#define MODEA(s) COPY8(dst, &antic.pf_210b2[video->data[s]])
 ...
 ***************************************************************/
#define MODEB(s) COPY8(dst, &antic.pf_3210b2[video->data[s]])
 ...
 ***************************************************************/
#define MODEC(s) COPY8(dst, &antic.pf_3210b2[video->data[s]])

 ...
 **********************************************/
#define SETCOL_L(o,d) \
    *((byte*)&antic.color_lookup[o] + 0) = Machine->colortable[d]

/**********************************************
 * set right color clock for one color
 **********************************************/
#define SETCOL_R(o,d) \
    *((byte*)&antic.color_lookup[o] + 1) = Machine->colortable[d]
...
static byte lumpm0=0,lumpm1=0,lumpm2=0,lumpm3=0,lumpm4=0;
static byte lumpf1=0,lumpf2=0,lumbk= 0;
static byte huepm0=0,huepm1=0,huepm2=0,huepm3=0,huepm4=0;
static byte huepf1=0,huepf2=0,huebk= 0;
...
#if OPTIMIZE
			if (*(dword*)&gtia.r.m0pf || *(dword*)&gtia.r.p0pf ||
				*(dword*)&gtia.r.m0pl || *(dword*)&gtia.r.p0pl)
            {
            int i;
			VIDEO * video = antic.video[antic.scanline];
				*(dword*)&gtia.r.m0pf = *(dword*)&gtia.r.p0pf =
				*(dword*)&gtia.r.m0pl = *(dword*)&gtia.r.p0pl = 0;
                for (i = 0; i < TOTAL_LINES; i++)
				{
					video = antic.video[i];
					*(dword*)&video->gtia_r.m0pf =
					*(dword*)&video->gtia_r.p0pf =
					*(dword*)&video->gtia_r.m0pl =
					*(dword*)&video->gtia_r.p0pl =
					*(dword*)&video->gtia_h.grafp0 =
					*(dword*)&video->gtia_h.grafm0 = 0;
                }
...
{
int x;
byte *prio = antic.prio_table[gtia.w.prior & 0x3f];
byte *src, *dst;

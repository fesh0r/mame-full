...
DISCRETE_SOUND_START(firetrk_discrete_interface)
	/************************************************/
	...
	DISCRETE_COUNTER_FIX(NODE_72, 1, NODE_71, FIRETRUCK_HSYNC, 15, 1, 0)	// IC B10
...
DISCRETE_SOUND_START(superbug_discrete_interface)
	/************************************************/
...
DISCRETE_SOUND_START(montecar_discrete_interface)
	/************************************************/

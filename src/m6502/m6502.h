...
/* for convenience (many drivers use this names from the previous M6502 core) */
#define INT_NONE    M6502_INT_NONE
#define INT_IRQ 	M6502_INT_IRQ
#define INT_NMI 	M6502_INT_NMI

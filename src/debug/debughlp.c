...
static struct help_item static_help_list[] =
{
	...
	},
	{
		...
		"  ignore [<cpunum>] -- stops debugging on <cpunum>\n"
		"  observe [<cpunum>] -- resumes debugging on <cpunum>\n"
		"  trace {<filename>|OFF},<cpunum>[,<action>] -- trace the given CPU to a file\n"
		"\n"
	},
	{
		"breakpoints",
	...
	},
	{
		...
		"\n"
		"Starts or stops tracing of the execution of the specified <cpunum>. When enabling tracing,\n"
		"specify the filename in the <filename> parameter. To disable tracing, substitute the keyword\n"
		"'off' for <filename>. If you wish to log additional information on each trace, you can\n"

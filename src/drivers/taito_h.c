...
INPUT_PORTS_START( syvalion )
	...
	PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(30) PORT_KEYDELTA(30) PORT_CENTER PORT_PLAYER(1)

	PORT_START  /* TRACKBALL1 Y (5) */
	PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(30) PORT_KEYDELTA(30) PORT_CENTER PORT_REVERSE PORT_PLAYER(1)

	PORT_START  /* TRACKBALL2 X (6) */
	PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(30) PORT_KEYDELTA(30) PORT_CENTER PORT_PLAYER(2)

	PORT_START  /* TRACKBALL2 Y (7) */
	PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(30) PORT_KEYDELTA(30) PORT_CENTER PORT_REVERSE PORT_PLAYER(2)
INPUT_PORTS_END

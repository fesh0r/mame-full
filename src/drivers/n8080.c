...
INPUT_PORTS_START( spacefev )
	...
	PORT_BIT(0x08, 0x00, 0 ) PORT_NAME("Game A") PORT_CODE(KEYCODE_Q)
	PORT_BIT(0x10, 0x00, 0 ) PORT_NAME("Game B") PORT_CODE(KEYCODE_W)
	PORT_BIT(0x20, 0x00, 0 ) PORT_NAME("Game C") PORT_CODE(KEYCODE_E)
	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNUSED )
...
ROM_START( spacefev )
	...
	ROM_LOAD( "sf.g2",    0x0c00, 0x0400, CRC(1faef63a) SHA1(68e1bfc45587bfb1ee2eb477b60efd4f69dffd2c) )
	ROM_LOAD( "sf.h1",    0x1000, 0x0400, CRC(b365389d) SHA1(e681f2c5e37cc07912915ef74184ff9336309de3) )
...
ROM_START( spacefva )
	...
	ROM_LOAD( "sf-a.g2",  0x0c00, 0x0400, CRC(fb6bcf4a) SHA1(3edea04d67c2f3b1a6a73adadea83ddda0be3842) )
	ROM_LOAD( "sf-a.h1",  0x1000, 0x0400, CRC(3beef037) SHA1(4bcc157e7d721b3a9e16e7a2efa807303d4be8ac) )
...
ROM_START( highsplt )
	...
	ROM_LOAD( "hs.g2",    0x0c00, 0x0400, CRC(f1a90948) SHA1(850f27b42ca12bcba4aa95a1ad3e66206fa63554) )
	ROM_LOAD( "hs.h1",    0x1000, 0x0400, CRC(eefb4273) SHA1(853a62976a406516f10ac68dc2859399b8b7aae8) )
	ROM_LOAD( "hs.h2",    0x1400, 0x0400, CRC(e91703e8) SHA1(f58606b0c7d945e94c3fccc7ebe17ca25675e6a0) )
...
ROM_START( highspla )
	...
	ROM_LOAD( "hs.g1",    0x0800, 0x0400, CRC(de17578a) SHA1(d9d5dbf38331f212d2a566c60756a788e169104d) )
	ROM_LOAD( "hs.g2",    0x0c00, 0x0400, CRC(f1a90948) SHA1(850f27b42ca12bcba4aa95a1ad3e66206fa63554) )
	ROM_LOAD( "hs-a.h1",  0x1000, 0x0400, CRC(b0505da3) SHA1(f7b1f3a6dd06ff0cdeb6b13c948b7a262592514a) )
	ROM_LOAD( "hs.h2",    0x1400, 0x0400, CRC(e91703e8) SHA1(f58606b0c7d945e94c3fccc7ebe17ca25675e6a0) )
...
ROM_START( sheriff )
	...
	ROM_LOAD( "sh.prm",   0x0000, 0x0400, NO_DUMP )
ROM_END

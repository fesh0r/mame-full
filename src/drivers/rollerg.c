...
static ADDRESS_MAP_START( writemem, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0x1800, 0x1fff) AM_WRITE(paletteram_xBBBBBGGGGGRRRRR_swap_w) AM_BASE(&paletteram)
...
static MACHINE_INIT( rollerg )
{
	cpunum_set_info_ptr(0, CPUINFO_PTR_KONAMI_SETLINES_CALLBACK, rollerg_banking);

...
static ADDRESS_MAP_START( namcos12_writemem, ADDRESS_SPACE_PROGRAM, 32 )
	AM_RANGE(0x00000000, 0x003fffff) AM_WRITE(MWA32_RAM)    /* ram */
	AM_RANGE(0x1f000000, 0x1f000003) AM_WRITE(bankoffset_w) /* banking */
	AM_RANGE(0x1f008000, 0x1f008003) AM_WRITE(MWA32_NOP)    /* ?? */
	AM_RANGE(0x1f010000, 0x1f010003) AM_WRITE(MWA32_NOP)    /* ?? */
	AM_RANGE(0x1f018000, 0x1f018003) AM_WRITE(MWA32_NOP)    /* ?? */
	AM_RANGE(0x1f080000, 0x1f083fff) AM_WRITE(sharedram_w) AM_BASE(&namcos12_sharedram) /* shared ram?? */
	AM_RANGE(0x1f140000, 0x1f141fff) AM_WRITE(MWA32_RAM) AM_BASE((data32_t **)&generic_nvram) AM_SIZE(&generic_nvram_size) /* flash */
	AM_RANGE(0x1f1bff08, 0x1f1bff0f) AM_WRITE(MWA32_NOP)    /* ?? */
...
static ADDRESS_MAP_START( namcos12_readmem, ADDRESS_SPACE_PROGRAM, 32 )
	AM_RANGE(0x00000000, 0x003fffff) AM_READ(MRA32_RAM)    /* ram */
	AM_RANGE(0x1f000000, 0x1f000003) AM_READ(MRA32_NOP)    /* banking */
	AM_RANGE(0x1f080000, 0x1f083fff) AM_READ(sharedram_r)  /* shared ram */
	AM_RANGE(0x1f140000, 0x1f141fff) AM_READ(MRA32_RAM)    /* flash */
	...
	AM_RANGE(0x1fa00000, 0x1fbfffff) AM_READ(MRA32_BANK7)  /* banked roms */
...
static MACHINE_DRIVER_START( coh700 )
	...
	MDRV_CPU_PROGRAM_MAP( namcos12_readmem, namcos12_writemem )

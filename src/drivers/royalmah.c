...
INPUT_PORTS_START( royalmah )
	...
	PORT_BIT(0x40, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Credit Clear") PORT_CODE(KEYCODE_7)
	PORT_BIT(0x80, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Credit Clear") PORT_CODE(KEYCODE_8)
	...
	PORT_BIT(0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Bet") PORT_CODE(KEYCODE_3)
	...
	PORT_START	/* P1 IN4 */
	PORT_BIT(0x01, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Last Chance") PORT_CODE(KEYCODE_RALT)
	PORT_BIT(0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Take Score") PORT_CODE(KEYCODE_RCONTROL)
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Double Up") PORT_CODE(KEYCODE_RSHIFT)
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Flip Flop") PORT_CODE(KEYCODE_X)
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Big") PORT_CODE(KEYCODE_ENTER)
	PORT_BIT(0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Small") PORT_CODE(KEYCODE_BACKSPACE)
	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* P2 IN0 */
	PORT_BIT(0x01, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 A")
	PORT_BIT(0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 E")
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 I")
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 M")
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Kan")
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_START2 )
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 )	// "COIN2"
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN2 )	// "COIN1", but not working

	PORT_START	/* P2 IN1 */
	PORT_BIT(0x01, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 B")
	PORT_BIT(0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 F")
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 J")
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 N")
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Reach")
	PORT_BIT(0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Bet") PORT_CODE(KEYCODE_4)
	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* P2 IN2 */
	PORT_BIT(0x01, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 C")
	PORT_BIT(0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 G")
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 K")
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Chi")
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Ron")
	PORT_BIT( 0xe0, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* P2 IN3 */
	PORT_BIT(0x01, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 D")
	PORT_BIT(0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 H")
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 L")
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Pon")
	PORT_BIT( 0xf0, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* P2 IN4 */
	PORT_BIT(0x01, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Last Chance")
	PORT_BIT(0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Take Score")
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Double Up")
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Flip Flop")
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Big")
	PORT_BIT(0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Small")
	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED )
...
INPUT_PORTS_START( tontonb )
	...
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Kan") PORT_CODE(KEYCODE_LCONTROL)
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_START1 )
	PORT_BIT(0x40, IP_ACTIVE_LOW, 0 ) PORT_NAME("Payout") PORT_CODE(KEYCODE_7)

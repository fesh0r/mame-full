...
#define PLAYER1_TRACKBALL \
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_TRACKBALL_Y ) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_PLAYER(1)\
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_TRACKBALL_X ) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_REVERSE PORT_PLAYER(1)

#define PLAYER2_TRACKBALL \
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_TRACKBALL_Y ) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_PLAYER(2)\
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_TRACKBALL_X ) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_REVERSE PORT_PLAYER(2)

#define PLAYER1_DIAL \
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_DIAL ) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_REVERSE PORT_PLAYER(1)

#define PLAYER2_DIAL \
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_DIAL ) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_REVERSE PORT_PLAYER(2)

#define PLAYER1_WHEEL \
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_DIAL ) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_PLAYER(1)

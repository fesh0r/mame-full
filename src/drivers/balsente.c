...
#define PLAYER1_TRACKBALL \
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_PLAYER(1)\
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_REVERSE PORT_PLAYER(1)

#define PLAYER2_TRACKBALL \
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_PLAYER(2)\
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_REVERSE PORT_PLAYER(2)

#define PLAYER1_DIAL \
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_REVERSE PORT_PLAYER(1)

#define PLAYER2_DIAL \
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_REVERSE PORT_PLAYER(2)

#define PLAYER1_WHEEL \
	PORT_START\
    PORT_BIT( 0xff, 0, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_CENTER PORT_PLAYER(1)
...
INPUT_PORTS_START( nstocker )
	...
	PORT_START
    PORT_BIT( 0xff, 0, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(20)
    				PORT_CODE_DEC(KEYCODE_S) PORT_CODE_DEC(JOYCODE_1_LEFT) PORT_CODE_INC(KEYCODE_F) PORT_CODE_INC(JOYCODE_1_RIGHT) PORT_CENTER PORT_PLAYER(2)
...
INPUT_PORTS_START( grudge )
	...
	/* analog ports */
	PORT_START
    PORT_BIT( 0xff, 0, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(50) PORT_KEYDELTA(20) PORT_PLAYER(1)
	PORT_START
    PORT_BIT( 0xff, 0, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(50) PORT_KEYDELTA(20) PORT_PLAYER(2)
	PORT_START
    PORT_BIT( 0xff, 0, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(50) PORT_KEYDELTA(20) PORT_PLAYER(3)
	UNUSED_ANALOG
INPUT_PORTS_END
...
//	PORT_BIT( 0x3c, IP_ACTIVE_LOW, IPT_UNUSED )
	...
	/* analog ports */
	PORT_START
	PORT_BIT( 0xff, 0x80, IPT_AD_STICK_X ) PORT_MINMAX(0x00,0xff) PORT_SENSITIVITY(100) PORT_KEYDELTA(20) PORT_REVERSE PORT_PLAYER(1)
	PORT_START

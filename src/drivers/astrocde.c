...
INPUT_PORTS_START( seawolf2 )
	PORT_START /* IN0 */
	PORT_BIT( 0x3f, 0x20, IPT_PADDLE ) PORT_MINMAX(0,0x3f) PORT_SENSITIVITY(20) PORT_KEYDELTA(5) PORT_REVERSE PORT_PLAYER(1)
	...
	PORT_START /* IN1 */
	PORT_BIT( 0x3f, 0x20, IPT_PADDLE ) PORT_MINMAX(0,0x3f) PORT_SENSITIVITY(20) PORT_KEYDELTA(5) PORT_REVERSE PORT_PLAYER(2)
...
INPUT_PORTS_START( ebases )
	...
	PORT_START
	PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CENTER PORT_PLAYER(2)	\

	PORT_START
	PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CENTER PORT_PLAYER(2)	\

	PORT_START
	PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CENTER	\

	PORT_START
	PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CENTER	\
INPUT_PORTS_END

...
ROM_START( ssf2tu )
	...
	ROM_FILL(XOR_BASE, XOR_BASE, 0)
	ROM_LOAD16_WORD_SWAP( "sfxux.03c", XOR_BASE+0x000000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sfxux.04a", XOR_BASE+0x080000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sfxux.05",  XOR_BASE+0x100000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sfxux.06a", XOR_BASE+0x180000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sfxux.07",  XOR_BASE+0x200000, 0x80000, 0x00000000 )
	ROM_LOAD16_WORD_SWAP( "sfxux.08",  XOR_BASE+0x280000, 0x80000, 0x00000000 )
...
GAME( 1995, 19xxh,    19xx,    cps2, cps2,    cps2, ROT270_16BIT, "Capcom", "19XX: The War Against Destiny (Hispanic 951218)" )
...
GAME( 1996, qndream,  0,       cps2, qndream, cps2, ROT0_16BIT,   "Capcom", "Quiz Nanairo Dreams: Miracle of the Rainbow Colored Town (Japan 960826)" )
...
GAMEX(1994, ssf2tu,   ssf2,    cps2, ssf2,    cps2, ROT0_16BIT,   "Capcom", "Super Street Fighter 2 Turbo (US 940223)", GAME_NOT_WORKING )

...
static WRITE8_HANDLER( chqflag_bankswitch_w )
{
	...
	if (data & 0x20){
		...
		memory_install_write8_handler(0, ADDRESS_SPACE_PROGRAM, 0x1800, 0x1fff, 0, 0, paletteram_xBBBBBGGGGGRRRRR_swap_w);	/* palette */
		if (K051316_readroms){
...
//	PORT_DIPSETTING(    0x00, "Coin Slot 2 Invalidity" )
	...
	PORT_BIT( 0xff, 0x80, IPT_AD_STICK_X ) PORT_MINMAX(0x10,0xef) PORT_SENSITIVITY(80) PORT_KEYDELTA(8) PORT_CENTER
INPUT_PORTS_END

...
INPUT_PORTS_START( crusnusa )
	...
	PORT_BIT(0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("Enter") PORT_CODE(KEYCODE_F2) /* Test switch */
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_SERVICE1 )
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_COIN3 )
	PORT_BIT(0x0100, IP_ACTIVE_LOW, 0 ) PORT_NAME("Volume Down") PORT_CODE(KEYCODE_MINUS)
	PORT_BIT(0x0200, IP_ACTIVE_LOW, 0 ) PORT_NAME("Volume Up") PORT_CODE(KEYCODE_EQUALS)

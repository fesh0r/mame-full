...
INPUT_PORTS_START( sstrangr )
	...
	PORT_BIT(0,  0x02, IPT_DIPSWITCH_SETTING ) PORT_NAME("Fast") PORT_CHEAT
INPUT_PORTS_END
...
INPUT_PORTS_START( gunfight )
	...
	PORT_BIT( 0xff, 0x00, IPT_PADDLE ) PORT_MINMAX(1,255) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CODE_DEC(KEYCODE_H) PORT_CODE_INC(KEYCODE_Y) PORT_PLAYER(2)

	PORT_START                                                                                          /* Player 1 Gun */
	PORT_BIT( 0xff, 0x00, IPT_PADDLE ) PORT_MINMAX(1,255) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CODE_DEC(KEYCODE_Z) PORT_CODE_INC(KEYCODE_A)
INPUT_PORTS_END
...
//	PORT_DIPSETTING(    0x03, DEF_STR( 1C_2C ) )
	...
	PORT_START                                                                                          /* Player 2 Gun */
	PORT_BIT( 0xff, 0x00, IPT_PADDLE ) PORT_MINMAX(1,255) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CODE_DEC(KEYCODE_X) PORT_CODE_INC(KEYCODE_S) PORT_PLAYER(2)
...
INPUT_PORTS_START( sflush )
	...
	PORT_START
	PORT_BIT( 0xff, 0x6a, IPT_PADDLE ) PORT_MINMAX(0x16,0xbf) PORT_SENSITIVITY(30) PORT_KEYDELTA(30)
INPUT_PORTS_END
...
INPUT_PORTS_START( clowns )
	PORT_START      /* IN0 */
	PORT_BIT( 0xff, 0x7f, IPT_PADDLE ) PORT_MINMAX(0x01,0xfe) PORT_SENSITIVITY(100) PORT_KEYDELTA(10)
...
INPUT_PORTS_START( bowler )
  ...
  /*PORT_DIPSETTING(    0x03, "German" )*/
	...
	PORT_START      /* IN5 */
	PORT_BIT( 0xff, 0, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(10) PORT_KEYDELTA(10) PORT_REVERSE

	PORT_START      /* IN6 */
	PORT_BIT( 0xff, 0, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(10) PORT_KEYDELTA(10)
INPUT_PORTS_END
...
INPUT_PORTS_START( shuffle )
  ...
  /*PORT_DIPSETTING(    0x03, "German" )*/
	...
	PORT_START      /* IN2 */
	PORT_BIT( 0xff, 0, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(10) PORT_KEYDELTA(10)

	PORT_START      /* IN3 */
	PORT_BIT( 0xff, 0, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(10) PORT_KEYDELTA(10) PORT_REVERSE
INPUT_PORTS_END
...
INPUT_PORTS_START( seawolf )
	PORT_START      /* IN0 */
	PORT_BIT( 0x1f, 0x01, IPT_PADDLE ) PORT_MINMAX(0,0x1f) PORT_SENSITIVITY(20) PORT_KEYDELTA(5)
	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON1 )
	PORT_DIPNAME( 0xc0, 0x00, "Time" )
...
INPUT_PORTS_START( blueshrk )
	PORT_START      /* IN0 */
	PORT_BIT( 0x7f, 0x45, IPT_PADDLE ) PORT_MINMAX(0xf,0x7f) PORT_SENSITIVITY(100) PORT_KEYDELTA(10)

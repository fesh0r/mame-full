...
INPUT_PORTS_START( hypreact )
	...
	PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_START1 )
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("Chi") PORT_CODE(KEYCODE_SPACE)
	PORT_BIT( 0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("Pon") PORT_CODE(KEYCODE_LALT)
	PORT_BIT( 0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("Kan") PORT_CODE(KEYCODE_LCONTROL)
	...
	PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_START2 )
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("Reach") PORT_CODE(KEYCODE_LSHIFT)
	PORT_BIT( 0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("Ron") PORT_CODE(KEYCODE_Z)
	PORT_BIT( 0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("Tsumo") PORT_CODE(KEYCODE_RCONTROL)
	...
	PORT_BIT(0x0001, IP_ACTIVE_LOW, 0 ) PORT_NAME("A") PORT_CODE(KEYCODE_A)
	PORT_BIT(0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("E") PORT_CODE(KEYCODE_E)
	PORT_BIT(0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("I") PORT_CODE(KEYCODE_I)
	PORT_BIT(0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("M") PORT_CODE(KEYCODE_M)
	PORT_BIT(0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("Kan") PORT_CODE(KEYCODE_LCONTROL)
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_START1                              )
	PORT_BIT( 0xffc0, IP_ACTIVE_LOW, IPT_UNKNOWN )

	PORT_START	// IN6 - $c00000(1)
	PORT_BIT(0x0001, IP_ACTIVE_LOW, 0 ) PORT_NAME("B") PORT_CODE(KEYCODE_B)
	PORT_BIT(0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("F") PORT_CODE(KEYCODE_F)
	PORT_BIT(0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("J") PORT_CODE(KEYCODE_J)
	PORT_BIT(0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("N") PORT_CODE(KEYCODE_N)
	PORT_BIT(0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("Reach") PORT_CODE(KEYCODE_LSHIFT)
	PORT_BIT(0x0020, IP_ACTIVE_LOW, 0 ) PORT_NAME("Bet") PORT_CODE(KEYCODE_RCONTROL)
	PORT_BIT( 0xffc0, IP_ACTIVE_LOW, IPT_UNKNOWN )

	PORT_START	// IN7 - $c00000(2)
	PORT_BIT(0x0001, IP_ACTIVE_LOW, 0 ) PORT_NAME("C") PORT_CODE(KEYCODE_C)
	PORT_BIT(0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("G") PORT_CODE(KEYCODE_G)
	PORT_BIT(0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("K") PORT_CODE(KEYCODE_K)
	PORT_BIT(0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("Chi") PORT_CODE(KEYCODE_SPACE)
	PORT_BIT(0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("Ron") PORT_CODE(KEYCODE_Z)
	PORT_BIT( 0xffe0, IP_ACTIVE_LOW, IPT_UNKNOWN )

	PORT_START	// IN8 - $c00000(3)
	PORT_BIT(0x0001, IP_ACTIVE_LOW, 0 ) PORT_NAME("D") PORT_CODE(KEYCODE_D)
	PORT_BIT(0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("H") PORT_CODE(KEYCODE_H)
	PORT_BIT(0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("L") PORT_CODE(KEYCODE_L)
	PORT_BIT(0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("Pon") PORT_CODE(KEYCODE_LALT)
...
//	PORT_DIPSETTING(      0x0080, "unused" )
	...
	PORT_BIT(0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("Pon") PORT_CODE(KEYCODE_LALT)
	PORT_BIT(0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("L") PORT_CODE(KEYCODE_L)
	PORT_BIT(0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("H") PORT_CODE(KEYCODE_H)
	PORT_BIT(0x0020, IP_ACTIVE_LOW, 0 ) PORT_NAME("D") PORT_CODE(KEYCODE_D)
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN )

	PORT_START	// IN6 - $800002(1)
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT(0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("Ron") PORT_CODE(KEYCODE_Z)
	PORT_BIT(0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("Chi") PORT_CODE(KEYCODE_SPACE)
	PORT_BIT(0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("K") PORT_CODE(KEYCODE_K)
	PORT_BIT(0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("G") PORT_CODE(KEYCODE_G)
	PORT_BIT(0x0020, IP_ACTIVE_LOW, 0 ) PORT_NAME("C") PORT_CODE(KEYCODE_C)
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN )

	PORT_START	// IN7 - $800002(2)
	PORT_BIT(0x0001, IP_ACTIVE_LOW, 0 ) PORT_NAME("Bet") PORT_CODE(KEYCODE_RCONTROL)
	PORT_BIT(0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("Reach") PORT_CODE(KEYCODE_LSHIFT)
	PORT_BIT(0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("N") PORT_CODE(KEYCODE_N)
	PORT_BIT(0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("J") PORT_CODE(KEYCODE_J)
	PORT_BIT(0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("F") PORT_CODE(KEYCODE_F)
	PORT_BIT(0x0020, IP_ACTIVE_LOW, 0 ) PORT_NAME("B") PORT_CODE(KEYCODE_B)
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN )

	PORT_START	// IN8 - $800002(3)
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_START1 )
	PORT_BIT(0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("Kan") PORT_CODE(KEYCODE_LCONTROL)
	PORT_BIT(0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("M") PORT_CODE(KEYCODE_M)
	PORT_BIT(0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("I") PORT_CODE(KEYCODE_I)
	PORT_BIT(0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("E") PORT_CODE(KEYCODE_E)
	PORT_BIT(0x0020, IP_ACTIVE_LOW, 0 ) PORT_NAME("A") PORT_CODE(KEYCODE_A)
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN )
INPUT_PORTS_END
...
//	PORT_DIPSETTING(      0x0000, DEF_STR( 1C_6C ) )
	...
	PORT_BIT( 0xff, 0x00, IPT_PADDLE ) PORT_MINMAX(0,0xcf) PORT_SENSITIVITY(15) PORT_KEYDELTA(15) PORT_CODE_DEC(KEYCODE_N) PORT_CODE_INC(KEYCODE_M)
INPUT_PORTS_END

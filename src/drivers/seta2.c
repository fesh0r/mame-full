...
INPUT_PORTS_START( grdians )
	...
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2 ) PORT_IMPULSE(5)
	PORT_BIT(  0x0004, IP_ACTIVE_LOW,  IPT_SERVICE1 )
	PORT_BIT( 0x0008, IP_ACTIVE_LOW,  IPT_SERVICE ) PORT_NAME("Test") PORT_CODE(KEYCODE_F1)
	PORT_BIT(  0x0010, IP_ACTIVE_LOW,  IPT_UNKNOWN )
	PORT_BIT(  0x0020, IP_ACTIVE_LOW,  IPT_UNKNOWN )
	PORT_BIT(  0x0040, IP_ACTIVE_LOW,  IPT_UNKNOWN )
	PORT_BIT(  0x0080, IP_ACTIVE_LOW,  IPT_UNKNOWN )
...
INPUT_PORTS_START( mj4simai )
	...
	PORT_BIT(0x0020, IP_ACTIVE_LOW, 0 ) PORT_NAME("Bet") PORT_CODE(KEYCODE_2)
	PORT_BIT( 0xffc0, IP_ACTIVE_LOW, IPT_UNKNOWN )
	...
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, 0 ) PORT_NAME("Last") PORT_CODE(KEYCODE_RALT)
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("Take") PORT_CODE(KEYCODE_RCONTROL)
	PORT_BIT( 0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("Double") PORT_CODE(KEYCODE_RSHIFT)
	PORT_BIT( 0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("Flip") PORT_CODE(KEYCODE_X)
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("Big") PORT_CODE(KEYCODE_ENTER)
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, 0 ) PORT_NAME("Small") PORT_CODE(KEYCODE_BACKSPACE)
...
INPUT_PORTS_START( myangel )
	...
	PORT_DIPSETTING(      0x0040, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x0080, 0x0080, IPT_DIPSWITCH_NAME ) PORT_NAME("Push Start To Freeze (Cheat) PORT_CHEAT")

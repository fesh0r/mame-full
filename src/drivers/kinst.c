...
INPUT_PORTS_START( kinst )
	...
	PORT_BIT(0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("Volume Up") PORT_CODE(KEYCODE_EQUALS)
	PORT_BIT(0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("Volume Down") PORT_CODE(KEYCODE_MINUS)
...
GAME( 1995, kinst2,   0,      kinst, kinst, kinst2, ROT0, "Rare", "Killer Instinct 2 (v1.4)" )
GAME( 1995, kinst213, kinst2, kinst, kinst, kinst2, ROT0, "Rare", "Killer Instinct 2 (v1.3)" )
GAME( 1995, kinst211, kinst2, kinst, kinst, kinst2, ROT0, "Rare", "Killer Instinct 2 (v1.1)" )

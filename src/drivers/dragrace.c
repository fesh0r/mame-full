...
INPUT_PORTS_START( dragrace )
	...
	PORT_START /* IN3 */
	PORT_BIT( 0xff, 0x00, IPT_DIAL_V ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10) PORT_PLAYER(1)

	PORT_START /* IN4 */
	PORT_BIT( 0xff, 0x00, IPT_DIAL_V ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10) PORT_PLAYER(2)

...
INPUT_PORTS_START( halleys )
	...
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_BIT(    0x40, 0x40, IPT_DIPSWITCH_NAME ) PORT_NAME("Invincibility") PORT_CHEAT
...
INPUT_PORTS_START( benberob )
	...
	PORT_BIT   ( 0x00, 0x00, IPT_DIPSWITCH_SETTING ) PORT_NAME(DEF_STR( Infinite )) PORT_CHEAT

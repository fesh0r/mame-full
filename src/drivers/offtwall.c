...
static ADDRESS_MAP_START( main_readmem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x038000, 0x03ffff) AM_READ(bankrom_r)
...
static ADDRESS_MAP_START( main_writemem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x038000, 0x03ffff) AM_WRITE(MWA16_ROM) AM_BASE(&bankrom_base)
	...
	AM_RANGE(0x3fd000, 0x3fd7ff) AM_WRITE(atarimo_0_spriteram_w) AM_BASE(&atarimo_0_spriteram)
	AM_RANGE(0x3fd800, 0x3fffff) AM_WRITE(MWA16_RAM)
ADDRESS_MAP_END
...
INPUT_PORTS_START( offtwall )
	...
	PORT_START	/* 260020 */
    PORT_BIT( 0xff, 0, IPT_DIAL_V ) PORT_MINMAX(0,0) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_PLAYER(1)
	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* 260022 */
    PORT_BIT( 0xff, 0, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_PLAYER(2)
	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* 260024 */
    PORT_BIT( 0xff, 0, IPT_DIAL_V ) PORT_MINMAX(0,0) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_REVERSE PORT_PLAYER(3)
	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED )
INPUT_PORTS_END

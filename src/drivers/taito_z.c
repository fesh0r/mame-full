...
INPUT_PORTS_START( aquajack )
	...
	PORT_BIT( 0xff, 0x80, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_PLAYER(1)
INPUT_PORTS_END
...
ROM_START( enforce )
	...
	ROM_REGION( 0x10000, REGION_USER2, 0 )
	ROM_LOAD( "b58-26a.104", 0x00000, 0x10000, CRC(dccb0c7f) SHA1(42f0af72f559133b74912a4478e1323062be4b77) )	/* unused roms */
	ROM_LOAD( "b58-27.56",   0x00000, 0x02000, CRC(5c6b013d) SHA1(6d02d4560076213b6fb6fe856143bb533090603e) )
...
ROM_START( bshark )
	...
	ROM_REGION( 0x10000, REGION_USER2, 0 )
	ROM_LOAD( "c34_18.22", 0x00000, 0x10000, CRC(7245a6f6) SHA1(5bdde4e3bcde8c59dc84478c3cc079d7ef8ee9c5) )	/* unused roms */
	ROM_LOAD( "c34_19.72", 0x00000, 0x00100, CRC(2ee9c404) SHA1(3a2ddaaaf7abe9f47f7e062b002fd3a61c80f60b) )
	ROM_LOAD( "c34_20.89", 0x00000, 0x00100, CRC(fbf81f30) SHA1(c868452c334792345dcced075f6df69cff9e31ca) )
...
ROM_START( nightstr )
	...
	ROM_REGION( 0x10000, REGION_USER2, 0 )
	ROM_LOAD( "b91-26.bin", 0x00000, 0x400,   CRC(77682a4f) SHA1(da2b3143f1c8688a22d8ec47bbb73b2f2e578480) )	/* unused roms */
	ROM_LOAD( "b91-27.bin", 0x00000, 0x400,   CRC(a3f8490d) SHA1(349b8c9ba914603f72f800a3fc8e8277d756deb1) )
	ROM_LOAD( "b91-28.bin", 0x00000, 0x400,   CRC(fa2f840e) SHA1(dd61ee6833bd43bbf619d36ec46f2bfa00880f40) )
	...
	ROM_LOAD( "b91-32.bin", 0x00000, 0x100,   CRC(fbf81f30) SHA1(c868452c334792345dcced075f6df69cff9e31ca) )
	ROM_LOAD( "b91-33.bin", 0x00000, 0x100,   CRC(89719d17) SHA1(50181b8172b0fc08b149db18caf10659be9c517f) )
ROM_END

...
static ADDRESS_MAP_START( readmem, ADDRESS_SPACE_PROGRAM, 16 )
	AM_RANGE(0x00000000, 0x003fffff) AM_READ(midtunit_vram_r)
	AM_RANGE(0x01000000, 0x013fffff) AM_READ(MRA16_RAM)
	AM_RANGE(0x01400000, 0x0145ffff) AM_READ(midwunit_cmos_r)
	AM_RANGE(0x01600000, 0x0160001f) AM_READ(midwunit_security_r)
	AM_RANGE(0x01680000, 0x0168001f) AM_READ(midwunit_sound_r)
	AM_RANGE(0x01800000, 0x0187ffff) AM_READ(midwunit_io_r)
	AM_RANGE(0x01880000, 0x018fffff) AM_READ(MRA16_RAM)
	AM_RANGE(0x01a00000, 0x01a000ff) AM_READ(midtunit_dma_r)
	AM_RANGE(0x01a80000, 0x01a800ff) AM_READ(midtunit_dma_r)
	AM_RANGE(0x01b00000, 0x01b0001f) AM_READ(midwunit_control_r)
...
static ADDRESS_MAP_START( writemem, ADDRESS_SPACE_PROGRAM, 16 )
	AM_RANGE(0x00000000, 0x003fffff) AM_WRITE(midtunit_vram_w)
	AM_RANGE(0x01000000, 0x013fffff) AM_WRITE(MWA16_RAM) AM_BASE(&midyunit_scratch_ram)
	AM_RANGE(0x01400000, 0x0145ffff) AM_WRITE(midwunit_cmos_w) AM_BASE((data16_t **)&generic_nvram) AM_SIZE(&generic_nvram_size)
	AM_RANGE(0x01480000, 0x014fffff) AM_WRITE(midwunit_cmos_enable_w)
	AM_RANGE(0x01600000, 0x0160001f) AM_WRITE(midwunit_security_w)
	AM_RANGE(0x01680000, 0x0168001f) AM_WRITE(midwunit_sound_w)
	AM_RANGE(0x01800000, 0x0187ffff) AM_WRITE(midwunit_io_w)
	AM_RANGE(0x01880000, 0x018fffff) AM_WRITE(midtunit_paletteram_w) AM_BASE(&paletteram16)
	AM_RANGE(0x01a00000, 0x01a000ff) AM_WRITE(midtunit_dma_w)
	AM_RANGE(0x01a80000, 0x01a800ff) AM_WRITE(midtunit_dma_w)
	AM_RANGE(0x01b00000, 0x01b0001f) AM_WRITE(midwunit_control_w)
	AM_RANGE(0x02000000, 0x06ffffff) AM_WRITE(MWA16_ROM) AM_BASE((data16_t **)&midwunit_decode_memory)
...
ROM_START( mk3 )
	...
	ROM_REGION( 0x400000, REGION_SOUND1, 0 )	/* sound data */
	ROM_LOAD( "umk3-u2.bin",  0x000000, 0x100000, CRC(3838cfe5) SHA1(e3d2901f3bae1362742fc6ee0aa31c9f63b4dfa3) )
	ROM_LOAD( "umk3-u3.bin",  0x100000, 0x100000, CRC(856fe411) SHA1(6165ebecfce7500e948d84492ffa19eed7f47091) )
	ROM_LOAD( "umk3-u4.bin",  0x200000, 0x100000, CRC(428a406f) SHA1(e70ec83cd054de0da1e178720ed0035b8887f797) )
	ROM_LOAD( "umk3-u5.bin",  0x300000, 0x100000, CRC(3b98a09f) SHA1(edf1d02a56dcf3349e6b4bb4097acfe7592305f4) )
...
ROM_START( openice )
	...
	ROM_REGION( 0x400000, REGION_SOUND1, 0 )	/* sound data */
	ROM_LOAD( "oiceu2.bin",  0x000000, 0x100000, CRC(8adb5aab) SHA1(4c25bc051c90947f3366f83ac5ca8dc78e26b8a4) )
	ROM_LOAD( "oiceu3.bin",  0x100000, 0x100000, CRC(11c61ad6) SHA1(324621d6b486399b6d5ede1fed39d4e448cdeb32) )
	ROM_LOAD( "oiceu4.bin",  0x200000, 0x100000, CRC(04279290) SHA1(daf1e57137ae1c3434194054e69809bfe3ed1fc3) )
	ROM_LOAD( "oiceu5.bin",  0x300000, 0x100000, CRC(e90ad61f) SHA1(59eeabcae7e0e70cdb4472cde64b8a28b07ede98) )
...
ROM_START( nbahangt )
	...
	ROM_REGION( 0x400000, REGION_SOUND1, 0 )	/* sound data */
	ROM_LOAD( "mhtu2.bin",  0x000000, 0x100000, CRC(3f0b0d0a) SHA1(e3b8a264686ce7359d86e4926237d8cf17612991) )
	ROM_LOAD( "mhtu3.bin",  0x100000, 0x100000, CRC(ec1db988) SHA1(1cf06d0b75f20ded7db648070e85c056043765bb) )
	ROM_LOAD( "mhtu4.bin",  0x200000, 0x100000, CRC(c7f847a3) SHA1(c50175dffa3563ccd5792c59a6b44523f4014544) )
	ROM_LOAD( "mhtu5.bin",  0x300000, 0x100000, CRC(ef19316a) SHA1(d41ae87ab45630a37c73684de42f7f6e0ed8f13b) )
...
ROM_START( nbamaxht )
	...
	ROM_REGION16_LE( 0x100000, REGION_USER1, ROMREGION_DISPOSE )	/* 34010 code */
	ROM_LOAD16_BYTE( "mhtu54.bin",  0x00000, 0x80000, CRC(dfb6b3ae) SHA1(1dc59a2d89bf9764a47cebf71b9657c6ae7ce959) )
	ROM_LOAD16_BYTE( "mhtu63.bin",  0x00001, 0x80000, CRC(78da472c) SHA1(b4573ff19dc0d8a99f1bceace872e4999d53317a) )
...
ROM_START( rmpgwt )
	...
	ROM_REGION( 0x400000, REGION_SOUND1, 0 )	/* sound data */
	ROM_LOAD( "rwt.2",  0x000000, 0x100000, CRC(0e82f83d) SHA1(215eebb6c229ef9ad0fcbcbc6e4e07300c05654f) )
	ROM_LOAD( "rwt.3",  0x100000, 0x100000, CRC(3ff54d15) SHA1(827805602091313ec68ea1bccf667bd3b3fc6b8b) )
	ROM_LOAD( "rwt.4",  0x200000, 0x100000, CRC(5c7f5656) SHA1(6c9d692bad539fec8b5aa0bfb56de3ef3719c68a) )
	ROM_LOAD( "rwt.5",  0x300000, 0x100000, CRC(fd9aaf24) SHA1(d60dc076e72618c99ecac9d081d8c49d337b90c7) )
...
ROM_START( wwfmania )
	...
	ROM_REGION( 0x400000, REGION_SOUND1, 0 )	/* sound data */
	ROM_LOAD( "wwf.2",  0x000000, 0x100000, CRC(a9acb250) SHA1(c1a7773ffdb86dc2c1c90c220482ed6330fcbb55) )
	ROM_LOAD( "wwf.3",  0x100000, 0x100000, CRC(9442b6c9) SHA1(1f887c05ab9ca99078be584d7e9e6c59c8ec1818) )
	ROM_LOAD( "wwf.4",  0x200000, 0x100000, CRC(cee78fac) SHA1(c37d3b4aef47dc80d864497b3013f03220d45482) )
	ROM_LOAD( "wwf.5",  0x300000, 0x100000, CRC(5b31fd40) SHA1(35dcf19b223029e17616357d29dd04bbfeb83491) )

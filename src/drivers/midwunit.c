...
static ADDRESS_MAP_START( main_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x01400000, 0x0145ffff) AM_READWRITE(midwunit_cmos_r, midwunit_cmos_w) AM_BASE((data16_t **)&generic_nvram) AM_SIZE(&generic_nvram_size)
	...
	AM_RANGE(0x02000000, 0x06ffffff) AM_READ(midwunit_gfxrom_r) AM_BASE((data16_t **)&midwunit_decode_memory)
...
INPUT_PORTS_START( mk3 )
	...
	PORT_BIT(0x0010, IP_ACTIVE_LOW, IPT_SERVICE ) PORT_NAME("Test") PORT_CODE(KEYCODE_F2)
...
GAME( 1996, nbamht,  nbahangt,  wunit, nbahangt,nbahangt,ROT0, "Midway", "NBA Maximum Hangtime (rev 1.03 06/09/97)" )

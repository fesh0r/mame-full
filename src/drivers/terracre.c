...
INPUT_PORTS_START( terracre )
	...
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x4000, 0x4000, IPT_DIPSWITCH_NAME ) PORT_NAME("Complete Invulnerability") PORT_CHEAT
	PORT_DIPSETTING(      0x4000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x8000, 0x8000, IPT_DIPSWITCH_NAME ) PORT_NAME("Base Ship Invulnerability") PORT_CHEAT
...
INPUT_PORTS_START( horekid )
	...
	PORT_DIPSETTING(      0x2000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0xc000, 0xc000, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug Mode") PORT_CHEAT
...
//	PORT_DIPSETTING(      0x0000, DEF_STR( Off ) )		// duplicated setting
	...
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_CHEAT	// fake button for "Debug Mode" (see read handler)
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_START

...
static MACHINE_DRIVER_START( bermudat )
	...
	MDRV_VIDEO_ATTRIBUTES(VIDEO_TYPE_RASTER)
	MDRV_SCREEN_SIZE(400, 224)
	MDRV_VISIBLE_AREA(16, 399, 0, 223)
...
#define SNK_JOY1_PORT \
	...
	PORT_BIT( 0xf0, 0x00, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10) PORT_CODE_DEC(KEYCODE_Z) PORT_CODE_INC(KEYCODE_X) \
...
#define SNK_JOY2_PORT \
	...
	PORT_BIT( 0xf0, 0x00, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10) PORT_CODE_DEC(KEYCODE_N) PORT_CODE_INC(KEYCODE_M) PORT_PLAYER(2)
...
INPUT_PORTS_START( ikari )
	...
	PORT_BIT( 0,       0x00, IPT_DIPSWITCH_SETTING ) PORT_NAME("Infinite Lives") PORT_CHEAT
...
INPUT_PORTS_START( victroad )
	...
	PORT_START /* DSW 1 */
	PORT_BIT( 0x01,    0x01, IPT_DIPSWITCH_NAME ) PORT_NAME("Kill friend & walk everywhere") PORT_CHEAT
	PORT_DIPSETTING(    0x01, DEF_STR( No ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Yes ) )
	PORT_DIPNAME( 0x02, 0x02, "P1 & P2 Fire Buttons" )
	PORT_DIPSETTING(    0x02, "Separate" )
	...
	PORT_BIT( 0,       0x04, IPT_DIPSWITCH_SETTING ) PORT_NAME("Infinite Lives") PORT_CHEAT
	PORT_DIPNAME( 0x30, 0x30, DEF_STR( Bonus_Life ) )
	PORT_DIPSETTING(    0x30, "50k 100k" )
	PORT_DIPSETTING(    0x20, "60k 120k" )
	PORT_DIPSETTING(    0x10, "100k 200k" )
...
INPUT_PORTS_START( legofair )
	...
	PORT_BIT(0x08, 0x08, IPT_SERVICE ) PORT_NAME( DEF_STR( Service_Mode)) PORT_CODE(KEYCODE_F2)
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN2 )
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN1 )
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START2 )
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 )
...
INPUT_PORTS_START( fitegolf )
	...
	PORT_START	/* DSW1 */
	PORT_DIPNAME( 0x01, 0x01, "Language" ) /* Version */
	PORT_DIPSETTING(    0x01, "English" )  /* Over Sea */
	PORT_DIPSETTING(    0x00, "Japanese" ) /* Domestic */
	PORT_DIPNAME( 0x02, 0x02, DEF_STR( Flip_Screen ) )
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	...
	PORT_DIPNAME( 0x0c, 0x0c, "Game Mode" )
	PORT_BIT( 0,       0x08, IPT_DIPSWITCH_SETTING ) PORT_NAME("Endless Game") PORT_CHEAT
...
INPUT_PORTS_START( countryc )
	...
	PORT_START
	PORT_BIT( 0x7f, 0x40, IPT_TRACKBALL_X  ) PORT_MINMAX(0,0x7f) PORT_SENSITIVITY(50) PORT_KEYDELTA(30)
	...
	PORT_START	/* DSW1 */
	PORT_DIPNAME( 0x01, 0x01, "Language" ) /* NOT showed in Test Mode/Manual */
...
INPUT_PORTS_START( ftsoccer )
	...
	PORT_BIT( 0x7f, 0x00, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10) PORT_CODE_DEC(KEYCODE_Z) PORT_CODE_INC(KEYCODE_X) PORT_PLAYER(1)
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* Only used in the "test mode" in this version */
	PORT_BIT( 0x7f, 0x00, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10) PORT_CODE_DEC(KEYCODE_N) PORT_CODE_INC(KEYCODE_M) PORT_PLAYER(2)
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* Only used in the "test mode" in this version */
	PORT_BIT( 0x7f, 0x00, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10) PORT_PLAYER(3)
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* Only used in the "test mode" in this version */
	PORT_BIT( 0x7f, 0x00, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10) PORT_PLAYER(4)
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )
...
/* 	PORT_DIPSETTING(    0x0c, "Europe" ) */
	...
	PORT_DIPSETTING(    0x0c, "Demo Sound On" )
	PORT_DIPSETTING(    0x00, "Freeze" )
	PORT_BIT( 0,       0x04, IPT_DIPSWITCH_SETTING ) PORT_NAME("Win Match Against CPU") PORT_CHEAT
...
INPUT_PORTS_START( tdfever )
	...
	PORT_START
	PORT_BIT( 0x7f, 0x00, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10) PORT_CODE_DEC(KEYCODE_Z) PORT_CODE_INC(KEYCODE_X)
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )
	...
	PORT_DIPSETTING(    0x00, "Freeze" )
	PORT_BIT( 0,       0x04, IPT_DIPSWITCH_SETTING ) PORT_NAME("Never Finish?") PORT_CHEAT

...
*/
	...
	PORT_START/*12*/
	PORT_BIT( 0x01, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 KAN") PORT_CODE(	CODE_NONE)
	PORT_BIT( 0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 START") PORT_CODE(KEYCODE_2)
	PORT_BIT ( 0x04, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT ( 0x08, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 E") PORT_CODE(	CODE_NONE)
	PORT_BIT( 0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 A") PORT_CODE(	CODE_NONE)
	PORT_BIT( 0x40, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 M") PORT_CODE(	CODE_NONE)
	PORT_BIT( 0x80, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 I") PORT_CODE(	CODE_NONE)

	PORT_START/*13*/
	PORT_BIT( 0x01, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 RON") PORT_CODE(CODE_NONE)
	PORT_BIT ( 0x02, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT ( 0x04, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT ( 0x08, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 F") PORT_CODE(	CODE_NONE)
	PORT_BIT( 0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 B") PORT_CODE(	CODE_NONE)
	PORT_BIT( 0x40, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 N") PORT_CODE(	CODE_NONE)
	PORT_BIT( 0x80, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 J") PORT_CODE(	CODE_NONE)

	PORT_START/*14*/
	PORT_BIT( 0x01, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 REACH") PORT_CODE(CODE_NONE)
	PORT_BIT ( 0x02, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT ( 0x04, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT ( 0x08, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 G") PORT_CODE(	CODE_NONE)
	PORT_BIT( 0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 C") PORT_CODE(	CODE_NONE)
	PORT_BIT( 0x40, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 CHI") PORT_CODE(CODE_NONE)
	PORT_BIT( 0x80, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 K") PORT_CODE(	CODE_NONE)
	...
	PORT_BIT ( 0x04, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT ( 0x08, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 H") PORT_CODE(	CODE_NONE)
	PORT_BIT( 0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 D") PORT_CODE(	CODE_NONE)
	PORT_BIT( 0x40, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 PON") PORT_CODE(CODE_NONE)
	PORT_BIT( 0x80, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 L") PORT_CODE(	CODE_NONE)
	...
	PORT_BIT ( 0x10, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT ( 0x20, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x40, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 FLIP") PORT_CODE(CODE_NONE)
	PORT_BIT ( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )
INPUT_PORTS_END

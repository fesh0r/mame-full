...
static ADDRESS_MAP_START( main_readmem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x641000, 0x641fff) AM_READ(atarigen_eeprom_r)
	AM_RANGE(0x642000, 0x642001) AM_READ(adpcm_r)
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( main_writemem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x3e0800, 0x3effbf) AM_WRITE(MWA16_RAM)
	AM_RANGE(0x3effc0, 0x3effff) AM_WRITE(atarimo_0_slipram_w) AM_BASE(&atarimo_0_slipram)
	AM_RANGE(0x640040, 0x64004f) AM_WRITE(latch_w)
	AM_RANGE(0x640060, 0x64006f) AM_WRITE(atarigen_eeprom_enable_w)
	AM_RANGE(0x641000, 0x641fff) AM_WRITE(atarigen_eeprom_w) AM_BASE(&atarigen_eeprom) AM_SIZE(&atarigen_eeprom_size)
	AM_RANGE(0x642000, 0x642001) AM_WRITE(adpcm_w)

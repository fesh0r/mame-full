...
INPUT_PORTS_START( ginganin )
	...
	PORT_BIT(	  0x0040, 0x0040, IPT_DIPSWITCH_NAME ) PORT_NAME("Infinite Lives") PORT_CHEAT
	PORT_DIPSETTING(	  0x0040, DEF_STR( Off ) )
	PORT_DIPSETTING(	  0x0000, DEF_STR( On ) )
	PORT_BIT(	  0x0080, 0x0080, IPT_DIPSWITCH_NAME ) PORT_NAME("Free Play & Invulnerability") PORT_CHEAT

...
INPUT_PORTS_START( forgottn )
	...
	PORT_START
	PORT_ANALOGX( 0x0fff, 0x0000, IPT_DIAL | IPF_PLAYER1, 100, 20, 0, 0, KEYCODE_Z, KEYCODE_X, CODE_NONE, CODE_NONE )

	PORT_START
	PORT_ANALOGX( 0x0fff, 0x0000, IPT_DIAL | IPF_PLAYER2, 100, 20, 0, 0, KEYCODE_N, KEYCODE_M, CODE_NONE, CODE_NONE )
INPUT_PORTS_END
...
//	PORT_DIPSETTING(    0x40, DEF_STR( Cocktail ) )
	...
	PORT_BITX(    0x80, 0x80, IPT_DIPSWITCH_NAME, "Game Mode", CODE_NONE, CODE_NONE )
...
//	PORT_DIPSETTING(    0x00, "?" )
	...
	PORT_DIPSETTING(    0x01, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_BITX( 0x02, 0x02, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Infinite Lives", CODE_NONE, CODE_NONE )
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x04, 0x04, DEF_STR( Free_Play ) )
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )

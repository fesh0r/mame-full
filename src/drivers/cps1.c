...
ROM_START( ghoulsj )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )
	ROM_LOAD16_BYTE( "ghlj29.bin",   0x00000, 0x20000, 0x82fd1798 )
	ROM_LOAD16_BYTE( "ghlj30.bin",   0x00001, 0x20000, 0x35366ccc )
	ROM_LOAD16_BYTE( "ghlj27.bin",   0x40000, 0x20000, 0xa17c170a )
	ROM_LOAD16_BYTE( "ghlj28.bin",   0x40001, 0x20000, 0x6af0b391 )
	ROM_LOAD16_WORD( "ghl17.bin",    0x80000, 0x80000, 0x3ea1b0f2 )
...
ROM_START( mswordj )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_BYTE( "msj_30.rom",   0x00000, 0x20000, 0x04f0ef50 )
	ROM_LOAD16_BYTE( "msj_35.rom",   0x00001, 0x20000, 0x9fcbb9cd )
	ROM_LOAD16_BYTE( "msj_31.rom",   0x40000, 0x20000, 0x6c060d70 )
	ROM_LOAD16_BYTE( "msj_36.rom",   0x40001, 0x20000, 0xaec77787 )
	ROM_LOAD16_WORD_SWAP( "ms_32.rom",    0x80000, 0x80000, 0x2475ddfc )
...
ROM_START( sf2 )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_BYTE( "sf2e_30b.rom",    0x00000, 0x20000, 0x57bd7051 )
	ROM_LOAD16_BYTE( "sf2e_37b.rom",    0x00001, 0x20000, 0x62691cdd )
	ROM_LOAD16_BYTE( "sf2e_31b.rom",    0x40000, 0x20000, 0xa673143d )
	ROM_LOAD16_BYTE( "sf2e_38b.rom",    0x40001, 0x20000, 0x4c2ccef7 )
	ROM_LOAD16_BYTE( "sf2_28b.rom",     0x80000, 0x20000, 0x4009955e )
	ROM_LOAD16_BYTE( "sf2_35b.rom",     0x80001, 0x20000, 0x8c1f3994 )
	ROM_LOAD16_BYTE( "sf2_29b.rom",     0xc0000, 0x20000, 0xbb4af315 )
	ROM_LOAD16_BYTE( "sf2_36b.rom",     0xc0001, 0x20000, 0xc02a13eb )

	ROM_REGION( 0x600000, REGION_GFX1, 0 )
	ROMX_LOAD( "sf2gfx02.rom", 0x000000, 0x80000, 0x22c9cc8e, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2gfx04.rom", 0x000002, 0x80000, 0x57213be8, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2gfx01.rom", 0x000004, 0x80000, 0xba529b4f, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2gfx03.rom", 0x000006, 0x80000, 0x4b1b33a8, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2gfx11.rom", 0x200000, 0x80000, 0x2c7e2229, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2gfx13.rom", 0x200002, 0x80000, 0xb5548f17, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2gfx10.rom", 0x200004, 0x80000, 0x14b84312, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2gfx12.rom", 0x200006, 0x80000, 0x5e9cd89a, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2gfx21.rom", 0x400000, 0x80000, 0x994bfa58, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2gfx23.rom", 0x400002, 0x80000, 0x3e66ad9d, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2gfx20.rom", 0x400004, 0x80000, 0xc1befaa8, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2gfx22.rom", 0x400006, 0x80000, 0x0627c831, ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( sf2jb )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_BYTE( "sf2e_30b.rom",   0x00000, 0x20000, 0x57bd7051 )
	ROM_LOAD16_BYTE( "sf2j_37b.rom",   0x00001, 0x20000, 0x1e1f6844 )
	ROM_LOAD16_BYTE( "sf2e_31b.rom",   0x40000, 0x20000, 0xa673143d )
	ROM_LOAD16_BYTE( "sf2e_38b.rom",   0x40001, 0x20000, 0x4c2ccef7 )
	ROM_LOAD16_BYTE( "sf2_28b.rom",    0x80000, 0x20000, 0x4009955e )
	ROM_LOAD16_BYTE( "sf2_35b.rom",    0x80001, 0x20000, 0x8c1f3994 )
...
ROM_START( sf2ce )
	...
	ROM_LOAD16_WORD_SWAP( "sf2ce.21",     0x100000, 0x80000, 0x925a7877 )

	ROM_REGION( 0x600000, REGION_GFX1, 0 )
	ROMX_LOAD( "sf2.01",       0x000000, 0x80000, 0x03b0d852, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.03",       0x000002, 0x80000, 0x840289ec, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.02",       0x000004, 0x80000, 0xcdb5f027, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.04",       0x000006, 0x80000, 0xe2799472, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.05",       0x200000, 0x80000, 0xba8a2761, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.07",       0x200002, 0x80000, 0xe584bfb5, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.06",       0x200004, 0x80000, 0x21e3f87d, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.08",       0x200006, 0x80000, 0xbefc47df, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.10",       0x400000, 0x80000, 0x960687d5, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.12",       0x400002, 0x80000, 0x978ecd18, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.11",       0x400004, 0x80000, 0xd6ec9a0a, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.13",       0x400006, 0x80000, 0xed2c67f6, ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( sf2cej )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD( "sf2cej.23",    0x000000, 0x80000, 0x7c463f94 )
	ROM_LOAD16_WORD( "sf2cej.22",    0x080000, 0x80000, 0x6628f6a6 )
	ROM_LOAD16_WORD( "sf2cej.21",    0x100000, 0x80000, 0xfcb8fe8f )
...
ROM_START( sf2t )
	...
	ROM_LOAD16_WORD_SWAP( "sf2.22",       0x080000, 0x80000, 0xaea6e035 )
	ROM_LOAD16_WORD_SWAP( "sf2.21",       0x100000, 0x80000, 0xfd200288 )
	...
	ROMX_LOAD( "sf2.06",       0x200004, 0x80000, 0x21e3f87d, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2.08",       0x200006, 0x80000, 0xbefc47df, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2t.10",      0x400000, 0x80000, 0x3c042686, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2t.12",      0x400002, 0x80000, 0x8b7e7183, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2t.11",      0x400004, 0x80000, 0x293c888c, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "sf2t.13",      0x400006, 0x80000, 0x842b35a4, ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( sf2tj )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "sf2tj.23",   0x000000, 0x80000, 0xea73b4dc )
	ROM_LOAD16_WORD_SWAP( "sf2.22",     0x080000, 0x80000, 0xaea6e035 )
	ROM_LOAD16_WORD_SWAP( "sf2.21",     0x100000, 0x80000, 0xfd200288 )
...
ROM_START( slammast )
	...
	ROMX_LOAD( "mb_gfx05.rom",   0x200000, 0x80000, 0x506b9dc9, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb_gfx07.rom",   0x200002, 0x80000, 0xaff8c2fb, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb_gfx06.rom",   0x200004, 0x80000, 0xb76c70e9, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb_gfx08.rom",   0x200006, 0x80000, 0xe60c9556, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb_gfx10.rom",   0x400000, 0x80000, 0x97976ff5, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb_gfx12.rom",   0x400002, 0x80000, 0xb350a840, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb_gfx11.rom",   0x400004, 0x80000, 0x8fb94743, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb_gfx13.rom",   0x400006, 0x80000, 0xda810d5f, ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( mbomberj )
	...
	ROM_REGION( 0x600000, REGION_GFX1, 0 )
	ROMX_LOAD( "mb01",           0x000000, 0x80000, 0xa53b1c81, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb02",           0x000002, 0x80000, 0x23fe10f6, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb03",           0x000004, 0x80000, 0xcb866c2f, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb04",           0x000006, 0x80000, 0xc9143e75, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb_gfx05.rom",   0x200000, 0x80000, 0x506b9dc9, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb_gfx07.rom",   0x200002, 0x80000, 0xaff8c2fb, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb_gfx06.rom",   0x200004, 0x80000, 0xb76c70e9, ROM_GROUPWORD | ROM_SKIP(6) )
	ROMX_LOAD( "mb_gfx08.rom",   0x200006, 0x80000, 0xe60c9556, ROM_GROUPWORD | ROM_SKIP(6) )
...
ROM_START( mbombrd )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_BYTE( "mbde_26.rom",       0x000000, 0x20000, 0x72b7451c )
	ROM_LOAD16_BYTE( "mbde_30.rom",       0x000001, 0x20000, 0xa036dc16 )
	ROM_LOAD16_BYTE( "mbde_27.rom",       0x040000, 0x20000, 0x4086f534 )
	ROM_LOAD16_BYTE( "mbde_31.rom",       0x040001, 0x20000, 0x085f47f0 )
	ROM_LOAD16_BYTE( "mbde_24.rom",       0x080000, 0x20000, 0xc20895a5 )
	ROM_LOAD16_BYTE( "mbde_28.rom",       0x080001, 0x20000, 0x2618d5e1 )
	ROM_LOAD16_BYTE( "mbde_25.rom",       0x0c0000, 0x20000, 0x9bdb6b11 )
	ROM_LOAD16_BYTE( "mbde_29.rom",       0x0c0001, 0x20000, 0x3f52d5e5 )
	ROM_LOAD16_WORD_SWAP( "mbde_21.rom",  0x100000, 0x80000, 0x690c026a )
	ROM_LOAD16_WORD_SWAP( "mbde_20.rom",  0x180000, 0x80000, 0xb8b2139b )
...
ROM_START( mbombrdj )
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
	ROM_LOAD16_BYTE( "mbde_26.rom",       0x000000, 0x20000, 0x72b7451c )
	ROM_LOAD16_BYTE( "mbde30.rom",        0x000001, 0x20000, 0xbeff31cf )
	ROM_LOAD16_BYTE( "mbde_27.rom",       0x040000, 0x20000, 0x4086f534 )
	ROM_LOAD16_BYTE( "mbde_31.rom",       0x040001, 0x20000, 0x085f47f0 )
	ROM_LOAD16_BYTE( "mbde_24.rom",       0x080000, 0x20000, 0xc20895a5 )
	ROM_LOAD16_BYTE( "mbde_28.rom",       0x080001, 0x20000, 0x2618d5e1 )
...
GAME( 1991, sf2a,     sf2,      sf2,      sf2,      0,        ROT0_16BIT, "Capcom", "Street Fighter II - The World Warrior (US 910206)" )
GAME( 1991, sf2b,     sf2,      sf2,      sf2,      0,        ROT0_16BIT, "Capcom", "Street Fighter II - The World Warrior (US 910214)" )
GAME( 1991, sf2e,     sf2,      sf2,      sf2,      0,        ROT0_16BIT, "Capcom", "Street Fighter II - The World Warrior (US 910228)" )
GAME( 1991, sf2i,     sf2,      sf2,      sf2,      0,        ROT0_16BIT, "Capcom", "Street Fighter II - The World Warrior (US 910522)" )
GAME( 1991, sf2j,     sf2,      sf2,      sf2j,     0,        ROT0_16BIT, "Capcom", "Street Fighter II - The World Warrior (Japan 911210)" )
GAME( 1991, sf2jb,    sf2,      sf2,      sf2j,     0,        ROT0_16BIT, "Capcom", "Street Fighter II - The World Warrior (Japan 910214)" )
...
GAME( 1992, sf2cea,   sf2ce,    sf2,      sf2,      0,        ROT0_16BIT, "Capcom", "Street Fighter II' - Champion Edition (US rev A)" )
GAME( 1992, sf2ceb,   sf2ce,    sf2,      sf2,      0,        ROT0_16BIT, "Capcom", "Street Fighter II' - Champion Edition (US rev B)" )
GAME( 1992, sf2cej,   sf2ce,    sf2,      sf2j,     0,        ROT0_16BIT, "Capcom", "Street Fighter II' - Champion Edition (Japan)" )
GAME( 1992, sf2rb,    sf2ce,    sf2,      sf2,      0,        ROT0_16BIT, "hack",  "Street Fighter II' - Champion Edition (Rainbow)" )

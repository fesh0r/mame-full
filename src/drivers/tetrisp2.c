...
INPUT_PORTS_START( rockn )
	...
	PORT_START	// IN2 - $be0008.w
	PORT_BIT(    0x0001, 0x0001, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 1-1") PORT_CHEAT
	PORT_DIPSETTING(      0x0001, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x0002, 0x0002, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 1-2") PORT_CHEAT
	PORT_DIPSETTING(      0x0002, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x0004, 0x0004, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 1-3") PORT_CHEAT
	PORT_DIPSETTING(      0x0004, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x0008, 0x0008, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 1-4") PORT_CHEAT
	PORT_DIPSETTING(      0x0008, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x0010, 0x0010, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 1-5") PORT_CHEAT
	PORT_DIPSETTING(      0x0010, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x0020, 0x0020, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 1-6") PORT_CHEAT
	PORT_DIPSETTING(      0x0020, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x0040, 0x0040, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 1-7") PORT_CHEAT
	PORT_DIPSETTING(      0x0040, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x0080, 0x0080, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 1-8") PORT_CHEAT
	PORT_DIPSETTING(      0x0080, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )

	PORT_BIT(    0x0100, 0x0100, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 2-1") PORT_CHEAT
	PORT_DIPSETTING(      0x0100, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x0200, 0x0200, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 2-2") PORT_CHEAT
	PORT_DIPSETTING(      0x0200, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x0400, 0x0400, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 2-3") PORT_CHEAT
	PORT_DIPSETTING(      0x0400, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x0800, 0x0800, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 2-4") PORT_CHEAT
	PORT_DIPSETTING(      0x0800, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x1000, 0x1000, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 2-5") PORT_CHEAT
	PORT_DIPSETTING(      0x1000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x2000, 0x2000, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 2-6") PORT_CHEAT
	PORT_DIPSETTING(      0x2000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x4000, 0x4000, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 2-7") PORT_CHEAT
	PORT_DIPSETTING(      0x4000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_BIT(    0x8000, 0x8000, IPT_DIPSWITCH_NAME ) PORT_NAME("DIPSW 2-8") PORT_CHEAT
	PORT_DIPSETTING(      0x8000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
INPUT_PORTS_END

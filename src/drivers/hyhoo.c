...
INPUT_PORTS_START( hyhoo )
	...
	PORT_BIT(0x01, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1-A") PORT_CODE(KEYCODE_Z)
	PORT_BIT(0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1-B") PORT_CODE(KEYCODE_X)
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1-C") PORT_CODE(KEYCODE_C)
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2-A") PORT_CODE(KEYCODE_V)
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2-B") PORT_CODE(KEYCODE_B)
	PORT_BIT(0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2-C") PORT_CODE(KEYCODE_N)
	...
	PORT_BIT(0x01, IP_ACTIVE_LOW, 0 ) PORT_NAME("P3-A") PORT_CODE(KEYCODE_A)
	PORT_BIT(0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P3-B") PORT_CODE(KEYCODE_S)
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P3-C") PORT_CODE(KEYCODE_D)
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P4-A") PORT_CODE(KEYCODE_F)
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P4-B") PORT_CODE(KEYCODE_G)
	PORT_BIT(0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P4-C") PORT_CODE(KEYCODE_H)
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )
INPUT_PORTS_END

...
INPUT_PORTS_START( konamigv )
	...
	PORT_BIT(0x1000, IP_ACTIVE_LOW, 0 ) PORT_NAME("Test Switch") PORT_CODE(KEYCODE_F2)
...
INPUT_PORTS_START( simpbowl )
	...
	/* IN 3 */
	PORT_START
	PORT_BIT( 0x7ff, 0x0000, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(63) PORT_REVERSE PORT_PLAYER(1)

	/* IN 4 */
	PORT_START
	PORT_BIT( 0x7ff, 0x0000, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(63) PORT_PLAYER(1)

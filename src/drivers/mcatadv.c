...
INPUT_PORTS_START( mcatadv )
	...
	PORT_DIPSETTING(    0x00, DEF_STR( 4C_1C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x00)
	PORT_DIPSETTING(    0x10, DEF_STR( 3C_1C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x00)
	PORT_DIPSETTING(    0x10, DEF_STR( 2C_1C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x08)
	PORT_DIPSETTING(    0x30, DEF_STR( 1C_1C ) )
	PORT_DIPSETTING(    0x00, DEF_STR( 2C_3C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x08)
	PORT_DIPSETTING(    0x20, DEF_STR( 1C_2C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x08)
	PORT_DIPSETTING(    0x20, DEF_STR( 1C_4C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x00)
	PORT_DIPNAME( 0xc0, 0xc0, DEF_STR( Coin_B ) )
	PORT_DIPSETTING(    0x00, DEF_STR( 4C_1C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x00)
	PORT_DIPSETTING(    0x40, DEF_STR( 3C_1C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x00)
	PORT_DIPSETTING(    0x40, DEF_STR( 2C_1C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x08)
	PORT_DIPSETTING(    0xc0, DEF_STR( 1C_1C ) )
	PORT_DIPSETTING(    0x00, DEF_STR( 2C_3C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x08)
	PORT_DIPSETTING(    0x80, DEF_STR( 1C_2C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x08)
	PORT_DIPSETTING(    0x80, DEF_STR( 1C_4C ) )	PORT_DIPCONDITION(2,0x08,PORTCOND_EQUALS,0x00)

/*
    ...
    almost OK
    ---------
    dynabb: won't coin up properly (i960 bug?)
    sgt24h: hangs on network test
    stcc: shows legal screen, then a bunch of "NOT CGM DATA!" errors
    vstriker: shows some attract mode, then hangs
    srallyc: drops into test menu, hits unimplemented REMR (0x683) if you exit
    manxtt: drops into test menu, hangs when you exit
    doaa: shows parade of 'ANIME' errors
    skytargt: never writes to proper palette RAM, hangs on title screen, and doesn't coin up
    dynamcop: coins up, won't start

    freezes / hangs
    ---------------
    lastbrxa: hangs (waiting for DSPs?)
    pltkids: hangs on gray screen
...
static READ32_HANDLER( model2_serial_r )
{
	...
	{
		return 0x00070000;	// TxRdy RxRdy (zeroguna also needs bit 4 - possibly a bug, since the 2B version reads FIFO status here instead)
	}
...
static ADDRESS_MAP_START( model2_base_mem, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x009c0004, 0x009c0007) AM_READ(fifoctl_r)
...
ROM_START( zeroguna )
	...
	ROM_REGION( 0x1000000, REGION_USER1, 0 ) // Data
...
ROM_START( vf2 )
	...
	ROM_REGION( 0x2400000, REGION_USER1, 0 ) // Data
...
ROM_START( skytargt )
	...
	ROM_REGION( 0x100000, REGION_CPU2, 0 ) // Sound program
        ROM_LOAD16_WORD_SWAP( "ep18408.30",   0x000000, 0x080000, CRC(6deb9657) SHA1(30e1894432a0765c64b93dd5ca7ca17ef58ac6c0) )
...
ROM_START( dynmcopb )
	...
	ROM_REGION( 0x2000000, REGION_USER1, 0 ) // Data
	ROM_LOAD32_WORD("mp20797.10",   0x000000, 0x400000, CRC(87bab1e4) SHA1(af2b2d82364621a1528d6ed59fbfbf15dc93ee72))
	ROM_LOAD32_WORD("mp20798.11",   0x000002, 0x400000, CRC(40dd752b) SHA1(8c2e210ac7c7b133ba9befc79a07c4ca6b4e3f18))
	ROM_LOAD32_WORD("mp20795.8",    0x800000, 0x400000, CRC(0ef85e12) SHA1(97c657edd98cde6f0780a04a7711e5b370087a60))
	ROM_LOAD32_WORD("mp20796.9",    0x800002, 0x400000, CRC(870139cb) SHA1(24fda2cd458cf7a3db485564c02ac61d30cbdf5e))
...
ROM_START( lastbexp )
	ROM_REGION( 0x200000, REGION_CPU1, 0 ) // i960 program
	ROM_LOAD32_WORD("ep19061a.15",  0x000000, 0x080000, CRC(c0aebab2) SHA1(0))
	ROM_LOAD32_WORD("ep19062a.16",  0x000002, 0x080000, CRC(cdf597e8) SHA1(0))
...
ROM_START( pltkidsa )
	...
	ROM_REGION( 0x800000, REGION_USER1, 0 ) // Data
...
ROM_START( pltkids )
	ROM_REGION( 0x200000, REGION_CPU1, 0 ) // i960 program
	ROM_LOAD32_WORD("ep21285a.15",  0x000000, 0x080000, CRC(bdde5b41) SHA1(0))
	ROM_LOAD32_WORD("ep21286a.16",  0x000002, 0x080000, CRC(c8092e0e) SHA1(0))
...
ROM_START( doa )
	ROM_REGION( 0x200000, REGION_CPU1, 0 ) // i960 program
	ROM_LOAD32_WORD("ep19379b.15",   0x000000, 0x080000, CRC(8a10a944) SHA1(0))
	ROM_LOAD32_WORD("ep19380b.16",   0x000002, 0x080000, CRC(766c1ec8) SHA1(0))
...
ROM_START( vonusa )
	ROM_REGION( 0x200000, REGION_CPU1, 0 ) // i960 program
	ROM_LOAD32_WORD("vo-prog0.usa", 0x000000, 0x080000, CRC(6499CC59) SHA1(0))
	ROM_LOAD32_WORD("vo-prog1.usa", 0x000002, 0x080000, CRC(0053B10F) SHA1(0))
	ROM_LOAD32_WORD("ep18666.13",   0x100000, 0x080000, CRC(66edb432) SHA1(b67131b0158a58138380734dd5b9394b70010026))
	ROM_LOAD32_WORD("ep18667.14",   0x100002, 0x080000, CRC(b593d31f) SHA1(1e9f23f4052ab1b0275307cc80e51352f13bc319))
...
ROM_START( vstrikra )
	...
	ROM_REGION( 0x900000, REGION_USER1, 0 ) // Data
	ROM_LOAD32_WORD("mp18055.11",   0x000000, 0x200000, CRC(5aba9fc0) SHA1(40d45af7e58fa48b6afa85071c2bd1d4b5b5ffa5))
	ROM_LOAD32_WORD("mp18056.12",   0x000002, 0x200000, CRC(017f0c55) SHA1(744e5a02abd82fbeb875c5cd30c5543570140cff))
	ROM_LOAD32_WORD("mp18053.9",    0x400000, 0x200000, CRC(46c770c8) SHA1(000e9edfed49cc3dcc136f80e044dcd2b42378ce))
	ROM_LOAD32_WORD("mp18054.10",   0x400002, 0x200000, CRC(437af66e) SHA1(c5afa62100a93e160aa96b327a260cc7fee51fdc))
...
ROM_START( daytona )
	ROM_REGION( 0x200000, REGION_CPU1, 0 ) // i960 program
	ROM_LOAD32_WORD("16722a.epr",   0x000000, 0x020000, CRC(48b94318) SHA1(a476a9a3531beef760c88c9634ed4a7d270e8ee7))
	ROM_LOAD32_WORD("16723a.epr",   0x000002, 0x020000, CRC(8af8b32d) SHA1(2039ec1f8da524176fcf85473c10a8b6e49e139a))

	ROM_REGION( 0x1000000, REGION_USER1, 0 ) // Data
	ROM_LOAD32_WORD("16528.mpr",    0x000000, 0x200000, CRC(9ce591f6) SHA1(e22fc8a70b533f7a6191f5952c581fb8f9627906))
	ROM_LOAD32_WORD("16529.mpr",    0x000002, 0x200000, CRC(f7095eaf) SHA1(da3c922f950dd730ea348eae12aa1cb69cee9a58))
	ROM_LOAD32_WORD("16808.mpr",    0x400000, 0x200000, CRC(44f1f5a0) SHA1(343866a6e2187a8ebc17f6727080f9f2f9ac9200))
	ROM_LOAD32_WORD("16809.mpr",    0x400002, 0x200000, CRC(37a2dd12) SHA1(8192d8698d6bd52ee11cc28917aff5840c447627))
	ROM_LOAD32_WORD("16724a.epr",   0x800000, 0x080000, CRC(469f10fd) SHA1(7fad3b8d03960e5e1f7a6cb36509238977e00fcc))
	...
	ROM_RELOAD     (                0xe00000, 0x080000 )
	ROM_RELOAD     (                0xf00000, 0x080000 )
	ROM_LOAD32_WORD("16725a.epr",   0x800002, 0x080000, CRC(ba0df8db) SHA1(d0c5581c56500b5266cab8e8151db24fcbdea0d7))
	...
	ROM_LOAD16_WORD_SWAP("16720.epr",    0x000000,  0x20000, CRC(8e73cffd) SHA1(9933ccc0757e8c86e0adb938d1c89210b26841ea))
	ROM_LOAD16_WORD_SWAP("16721.epr",    0x020000,  0x20000, CRC(1bb3b7b7) SHA1(ee2fd1480e535fc37e9932e6fe4e31344559fc87))

	ROM_REGION( 0x400000, REGION_SOUND1, 0 ) // Samples
	ROM_LOAD("16491.mpr",    0x000000, 0x200000, CRC(89920903) SHA1(06d1d55470ae99f8de0f8c88c694f34c4eb13668))
	ROM_LOAD("16492.mpr",    0x200000, 0x200000, CRC(459e701b) SHA1(2054f69cecad677eb00c6a3051f5b5d90885e19b))

	ROM_REGION( 0x400000, REGION_SOUND2, 0 ) // Samples
	ROM_LOAD("16493.mpr",    0x000000, 0x200000, CRC(9990db15) SHA1(ea9a8b45a07dccaae62be7cf095532ce7596a70c))
	ROM_LOAD("16494.mpr",    0x200000, 0x200000, CRC(600e1d6c) SHA1(d4e246fc57a16ff562bbcbccf6a739b706f58696))

	MODEL2_CPU_BOARD /* Model 2 CPU board extra roms */

	ROM_REGION( 0x1000000, REGION_USER7, 0 ) // Unplaced roms, should probably be loaded for other daytona sets too
	ROM_LOAD("16537",    0x000000, 0x100000, CRC(44ce6834) SHA1(61b7ee8f9667683bb723bb930945e550ba84daa4))
	ROM_LOAD("16536",    0x000000, 0x100000, CRC(adea6e68) SHA1(fd9065ea1a19791e813ec163525c072a2e985e61))
	ROM_LOAD("16525",    0x000000, 0x100000, CRC(04d56b09) SHA1(62d28ba02cdcc5de89b558ea32ac92aca95d1ff8))
	ROM_LOAD("16524",    0x000000, 0x100000, CRC(fd5ce5e7) SHA1(b33098977b6fc980e3f21096f96745199a2155a9))
	ROM_LOAD("16519",    0x000000, 0x100000, CRC(5348d519) SHA1(b0fa271e6d350ac5112a258bb9c0fa569e05c739))
	ROM_LOAD("16520",    0x000000, 0x100000, CRC(937f390b) SHA1(e8fe943a2824101d0a37dada5103daa1009a531d))
	ROM_LOAD("16521",    0x000000, 0x200000, CRC(af1934fb) SHA1(a6a21a23cd34d0de6d3e6a5c3c2687f905d0dc2a))
	ROM_LOAD("16522",    0x000000, 0x200000, CRC(55d39a57) SHA1(abf7b0fc0f111f90da42463d600db9fa32e95efe))
	ROM_LOAD("16769",    0x000000, 0x200000, CRC(e57429e9) SHA1(8c712ab09e61ef510741a55f29b3c4e497471372))
	ROM_LOAD("16523",    0x000000, 0x200000, CRC(2f484d42) SHA1(0b83a3fc92b7d913a14cfb01d688c63555c17c41))
	ROM_LOAD("16772",    0x000000, 0x200000, CRC(770ed912) SHA1(1789f35dd403f73f8be18495a0fe4ad1e6841417))
	ROM_LOAD("16771",    0x000000, 0x200000, CRC(a2205124) SHA1(257a3675e4ef6adbf61285a5daa5954223c28cb2))
	ROM_LOAD("16770",    0x000000, 0x200000, CRC(f9fa7bfb) SHA1(8aa933b74d4e05dc49987238705e50b00e5dae73))
	ROM_LOAD("16518",    0x000000, 0x200000, CRC(df683bf7) SHA1(16afe5029591f3536b5b75d9cf50a34d0ea72c3d))
	ROM_LOAD("14869c",   0x000000, 0x010000, CRC(24b68e64) SHA1(c19d044d4c2fe551474492aa51922587394dd371))
ROM_END
...
ROM_START( vcop )
	...
	ROM_REGION( 0x0a00000, REGION_USER1, 0 ) // Data
	...
	ROM_REGION( 0x400000, REGION_CPU3, 0 ) // TGP program
...
ROM_START( desert )
	...
	ROM_REGION( 0x1000000, REGION_USER7, 0 ) // Unplaced roms
	ROM_LOAD("ic16  mpr16968 a530h 27c160",   0x000000, 0x200000, CRC(4a16f465) SHA1(411214ed65ce966040d4299b50bfaa40f7f5f266) )
	ROM_LOAD("ic17  mpr16969 ac4ah 27c160",   0x000000, 0x200000, CRC(887380ac) SHA1(03a9f601764d06cb0b2daaadf4f8433f327abd4a) )
	ROM_LOAD("ic20  mpr16965 ad57h 27c160",   0x000000, 0x200000, CRC(9ba7645f) SHA1(c04f369961f908bac16fad8e32b863202390c205) )
	ROM_LOAD("ic21  mpr16964 dcb0h 27c160",   0x000000, 0x200000, CRC(d4a769b6) SHA1(845c34f95a49e06e3996b0c67aa73b4886fa8996) )
	ROM_LOAD("ic24  mpr16966 7a3ch 27c160",   0x000000, 0x200000, CRC(7484efe9) SHA1(33e72139ad6c2990428e3fa041dbcdf39aca1c7a) )
	ROM_LOAD("ic25  mpr16967 7b0dh 27c160",   0x000000, 0x200000, CRC(b8b84c9d) SHA1(00ef320988609e98c8af383b68d845e3be8d0a03) )
	ROM_LOAD("ic28  epr16981 098eh 27c400",   0x000000, 0x080000, CRC(ae847571) SHA1(32d0f9e685667ae9fddacea0b9f4ad6fb3a6fdad) )
	ROM_LOAD("ic29  epr16980 4418h 27c400",   0x000000, 0x080000, CRC(5239b864) SHA1(e889556e0f1ea80de52afff563b0923f87cef7ab) )
ROM_END
...
// these two NOPs are in ElSemi's emulator
//	ROM[0x630/4] = 0x08000004;
//	ROM[0x808/4] = 0x08000004;
// this one isn't...
	ROM[0x2810/4] = 0x08000004;
}

// Model 2 (TGPs, Model 1 sound board)
GAMEX( 1993, daytona,         0, model2o, daytona, 0, ROT0, "Sega", "Daytona USA (Japan)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1993, daytonat,  daytona, model2o, daytona, 0, ROT0, "Sega", "Daytona USA (Japan, Turbo hack)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1993, daytonam,  daytona, model2o, daytona, daytonam, ROT0, "Sega", "Daytona USA (Japan, To The MAXX)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1994, desert,          0, model2o, desert, 0, ROT0, "Sega", "Desert Tank", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1994, vcop,            0, model2o, daytona, 0, ROT0, "Sega", "Virtua Cop", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )

// Model 2A-CRX (TGPs, SCSP sound board)
GAMEX( 1995, manxtt,          0, model2, model2, 0, ROT0, "Sega", "Manx TT Superbike", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1995, srallyc,         0, model2, model2, 0, ROT0, "Sega", "Sega Rally Championship", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1995, vf2,             0, model2, model2, 0, ROT0, "Sega", "Virtua Fighter 2", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1995, vf21,          vf2, model2, model2, 0, ROT0, "Sega", "Virtua Fighter 2 (ver 2.1)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1995, vcop2,           0, model2, model2, 0, ROT0, "Sega", "Virtua Cop 2", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1996, dynamcop,        0, model2, model2, genprot, ROT0, "Sega", "Dynamite Cop (Model 2A)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1996, doaa,          doa, model2, model2, doa, ROT0, "Sega", "Dead or Alive (Model 2A)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1997, zeroguna,  zerogun, model2, model2, genprot, ROT0, "Psikyo", "Zero Gunner (Model 2A)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1998, pltkidsa,  pltkids, model2, model2, pltkids, ROT0, "Psikyo", "Pilot Kids (Model 2A)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )

// Model 2B-CRX (SHARC, SCSP sound board)
GAMEX( 1994, vstriker,        0, model2, model2, 0, ROT0, "Sega", "Virtua Striker", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1994, vstrikra, vstriker, model2, model2, 0, ROT0, "Sega", "Virtua Striker (Rev A)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1995, fvipers,         0, model2, model2, 0, ROT0, "Sega", "Fighting Vipers", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1995, gunblade,        0, model2, model2, 0, ROT0, "Sega", "Gunblade NY", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1995, indy500,         0, model2, model2, 0, ROT0, "Sega", "Indianapolis 500", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1995, skytargt,        0, model2, model2, 0, ROT0, "Sega", "Sky Target", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1996, dynmcopb, dynamcop, model2, model2, genprot, ROT0, "Sega", "Dynamite Cop (Model 2B)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1996, schamp,          0, model2, model2, 0, ROT0, "Sega", "Sonic Championship", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1996, lastbrxa,        0, model2, model2, 0, ROT0, "Sega", "Last Bronx (Rev A)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1996, lastbexp,        0, model2, model2, 0, ROT0, "Sega", "Last Bronx (Export, Rev A)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1996, doa,             0, model2, model2, doa, ROT0, "Sega", "Dead or Alive (Model 2B)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1996, sgt24h,          0, model2, model2, sgt24h, ROT0, "Jaleco", "Super GT 24h", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1996, von,             0, model2, model2, 0, ROT0, "Sega", "Virtual On Cybertroopers (Japan)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1996, vonusa,        von, model2, model2, 0, ROT0, "Sega", "Virtual On Cybertroopers (US)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1996, dynabb,          0, model2, model2, 0, ROT0, "Sega", "Dynamite Baseball '97", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1997, zerogun,         0, model2, model2, genprot, ROT0, "Psikyo", "Zero Gunner (Model 2B)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1997, zerogunj,  zerogun, model2, model2, genprot, ROT0, "Psikyo", "Zero Gunner (Jap, Model 2B)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1998, pltkids,         0, model2, model2, pltkids, ROT0, "Psikyo", "Pilot Kids (Model 2B)", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )

// Model 2C-CRX (TGPx4, SCSP sound board)
GAMEX( 1996, stcc,            0, model2c, model2, 0, ROT0, "Sega", "Sega Touring Car Championship", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1997, hotd,            0, model2c, model2, 0, ROT0, "Sega", "House of the Dead", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1997, topskatr,        0, model2c, model2, 0, ROT0, "Sega", "Top Skater", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )
GAMEX( 1998, bel,             0, model2c, bel,    0, ROT0, "Sega", "Behind Enemy Lines", GAME_NOT_WORKING|GAME_IMPERFECT_GRAPHICS )

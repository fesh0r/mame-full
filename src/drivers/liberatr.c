...
INPUT_PORTS_START( liberatr )
	...
	PORT_BIT( 0x0f, 0x0, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(30) PORT_KEYDELTA(10)

	PORT_START	/* IN5 - FAKE - overlaps IN0 in the HW */
	PORT_BIT( 0x0f, 0x0, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(30) PORT_KEYDELTA(10)
INPUT_PORTS_END

...
static struct GfxLayout tank_layout =
{
	16, 16,
	4,
	1,
...
static struct GfxDecodeInfo tank8_gfxdecodeinfo[] =
{
...
static DRIVER_INIT( decode )
{
 ...
 GAME( 1976, tank8,  0,     tank8, tank8, 0,	  ROT0, "Atari", "Tank 8 (set 1)")
GAMEX( 1976, tank8a, tank8, tank8, tank8, decode, ROT0, "Atari", "Tank 8 (set 2)",  GAME_NOT_WORKING )
GAMEX( 1976, tank8b, tank8, tank8, tank8, decode, ROT0, "Atari", "Tank 8 (set 3)",  GAME_NOT_WORKING )
GAMEX( 1976, tank8c, tank8, tank8, tank8, 0,      ROT0, "Atari", "Tank 8 (set 4)",  GAME_NOT_WORKING )
GAMEX( 1976, tank8d, tank8, tank8, tank8, 0,      ROT0, "Atari", "Tank 8 (set 5)",  GAME_NOT_WORKING )

...
#define SETAMJCTRL_PORT3 \
	...
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Small") PORT_CODE(KEYCODE_BACKSPACE) \
	PORT_BIT( 0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Double Up") PORT_CODE(KEYCODE_RSHIFT) \
	PORT_BIT( 0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Big") PORT_CODE(KEYCODE_ENTER) \
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Take Score") PORT_CODE(KEYCODE_RCONTROL) \
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Flip") PORT_CODE(KEYCODE_X) \
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Last Chance") PORT_CODE(KEYCODE_RALT) \
	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN ) \
	PORT_BIT ( 0xff00, IP_ACTIVE_LOW, IPT_UNKNOWN )

#define SETAMJCTRL_PORT4 \
	PORT_START	/* KEY MATRIX INPUT (4) */ \
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 K") PORT_CODE(KEYCODE_K) \
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Ron") PORT_CODE(KEYCODE_Z) \
	PORT_BIT( 0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 G") PORT_CODE(KEYCODE_G) \
	PORT_BIT( 0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Chi") PORT_CODE(KEYCODE_SPACE) \
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 C") PORT_CODE(KEYCODE_C) \
	PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN ) \
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 L") PORT_CODE(KEYCODE_L) \
	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN ) \
	PORT_BIT ( 0xff00, IP_ACTIVE_LOW, IPT_UNKNOWN )

#define SETAMJCTRL_PORT5 \
	PORT_START	/* KEY MATRIX INPUT (5) */ \
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 H") PORT_CODE(KEYCODE_H) \
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Pon") PORT_CODE(KEYCODE_LALT) \
	PORT_BIT( 0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 D") PORT_CODE(KEYCODE_D) \
	PORT_BIT( 0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Start") PORT_CODE(KEYCODE_1) \
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 I") PORT_CODE(KEYCODE_I) \
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Kan") PORT_CODE(KEYCODE_LCONTROL) \
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 E") PORT_CODE(KEYCODE_E) \
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 M") PORT_CODE(KEYCODE_M) \
	PORT_BIT ( 0xff00, IP_ACTIVE_LOW, IPT_UNKNOWN )

#define SETAMJCTRL_PORT6 \
	PORT_START	/* KEY MATRIX INPUT (6) */ \
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 A") PORT_CODE(KEYCODE_A) \
	PORT_BIT( 0x0002, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Bet") PORT_CODE(KEYCODE_2) \
	PORT_BIT( 0x0004, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 J") PORT_CODE(KEYCODE_J) \
	PORT_BIT( 0x0008, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Reach") PORT_CODE(KEYCODE_LSHIFT) \
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 F") PORT_CODE(KEYCODE_F) \
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 N") PORT_CODE(KEYCODE_N) \
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 B") PORT_CODE(KEYCODE_B) \
	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN ) \
	PORT_BIT ( 0xff00, IP_ACTIVE_LOW, IPT_UNKNOWN )
...
INPUT_PORTS_START( srmp3 )
	...
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_BIT   ( 0x04, 0x04, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug Mode") PORT_CHEAT
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x08, 0x08, DEF_STR( Unknown ) )
	PORT_DIPSETTING(    0x08, DEF_STR( Off ) )
...
INPUT_PORTS_START( mjyuugi )
	...
	PORT_BIT ( 0x0001, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_SERVICE3 )
	PORT_BIT( 0x0004, 0x0004, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug Mode") PORT_CHEAT
	...
	PORT_BIT( 0x0001, 0x0001, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug  0") PORT_CHEAT
	PORT_DIPSETTING(   0x0001, DEF_STR( Off ) )
	PORT_DIPSETTING(   0x0000, DEF_STR( On ) )
	PORT_BIT( 0x0002, 0x0002, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug  1") PORT_CHEAT
	PORT_DIPSETTING(   0x0002, DEF_STR( Off ) )
	PORT_DIPSETTING(   0x0000, DEF_STR( On ) )
	PORT_BIT( 0x0004, 0x0004, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug  2") PORT_CHEAT
	PORT_DIPSETTING(   0x0004, DEF_STR( Off ) )
	PORT_DIPSETTING(   0x0000, DEF_STR( On ) )
	PORT_BIT( 0x0008, 0x0008, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug  3") PORT_CHEAT
	PORT_DIPSETTING(   0x0008, DEF_STR( Off ) )
	PORT_DIPSETTING(   0x0000, DEF_STR( On ) )
	PORT_BIT ( 0xfff0, IP_ACTIVE_LOW, IPT_UNKNOWN )

	PORT_START			/* DSW (3-2) [Debug switch] */
	PORT_BIT( 0x0001, 0x0001, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug  4") PORT_CHEAT
	PORT_DIPSETTING(   0x0001, DEF_STR( Off ) )
	PORT_DIPSETTING(   0x0000, DEF_STR( On ) )
	PORT_BIT( 0x0002, 0x0002, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug  5") PORT_CHEAT
	PORT_DIPSETTING(   0x0002, DEF_STR( Off ) )
	PORT_DIPSETTING(   0x0000, DEF_STR( On ) )
	PORT_BIT( 0x0004, 0x0004, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug  6") PORT_CHEAT
	PORT_DIPSETTING(   0x0004, DEF_STR( Off ) )
	PORT_DIPSETTING(   0x0000, DEF_STR( On ) )
	PORT_BIT( 0x0008, 0x0008, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug  7") PORT_CHEAT
	PORT_DIPSETTING(   0x0008, DEF_STR( Off ) )
	PORT_DIPSETTING(   0x0000, DEF_STR( On ) )
	PORT_BIT ( 0xfff0, IP_ACTIVE_LOW, IPT_UNKNOWN )
INPUT_PORTS_END
...
//	PORT_DIPSETTING(    0x10, "1000" )
	...
	PORT_BIT(    0x40, 0x40, IPT_DIPSWITCH_NAME ) PORT_NAME("Debug Mode") PORT_CHEAT
	PORT_DIPSETTING(    0x40, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )

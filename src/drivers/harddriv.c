...
ROM_START( harddriv )
	ROM_REGION( 0x200000, REGION_CPU1 )		/* 2MB for 68000 code */
	ROM_LOAD_EVEN( "hd_200.r", 0x00000, 0x10000, 0xa42a2c69 )
	ROM_LOAD_ODD ( "hd_210.r", 0x00000, 0x10000, 0x358995b5 )
	ROM_LOAD_EVEN( "hd_200.s", 0x20000, 0x10000, 0xa668db0e )
	ROM_LOAD_ODD ( "hd_210.s", 0x20000, 0x10000, 0xab689a94 )
	ROM_LOAD_EVEN( "hd_200.w", 0xa0000, 0x10000, 0x908ccbbe )
	ROM_LOAD_ODD ( "hd_210.w", 0xa0000, 0x10000, 0x5b25023c )
	ROM_LOAD_EVEN( "hd_200.x", 0xc0000, 0x10000, 0xe1f455a3 )
	ROM_LOAD_ODD ( "hd_210.x", 0xc0000, 0x10000, 0xa7fc3aaa )
	
	ROM_REGION( 0x10000, REGION_CPU2 )		/* dummy region for GSP 34010 */

	ROM_REGION( 0x10000, REGION_CPU3 )		/* dummy region for MSP 34010 */
	
	ROM_REGION( ADSP2100_SIZE, REGION_CPU4 )/* dummy region for ADSP 2100 */

	ROM_REGION( 0x20000, REGION_CPU5 )		/* 2*64k for audio 68000 code */
	ROM_LOAD_ODD ( "hd_s.45n", 0x00000, 0x08000, 0x54d6dd5f )
	ROM_LOAD_EVEN( "hd_s.70n", 0x00000, 0x08000, 0x0c77fab6 )

	ROM_REGION( 0x10000, REGION_CPU6 )		/* dummy region for audio 32010 */
	
	ROM_REGION( 0x60000, REGION_USER1 )		/* 384k for object ROM */
	ROM_LOAD_EVEN( "hd_dsp.10h", 0x00000, 0x10000, 0x1b77f171 )
	ROM_LOAD_ODD ( "hd_dsp.10k", 0x00000, 0x10000, 0xe50bec32 )
	ROM_LOAD_EVEN( "hd_dsp.10j", 0x20000, 0x10000, 0x998d3da2 )
	ROM_LOAD_ODD ( "hd_dsp.10l", 0x20000, 0x10000, 0xbc59a2b7 )
	
	ROM_REGION( 0x8000, REGION_USER2 )		/* 32k for I/O buffers */

	ROM_REGION( 0x80000, REGION_SOUND1 )	/* 4*128k for audio serial ROMs */
	ROM_LOAD_EVEN( "hd_s.65a", 0x00000, 0x10000, 0xa88411dc )
	ROM_LOAD_EVEN( "hd_s.55a", 0x20000, 0x10000, 0x071a4309 )
	ROM_LOAD_EVEN( "hd_s.45a", 0x40000, 0x10000, 0xebf391af )
	ROM_LOAD_EVEN( "hd_s.30a", 0x60000, 0x10000, 0xf46ef09c )
ROM_END


ROM_START( stunrun )
	ROM_REGION( 0x200000, REGION_CPU1)		/* 2MB for 68000 code */
	ROM_LOAD_EVEN( "sr_200.r", 0x00000, 0x10000, 0xe0ed54d8 )
	ROM_LOAD_ODD ( "sr_210.r", 0x00000, 0x10000, 0x3008bcf8 )
	ROM_LOAD_EVEN( "sr_200.s", 0x20000, 0x10000, 0x6acdeeaa )
	ROM_LOAD_ODD ( "sr_210.s", 0x20000, 0x10000, 0xe8b1262a )
	ROM_LOAD_EVEN( "sr_200.t", 0x40000, 0x10000, 0x41c4778c )
	ROM_LOAD_ODD ( "sr_210.t", 0x40000, 0x10000, 0x0d6c9b8f )
	ROM_LOAD_EVEN( "sr_200.u", 0x60000, 0x10000, 0x0ce849aa )
	ROM_LOAD_ODD ( "sr_210.u", 0x60000, 0x10000, 0x19bc7495 )
	ROM_LOAD_EVEN( "sr_200.v", 0x80000, 0x10000, 0x4f6d22c5 )
	ROM_LOAD_ODD ( "sr_210.v", 0x80000, 0x10000, 0xac6d4d4a )
	ROM_LOAD_EVEN( "sr_200.w", 0xa0000, 0x10000, 0x3f896aaf )
	ROM_LOAD_ODD ( "sr_210.w", 0xa0000, 0x10000, 0x47f010ad )

	ROM_REGION( 0x10000, REGION_CPU2 )		/* dummy region for GSP 34010 */

	ROM_REGION( ADSP2100_SIZE, REGION_CPU3 )/* dummy region for ADSP 2100 */

	ROM_REGION( 0x14000, REGION_CPU4 )		/* 64k for 6502 code */
	ROM_LOAD( "sr_snd.10c", 0x10000, 0x4000, 0x121ab09a )
	ROM_CONTINUE(           0x04000, 0xc000 )
	
	ROM_REGION( 0x60000, REGION_USER1 )		/* 384k for object ROM */
	ROM_LOAD_EVEN( "sr_dsp_9.10h", 0x00000, 0x10000, 0x0ebf8e58 )
	ROM_LOAD_ODD ( "sr_dsp_9.10k", 0x00000, 0x10000, 0xfb98abaf )
	ROM_LOAD_EVEN( "sr_dsp.10h",   0x20000, 0x10000, 0xbd5380bd )
	ROM_LOAD_ODD ( "sr_dsp.10k",   0x20000, 0x10000, 0xbde8bd31 )
	ROM_LOAD_EVEN( "sr_dsp.9h",    0x40000, 0x10000, 0x55a30976 )
	ROM_LOAD_ODD ( "sr_dsp.9k",    0x40000, 0x10000, 0xd4a9696d )

	ROM_REGION( 0x8000, REGION_USER2 )		/* 32k for I/O buffers */

	ROM_REGION( 0x100000, REGION_SOUND1 )	/* 256k for ADPCM samples */
...
ROM_START( stunrnp )
	...
	ROM_LOAD_EVEN( "sr_200.r", 0x00000, 0x10000, 0xe0ed54d8 )
	ROM_LOAD_ODD ( "sr_210.r", 0x00000, 0x10000, 0x3008bcf8 )
	ROM_LOAD_EVEN( "prog-hi0.s20", 0x20000, 0x10000, 0x0be15a99 )
	ROM_LOAD_ODD ( "prog-lo0.s21", 0x20000, 0x10000, 0x757c0840 )
	ROM_LOAD_EVEN( "prog-hi.t20",  0x40000, 0x10000, 0x49bcde9d )
	ROM_LOAD_ODD ( "prog-lo1.t21", 0x40000, 0x10000, 0x3bdafd89 )
	ROM_LOAD_EVEN( "sr_200.u", 0x60000, 0x10000, 0x0ce849aa )
	ROM_LOAD_ODD ( "sr_210.u", 0x60000, 0x10000, 0x19bc7495 )
	ROM_LOAD_EVEN( "sr_200.v", 0x80000, 0x10000, 0x4f6d22c5 )
	ROM_LOAD_ODD ( "sr_210.v", 0x80000, 0x10000, 0xac6d4d4a )
...
ROM_START( steeltal )
	ROM_REGION( 0x200000, REGION_CPU1 )		/* 2MB for 68000 code */
	ROM_LOAD_EVEN( "st_200.r", 0x00000, 0x10000, 0x31bf01a9 )
	ROM_LOAD_ODD ( "st_210.r", 0x00000, 0x10000, 0xb4fa2900 )
	ROM_LOAD_EVEN( "st_200.s", 0x20000, 0x10000, 0xc31ca924 )
	ROM_LOAD_ODD ( "st_210.s", 0x20000, 0x10000, 0x7802e86d )
	ROM_LOAD_EVEN( "st_200.t", 0x40000, 0x10000, 0x01ebc0c3 )
	ROM_LOAD_ODD ( "st_210.t", 0x40000, 0x10000, 0x1107499c )
	ROM_LOAD_EVEN( "st_200.u", 0x60000, 0x10000, 0x78e72af9 )
	ROM_LOAD_ODD ( "st_210.u", 0x60000, 0x10000, 0x420be93b )
	ROM_LOAD_EVEN( "st_200.v", 0x80000, 0x10000, 0x7eff9f8b )
	ROM_LOAD_ODD ( "st_210.v", 0x80000, 0x10000, 0x53e9fe94 )
	ROM_LOAD_EVEN( "st_200.w", 0xa0000, 0x10000, 0xd39e8cef )
	ROM_LOAD_ODD ( "st_210.w", 0xa0000, 0x10000, 0xb388bf91 )
	ROM_LOAD_EVEN( "st_200.x", 0xc0000, 0x10000, 0x9f047de7 )
	ROM_LOAD_ODD ( "st_210.x", 0xc0000, 0x10000, 0xf6b99901 )
	ROM_LOAD_EVEN( "st_200.y", 0xe0000, 0x10000, 0xdb62362e )
	ROM_LOAD_ODD ( "st_210.y", 0xe0000, 0x10000, 0xef517db7 )
	...
	ROM_REGION( 0x14000, REGION_CPU5 )		/* 64k for 6502 code */
	ROM_LOAD( "stsnd.1f", 0x10000, 0x4000, 0xc52d8218 )
	ROM_CONTINUE(         0x04000, 0xc000 )

	ROM_REGION( 0x10000, REGION_CPU6 )		/* 64k for DSP communications */
	ROM_LOAD( "stdspcom.5f",  0x00000, 0x10000, 0x4c645933 )
	
	ROM_REGION( 0x60000, REGION_USER1 )		/* 384k for object ROM */
	ROM_LOAD_EVEN( "stds3.2lm", 0x00000, 0x20000, 0x0a29db30 )
	ROM_LOAD_ODD ( "stds3.2t",  0x00000, 0x20000, 0xa5882384 )

	ROM_REGION( 0x8000, REGION_USER2 )		/* 32k for I/O buffers */

	ROM_REGION( 0x100000, REGION_SOUND1 )	/* 1MB for ADPCM samples */
...
ROM_START( steeltdb )
	ROM_REGION( 0x200000, REGION_CPU1 )		/* 2MB for 68000 code */
	ROM_LOAD_EVEN( "sta200r",    0x00000, 0x10000, 0x1e69690a )
	ROM_LOAD_ODD ( "sta210r",    0x00000, 0x10000, 0x3f6af83e )
	ROM_LOAD_EVEN( "xprog200.s", 0x20000, 0x10000, 0x0bdcd267 )
	ROM_LOAD_ODD ( "xprog210.s", 0x20000, 0x10000, 0x565786e9 )
	ROM_LOAD_EVEN( "st_200.t",   0x40000, 0x10000, 0x01ebc0c3 )
	ROM_LOAD_ODD ( "st_210.t",   0x40000, 0x10000, 0x1107499c )
	ROM_LOAD_EVEN( "st_200.u",   0x60000, 0x10000, 0x78e72af9 )
	ROM_LOAD_ODD ( "st_210.u",   0x60000, 0x10000, 0x420be93b )
...
ROM_START( racedriv )
	ROM_REGION( 0x200000, REGION_CPU1 )	/* 2MB for 68000 code */
	ROM_LOAD_ODD ( "077-3001", 0x00000, 0x10000, 0xc75373a4 )
	ROM_LOAD_EVEN( "077-3002", 0x00000, 0x10000, 0x78771253 )
	ROM_LOAD_ODD ( "077-2003", 0x20000, 0x10000, 0x8c36b745 )
	ROM_LOAD_EVEN( "077-2004", 0x20000, 0x10000, 0x4eb19582 )
	ROM_LOAD_ODD ( "077-2005", 0x40000, 0x10000, 0x71c0a770 )
	ROM_LOAD_EVEN( "077-2006", 0x40000, 0x10000, 0x07fd762e )
	ROM_LOAD_ODD ( "077-2007", 0x60000, 0x10000, 0x17903148 )
	ROM_LOAD_EVEN( "077-2008", 0x60000, 0x10000, 0x5144d31b )
	ROM_LOAD_ODD ( "077-2009", 0x80000, 0x10000, 0x1e9e4c31 )
	ROM_LOAD_EVEN( "077-2010", 0x80000, 0x10000, 0x8674e44e )
	ROM_LOAD_ODD ( "rd1011.bin", 0xa0000, 0x10000, 0xc5cd5491 )
	ROM_LOAD_EVEN( "rd1012.bin", 0xa0000, 0x10000, 0x9a78b952 )
	ROM_LOAD_ODD ( "rd1013.bin", 0xc0000, 0x10000, 0xca7b3e53 )
	ROM_LOAD_EVEN( "rd1014.bin", 0xc0000, 0x10000, 0xa872792a )
	ROM_LOAD_ODD ( "077-1015", 0xe0000, 0x10000, 0xc51f2702 )
	ROM_LOAD_EVEN( "077-1016", 0xe0000, 0x10000, 0xe83a9c99 )
	...
	ROM_REGION( 0x10000, REGION_CPU5 )		/* dummy region for DSP32 */
	
	ROM_REGION( 0x50000, REGION_CPU6 )		/* 2*64k for audio 68000 code */
	ROM_LOAD_ODD ( "rd1032.bin", 0x00000, 0x10000, 0x33005f2a )
	ROM_LOAD_EVEN( "rd1033.bin", 0x00000, 0x10000, 0x4fc800ac )

	ROM_REGION( 0x10000, REGION_CPU7 )		/* dummy region for audio 32010 */

	ROM_REGION( 0x60000, REGION_USER1 )		/* 384k for object ROM */
	ROM_LOAD_EVEN( "rd2021.bin", 0x00000, 0x10000, 0x8b2a98da )
	ROM_LOAD_ODD ( "rd2023.bin", 0x00000, 0x10000, 0xc6d83d38 )
	ROM_LOAD_EVEN( "rd2022.bin", 0x20000, 0x10000, 0xc0393c31 )
	ROM_LOAD_ODD ( "rd2024.bin", 0x20000, 0x10000, 0x1e2fb25f )

	ROM_REGION( 0x8000, REGION_USER2 )		/* 32k for I/O buffers */

	ROM_REGION( 0x31000, REGION_USER3 )		/* 128k for DSK ROMs + 64k for RAM + 4k for ZRAM */
	ROM_LOAD_EVEN( "rd1030.bin", 0x00000, 0x10000, 0x31a600db )
	ROM_LOAD_ODD ( "rd1031.bin", 0x00000, 0x10000, 0x059c410b )

	ROM_REGION( 0x120000, REGION_SOUND1 )	/* 10*128k for audio serial ROMs */
	ROM_LOAD_EVEN( "rd1123.bin", 0x00000, 0x10000, 0xa88411dc )
	ROM_LOAD_EVEN( "rd1124.bin", 0x20000, 0x10000, 0x071a4309 )
	ROM_LOAD_EVEN( "rd3125.bin", 0x40000, 0x10000, 0x856548ff )
	ROM_LOAD_EVEN( "rd1126.bin", 0x60000, 0x10000, 0xf46ef09c )
	ROM_LOAD_EVEN( "rd1017.bin",0x100000, 0x10000, 0xe93129a3 )
ROM_END


ROM_START( racedrvc )
	ROM_REGION( 0x200000, REGION_CPU1 )	/* 2MB for 68000 code */
	ROM_LOAD_ODD ( "rd2001.bin", 0x00000, 0x10000, 0x9312fd5f )
	ROM_LOAD_EVEN( "rd2002.bin", 0x00000, 0x10000, 0x669fe6fe )
	ROM_LOAD_ODD ( "rd1003.bin", 0x20000, 0x10000, 0x5131ee87 )
	ROM_LOAD_EVEN( "rd1004.bin", 0x20000, 0x10000, 0xf937ce55 )
	ROM_LOAD_ODD ( "rd1005.bin", 0x40000, 0x10000, 0x627c4294 )
	ROM_LOAD_EVEN( "rd1006.bin", 0x40000, 0x10000, 0xfe09241e )
	ROM_LOAD_ODD ( "rd1007.bin", 0x60000, 0x10000, 0x2517035a )
	ROM_LOAD_EVEN( "rd1008.bin", 0x60000, 0x10000, 0x0540d53d )
	ROM_LOAD_ODD ( "rd1009.bin", 0x80000, 0x10000, 0x33556cb5 )
	ROM_LOAD_EVEN( "rd1010.bin", 0x80000, 0x10000, 0x84329826 )
	ROM_LOAD_ODD ( "rd1011.bin", 0xa0000, 0x10000, 0xc5cd5491 )
	ROM_LOAD_EVEN( "rd1012.bin", 0xa0000, 0x10000, 0x9a78b952 )
	ROM_LOAD_ODD ( "rd1013.bin", 0xc0000, 0x10000, 0xca7b3e53 )
	ROM_LOAD_EVEN( "rd1014.bin", 0xc0000, 0x10000, 0xa872792a )
	ROM_LOAD_ODD ( "rd1015.bin", 0xe0000, 0x10000, 0x64dd6040 )
	ROM_LOAD_EVEN( "rd1016.bin", 0xe0000, 0x10000, 0xa2a0ed28 )
	...
	ROM_REGION( 0x20000, REGION_USER3 )		/* 128k for DSK ROMs */
	ROM_LOAD_EVEN( "rd1030.bin", 0x00000, 0x10000, 0x31a600db )
	ROM_LOAD_ODD ( "rd1031.bin", 0x00000, 0x10000, 0x059c410b )
...
ROM_START( hdrivair )
	ROM_REGION( 0x200000, REGION_CPU1 )		/* 2MB for 68000 code */
	ROM_LOAD_ODD ( "stestlo.bin", 0x000000, 0x20000, 0x58758419 )
	ROM_LOAD_EVEN( "stesthi.bin", 0x000000, 0x20000, 0xb4bfa451 )
	ROM_LOAD_ODD ( "drivelo.bin", 0x040000, 0x20000, 0x34adf4af )
	ROM_LOAD_EVEN( "drivehi.bin", 0x040000, 0x20000, 0xd15f5119 )
	ROM_LOAD_ODD ( "wavelo.bin",  0x0c0000, 0x20000, 0x15ed4394 )
	ROM_LOAD_EVEN( "wavehi.bin",  0x0c0000, 0x20000, 0xb21a34b6 )
	ROM_LOAD_ODD ( "ms2pics.lo",  0x140000, 0x20000, 0xc3c6be8c )
	ROM_LOAD_EVEN( "ms2pics.hi",  0x140000, 0x20000, 0xbca0af7e )
	ROM_LOAD_ODD ( "univlo.bin",  0x180000, 0x20000, 0x22d3b699 )
	ROM_LOAD_EVEN( "univhi.bin",  0x180000, 0x20000, 0x86351673 )
	ROM_LOAD_ODD ( "coproclo.bin",0x1c0000, 0x20000, 0x5f98b04d )
	ROM_LOAD_EVEN( "coprochi.bin",0x1c0000, 0x20000, 0x5d2ca109 )
	...
	ROM_REGION( 0x50000, REGION_CPU5 )		/* 5*64k for 32C010 code */

	ROM_REGION( 0x60000, REGION_USER1 )		/* 384k for object ROM */

	ROM_REGION( 0x8000, REGION_USER2 )		/* 32k for I/O buffers */

	ROM_REGION( 0x100000, REGION_USER3 )	/* unknown ROMs */
	ROM_LOAD_ODD ( "ds3rom0.bin", 0x00000, 0x80000, 0x90b8dbb6 )
	ROM_LOAD_EVEN( "ds3rom1.bin", 0x00000, 0x80000, 0x58173812 )
	ROM_LOAD_ODD ( "ds3rom2.bin", 0x00000, 0x80000, 0x5a4b18fa )
	ROM_LOAD_EVEN( "ds3rom3.bin", 0x00000, 0x80000, 0x63965868 )
	ROM_LOAD_ODD ( "ds3rom4.bin", 0x00000, 0x80000, 0x15ffb19a )
	ROM_LOAD_EVEN( "ds3rom5.bin", 0x00000, 0x80000, 0x8d0e9b27 )
	ROM_LOAD_ODD ( "ds3rom6.bin", 0x00000, 0x80000, 0xce7edbae )
	ROM_LOAD_EVEN( "ds3rom7.bin", 0x00000, 0x80000, 0x323eff0b )
	ROM_LOAD_ODD ( "dsk2plo.bin", 0x00000, 0x80000, 0xedf96363 )
	ROM_LOAD_EVEN( "dsk2phi.bin", 0x00000, 0x80000, 0x71c268e0 )
	ROM_LOAD_ODD ( "obj0l.bin",   0x00000, 0x20000, 0x1f835f2e )
	ROM_LOAD_EVEN( "obj0h.bin",   0x00000, 0x20000, 0xc321ab55 )
	ROM_LOAD_ODD ( "obj1l.bin",   0x00000, 0x20000, 0x3d65f264 )
	ROM_LOAD_EVEN( "obj1h.bin",   0x00000, 0x20000, 0x2c06b708 )
	ROM_LOAD_ODD ( "obj2l.bin",   0x00000, 0x20000, 0xb206cc7e )
	ROM_LOAD_EVEN( "obj2h.bin",   0x00000, 0x20000, 0xa666e98c )
	ROM_LOAD_ODD ( "roads0.bin",  0x00000, 0x80000, 0x5028eb41 )
	ROM_LOAD_EVEN( "roads1.bin",  0x00000, 0x80000, 0xc3f2c201 )
	ROM_LOAD_ODD ( "roads2.bin",  0x00000, 0x80000, 0x527923fe )
	ROM_LOAD_EVEN( "roads3.bin",  0x00000, 0x80000, 0x2f2023b2 )
...
ROM_START( hdrivaip )
	ROM_REGION( 0x200000, REGION_CPU1 )		/* 2MB for 68000 code */
	ROM_LOAD_ODD ( "stest.0l",    0x000000, 0x20000, 0xf462b511 )
	ROM_LOAD_EVEN( "stest.0h",    0x000000, 0x20000, 0xbf4bb6a0 )
	ROM_LOAD_ODD ( "drive.lo",    0x040000, 0x20000, 0x799e3138 )
	ROM_LOAD_EVEN( "drive.hi",    0x040000, 0x20000, 0x56571590 )
	ROM_LOAD_ODD ( "wave1.lo",    0x0c0000, 0x20000, 0x1a472475 )
	ROM_LOAD_EVEN( "wave1.hi",    0x0c0000, 0x20000, 0x63872d12 )
	ROM_LOAD_ODD ( "ms2pics.lo",  0x140000, 0x20000, 0xc3c6be8c )
	ROM_LOAD_EVEN( "ms2pics.hi",  0x140000, 0x20000, 0xbca0af7e )
	ROM_LOAD_ODD ( "ms2univ.lo",  0x180000, 0x20000, 0x7493bf60 )
	ROM_LOAD_EVEN( "ms2univ.hi",  0x180000, 0x20000, 0x59c91b15 )
	ROM_LOAD_ODD ( "ms2cproc.0l", 0x1c0000, 0x20000, 0x1e48bd46 )
	ROM_LOAD_EVEN( "ms2cproc.0h", 0x1c0000, 0x20000, 0x19024f2d )
	...
	ROM_REGION( 0x100000, REGION_USER3 )	/* unknown ROMs */
	ROM_LOAD_ODD ( "ds3rom.0",    0x00000, 0x80000, 0x90b8dbb6 )
	ROM_LOAD_EVEN( "ds3rom.1",    0x00000, 0x80000, 0x03673d8d )
	ROM_LOAD_ODD ( "ds3rom.2",    0x00000, 0x80000, 0xf67754e9 )
	ROM_LOAD_EVEN( "ds3rom.3",    0x00000, 0x80000, 0x008d3578 )
	ROM_LOAD_ODD ( "ds3rom.4",    0x00000, 0x80000, 0x6281efee )
	ROM_LOAD_EVEN( "ds3rom.5",    0x00000, 0x80000, 0x6ef9ed90 )
	ROM_LOAD_ODD ( "ds3rom.6",    0x00000, 0x80000, 0xcd4cd6bc )
	ROM_LOAD_EVEN( "ds3rom.7",    0x00000, 0x80000, 0x3d695e1f )
	ROM_LOAD_ODD ( "dskpics.lo",  0x00000, 0x80000, 0x8c6f0750 )
	ROM_LOAD_EVEN( "dskpics.hi",  0x00000, 0x80000, 0xeaa88101 )
	ROM_LOAD_ODD ( "objects.0l",  0x00000, 0x20000, 0x3c9e9078 )
	ROM_LOAD_EVEN( "objects.0h",  0x00000, 0x20000, 0x4480dbae )
	ROM_LOAD_ODD ( "objects.1l",  0x00000, 0x20000, 0x700bd978 )
	ROM_LOAD_EVEN( "objects.1h",  0x00000, 0x20000, 0xf613adaf )
	ROM_LOAD_ODD ( "objects.2l",  0x00000, 0x20000, 0xe3b512f0 )
	ROM_LOAD_EVEN( "objects.2h",  0x00000, 0x20000, 0x3f83742b )
	ROM_LOAD_ODD ( "roads.0",     0x00000, 0x80000, 0xcab2e335 )
	ROM_LOAD_EVEN( "roads.1",     0x00000, 0x80000, 0x62c244ba )
	ROM_LOAD_ODD ( "roads.2",     0x00000, 0x80000, 0xba57f415 )
	ROM_LOAD_EVEN( "roads.3",     0x00000, 0x80000, 0x1e6a4ca0 )

...
static ADDRESS_MAP_START( writemem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x040000, 0x04ffff) AM_WRITE(MWA16_RAM) AM_BASE(&rpunch_bitmapram) AM_SIZE(&rpunch_bitmapram_size)
...
ROM_START( rpunch )
	...
	ROM_REGION( 0x80000, REGION_GFX1, ROMREGION_ERASEFF )
	...
	ROM_REGION( 0x80000, REGION_GFX2, ROMREGION_ERASEFF )
	...
	ROM_REGION( 0x80000, REGION_GFX3, ROMREGION_ERASEFF )

...
ROM_START( rvschool )
	...
	ROM_REGION( 0x2480000, REGION_USER2 )
...
ROM_START( kikaioh )
	...
	ROM_REGION( 0x3080000, REGION_USER2 )
	ROM_LOAD_WIDE_SWAP( "kioj-04.bin", 0x0000000, 0x080000, 0x3a2a3bc8 )
	ROM_LOAD_WIDE_SWAP( "kio-05m.bin", 0x0080000, 0x800000, 0x98e9eb24 )
	ROM_LOAD_WIDE_SWAP( "kio-06m.bin", 0x0880000, 0x800000, 0xbe8d7d73 )
	ROM_LOAD_WIDE_SWAP( "kio-07m.bin", 0x1080000, 0x800000, 0xffd81f18 )
	ROM_LOAD_WIDE_SWAP( "kio-08m.bin", 0x1880000, 0x800000, 0x17302226 )
	ROM_LOAD_WIDE_SWAP( "kio-09m.bin", 0x2080000, 0x800000, 0xa34f2119 )
	ROM_LOAD_WIDE_SWAP( "kio-10m.bin", 0x2880000, 0x800000, 0x7400037a )
...
ROM_START( sfex )
	...
	ROM_REGION( 0x1880000, REGION_USER2 )
...
ROM_START( shiryu2 )
	...
	ROM_REGION( 0x2c80000, REGION_USER2 )
	ROM_LOAD_WIDE_SWAP( "hr2j-04.bin", 0x0000000, 0x080000, 0x0824ee5f )
	ROM_LOAD_WIDE_SWAP( "hr2-05m.bin", 0x0080000, 0x800000, 0x18716fe8 )
	ROM_LOAD_WIDE_SWAP( "hr2-06m.bin", 0x0880000, 0x800000, 0x6f13b69c )
	ROM_LOAD_WIDE_SWAP( "hr2-07m.bin", 0x1080000, 0x800000, 0x3925701b )
	ROM_LOAD_WIDE_SWAP( "hr2-08m.bin", 0x1880000, 0x800000, 0xd844c0dc )
	ROM_LOAD_WIDE_SWAP( "hr2-09m.bin", 0x2080000, 0x800000, 0xcdd43e6b )
	ROM_LOAD_WIDE_SWAP( "hr2-10m.bin", 0x2880000, 0x400000, 0xd95b3f37 )
...
ROM_START( tgmj )
	...
	ROM_REGION( 0x0880000, REGION_USER2 )
...
ROM_START( doapp )
	...
	ROM_LOAD_WIDE_SWAP( "mg-bios.bin",  0x0000000, 0x080000, 0x69ffbcb4 )

	ROM_REGION( 0x01a00000, REGION_USER2 )
	ROM_LOAD_EVEN(      "doapp119.bin", 0x0000000, 0x100000, 0xbbe04cef )
	ROM_LOAD_ODD(       "doapp120.bin", 0x0000000, 0x100000, 0xb614d7e6 )
	ROM_LOAD_WIDE_SWAP( "doapp-0.216",  0x0200000, 0x400000, 0xacc6c539 )
	ROM_LOAD_WIDE_SWAP( "doapp-1.217",  0x0600000, 0x400000, 0x14b961c4 )
	ROM_LOAD_WIDE_SWAP( "doapp-2.218",  0x0a00000, 0x400000, 0x134f698f )
	ROM_LOAD_WIDE_SWAP( "doapp-3.219",  0x0e00000, 0x400000, 0x1c6540f3 )
	ROM_LOAD_WIDE_SWAP( "doapp-4.220",  0x1200000, 0x400000, 0xf83bacf7 )
	ROM_LOAD_WIDE_SWAP( "doapp-5.221",  0x1600000, 0x400000, 0xe11e8b71 )
ROM_END
...
ROM_START( glpracr2 )
	...
	ROM_REGION( 0x02200000, REGION_USER2 )
	ROM_LOAD_EVEN(      "1.119",        0x0000000, 0x100000, 0x0fe2d2df )
	ROM_LOAD_ODD(       "1.120",        0x0000000, 0x100000, 0x8e3fb1c0 )
	ROM_LOAD_WIDE_SWAP( "gra2-0.217",   0x0200000, 0x400000, 0xa077ffa3 )
	ROM_LOAD_WIDE_SWAP( "gra2-1.218",   0x0600000, 0x400000, 0x28ce033c )
	ROM_LOAD_WIDE_SWAP( "gra2-2.219",   0x0a00000, 0x400000, 0x0c9cb7da )
	ROM_LOAD_WIDE_SWAP( "gra2-3.220",   0x0e00000, 0x400000, 0x264e3a0c )
	ROM_LOAD_WIDE_SWAP( "gra2-4.221",   0x1200000, 0x400000, 0x2b070307 )
	ROM_LOAD_WIDE_SWAP( "gra2-5.222",   0x1600000, 0x400000, 0x94a363c1 )
	ROM_LOAD_WIDE_SWAP( "gra2-6.223",   0x1a00000, 0x400000, 0x8c6b4c4c )
	ROM_LOAD_WIDE_SWAP( "gra2-7.323",   0x1e00000, 0x400000, 0x7dfb6c54 )
ROM_END
...
ROM_START( sncwgltd )
	...
	ROM_REGION( 0x080000, REGION_USER1 )
	ROM_LOAD_WIDE_SWAP( "kn-bios.bin",  0x0000000, 0x080000, 0x5ff165f3 )

	ROM_REGION( 0x01a80000, REGION_USER2 )
	ROM_LOAD_WIDE_SWAP( "ic5.bin",      0x0000000, 0x080000, 0x458f14aa )
	ROM_LOAD_WIDE_SWAP( "ic6.bin",      0x0080000, 0x080000, 0x8233dd1e )
	ROM_LOAD_WIDE_SWAP( "ic7.bin",      0x0100000, 0x080000, 0xdf5ba2f7 )
	ROM_LOAD_WIDE_SWAP( "ic8.bin",      0x0180000, 0x080000, 0xe8145f2b )
	ROM_LOAD_WIDE_SWAP( "ic9.bin",      0x0200000, 0x080000, 0x605c9370 )
	ROM_LOAD_WIDE_SWAP( "ic11.bin",     0x0280000, 0x400000, 0xa93f6fee )
	ROM_LOAD_WIDE_SWAP( "ic12.bin",     0x0680000, 0x400000, 0x9f584ef7 )
	ROM_LOAD_WIDE_SWAP( "ic13.bin",     0x0a80000, 0x400000, 0x652e9c78 )
	ROM_LOAD_WIDE_SWAP( "ic14.bin",     0x0e80000, 0x400000, 0xc4ef1424 )
	ROM_LOAD_WIDE_SWAP( "ic15.bin",     0x1280000, 0x400000, 0x2551d816 )
	ROM_LOAD_WIDE_SWAP( "ic16.bin",     0x1680000, 0x400000, 0x21b401bc )
ROM_END

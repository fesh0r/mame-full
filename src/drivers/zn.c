...
static ADDRESS_MAP_START( zn_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x1f000000, 0x1f3fffff) AM_ROM AM_REGION(REGION_USER3, 0) /* game rom */
...
#define CPZN1_BIOS \
	...
	ROM_LOAD( "coh1002c.bin", 0x0000000, 0x080000, CRC(50033af6) SHA1(486d92ff6c7f1e54f8e0ef41cd9116eca0e10e1a) )
...
ROM_START( glpracr )
	...
	ROM_REGION32_LE( 0x0c00000, REGION_USER3, 0 )
...
ROM_START( rvschool )
	...
	ROM_REGION32_LE( 0x2400000, REGION_USER3, 0 )
...
ROM_START( sfexp )
	...
	ROM_REGION32_LE( 0x1880000, REGION_USER3, 0 )
...
ROM_START( starglad )
	...
	ROM_REGION32_LE( 0x0800000, REGION_USER3, 0 )
...
ROM_START( ts2 )
	...
	ROM_REGION32_LE( 0x0e00000, REGION_USER3, 0 )
...
#define CPZN2_BIOS \
	ROM_REGION( 0x080000, REGION_USER1, 0 ) \
	ROM_LOAD( "coh3002c.bin", 0x0000000, 0x080000, CRC(e860ea8b) SHA1(66e7e1d4e426466b8f48a2ba055a91b475569504) )
...
ROM_START( techromn )
	...
	ROM_REGION32_LE( 0x3000000, REGION_USER3, 0 )
...
ROM_START( strider2 )
	...
	ROM_REGION32_LE( 0x80000, REGION_USER2, 0 )
	ROM_LOAD( "hr2a-04.bin",   0x000000, 0x080000, CRC(56ff9394) SHA1(fe8417965d945210ac098c6678c02f1c678bd13b) )

	ROM_REGION32_LE( 0x2c00000, REGION_USER3, 0 )
...
#define TPS_BIOS \
	ROM_REGION( 0x080000, REGION_USER1, 0 ) \
	ROM_LOAD( "coh1002m.bin", 0x0000000, 0x080000, CRC(69ffbcb4) SHA1(03eb2febfab3fcde716defff291babd9392de965) )
...
ROM_START( doapp )
	...
	ROM_REGION32_LE( 0x01a00000, REGION_USER2, 0 )
...
ROM_START( glpracr2 )
	...
	ROM_REGION32_LE( 0x02200000, REGION_USER2, 0 )
...
ROM_START( tondemo )
	...
	ROM_REGION32_LE( 0x01600000, REGION_USER2, 0 )
...
#define KN_BIOS \
	ROM_REGION( 0x080000, REGION_USER1, 0 ) \
	ROM_LOAD( "coh1002v.bin", 0x0000000, 0x080000, CRC(5ff165f3) SHA1(8f59314c1093446b9bcb06d232244da6df78e206) )
...
#define TAITOFX1_BIOS \
	ROM_REGION( 0x080000, REGION_USER1, 0 ) \
	ROM_LOAD( "coh1002t.bin", 0x0000000, 0x080000, CRC(e3f23b6e) SHA1(e18907cf8c6ba54d96edba0a9a00487a90219e0d) )
...
#define TAITOGNET_BIOS \
	ROM_REGION( 0x080000, REGION_USER1, 0 ) \
	ROM_LOAD( "coh3002t.353", 0x0000000, 0x080000, CRC(03967fa7) SHA1(0e17fec2286e4e25deb23d40e41ce0986f373d49) )
...
#define PSARC95_BIOS \
	ROM_REGION( 0x080000, REGION_USER1, 0 ) \
	ROM_LOAD( "coh1002e.bin", 0x0000000, 0x080000, NO_DUMP )
...
#define AC_BIOS \
	ROM_REGION( 0x080000, REGION_USER1, 0 ) \
	ROM_LOAD( "coh1000a.bin", 0x0000000, 0x080000, CRC(8d8d0764) SHA1(7ee83d317190bb1cef2f8f01c81eaaae47150ebb) )

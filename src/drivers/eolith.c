/********************************************************************
	Preliminary Hyperstone based Eolith games driver
...
#define XSIZE 0xa8
	...
	for(y=0;y<200;y++)
		for(x=0;x<XSIZE;x+=2)
		{
			plot_pixel(bitmap,x,y,(eo_vram[y*XSIZE+(x/2)]>>16)&0x7fff);
			plot_pixel(bitmap,x+1,y,eo_vram[y*XSIZE+(x/2)]&0x7fff);
		}
...
ROM_START( hidnctch )
	...
	ROM_LOAD32_WORD( "hc0_u39.bin", 0x0000000, 0x400000, CRC(eefb6add) SHA1(a0f6f2cf86699a666be0647274d8c9381782640d) )
	ROM_LOAD32_WORD( "hc1_u34.bin", 0x0000002, 0x400000, CRC(482f3e52) SHA1(7a527c6af4c80e10cc25219a04ccf7c7ea1b23af) )
	ROM_LOAD32_WORD( "hc2_u40.bin", 0x0800000, 0x400000, CRC(914a1544) SHA1(683cb007ace50d1ba88253da6ad71dc3a395299d) )
	ROM_LOAD32_WORD( "hc3_u35.bin", 0x0800002, 0x400000, CRC(80c59133) SHA1(66ca4c2c014c4a1c87c46a3971732f0a2be95408) )
	ROM_LOAD32_WORD( "hc4_u41.bin", 0x1000000, 0x400000, CRC(9a9e2203) SHA1(a90f5842b63696753e6c16114b1893bbeb91e45c) )
	ROM_LOAD32_WORD( "hc5_u36.bin", 0x1000002, 0x400000, CRC(74b1719d) SHA1(fe2325259117598ad7c23217426ac9c28440e3a0) )
	...
	ROM_LOAD( "hc_u107.bin", 0x0000, 0x8000, CRC(afd5263d) SHA1(71ace1b749d8a6b84d08b97185e7e512d04e4b8d) ) // same in landbrk
...
ROM_START( landbrk )
	...
	ROM_REGION( 0x2000000, REGION_GFX1, 0 ) /* GFX (not tile based) */
	ROM_LOAD16_BYTE( "lb2-000.u39", 0x0000001, 0x400000, CRC(b37faf7a) SHA1(30e9af3957ada7c72d85f55add221c2e9b3ea823) )
	ROM_LOAD16_BYTE( "lb2-001.u34", 0x0000000, 0x400000, CRC(07e620c9) SHA1(19f95316208fb4e52cef78f18c5d93460a644566) )
	ROM_LOAD16_BYTE( "lb2-002.u40", 0x0800001, 0x400000, CRC(3bb4bca6) SHA1(115029be4a4e322549a35f3ae5093ec161e9a421) )
	ROM_LOAD16_BYTE( "lb2-003.u35", 0x0800000, 0x400000, CRC(28ce863a) SHA1(1ba7d8be0ed4459dbdf99df18a2ad817904b9f04) )
	ROM_LOAD16_BYTE( "lb2-004.u41", 0x1000001, 0x400000, CRC(cbe84b06) SHA1(52505939fb88cd24f409c795fe5ceed5b41a52c2) )
	ROM_LOAD16_BYTE( "lb2-005.u36", 0x1000000, 0x400000, CRC(350c77a3) SHA1(231e65ea7db19019615a8aa4444922bcd5cf9e5c) )
	ROM_LOAD16_BYTE( "lb2-006.u42", 0x1800001, 0x400000, CRC(22c57cd8) SHA1(c9eb745523005876395ff7f0b3e996994b3f1220) )
	ROM_LOAD16_BYTE( "lb2-007.u37", 0x1800000, 0x400000, CRC(31f957b3) SHA1(ab1c4c50c2d5361ba8db047feb714423d84e6df4) )
...
ROM_START( raccoon )
	...
	ROM_REGION( 0x2000000, REGION_GFX1, 0 ) /* GFX (not tile based) */
	ROM_LOAD16_BYTE( "racoon.u1",  0x0000001, 0x200000, CRC(49775125) SHA1(2b8ee9dd767465999c828d65bb02b8aaad94177c) )
	ROM_LOAD16_BYTE( "racoon.u10", 0x0000000, 0x200000, CRC(f702390e) SHA1(47520ba0e6d3f044136a517ebbec7426a66ce33d) )
	ROM_LOAD16_BYTE( "racoon.u2",  0x0800001, 0x200000, CRC(1eb00529) SHA1(d9af75e116f5237a3c6812538b77155b9c08dd5c) )
	ROM_LOAD16_BYTE( "racoon.u11", 0x0800000, 0x200000, CRC(3f23f368) SHA1(eb1ea51def2cde5e7e4f334888294b794aa03dfc) )
	ROM_LOAD16_BYTE( "racoon.u5",  0x1000001, 0x200000, CRC(5fbac174) SHA1(1d3e3f40a737d61ff688627891dec183af7fa19a) )
	ROM_LOAD16_BYTE( "racoon.u14", 0x1000000, 0x200000, CRC(870fe45e) SHA1(f8d800b92eb1ee9ef4663319fd3cb1f5e52d0e72) )
...
GAMEX( 19??, hidnctch, 0, eolith, eolith, eolith, ROT0, "Eolith", "Hidden Catch",  GAME_NO_SOUND | GAME_NOT_WORKING )
GAMEX( 19??, landbrk,  0, eolith, eolith, eolith, ROT0, "Eolith", "Land Breaker",  GAME_NO_SOUND | GAME_NOT_WORKING )
GAMEX( 19??, raccoon,  0, eolith, eolith, eolith, ROT0, "Eolith", "Raccoon World", GAME_NO_SOUND | GAME_NOT_WORKING )

...
ROM_START( bradley )
	ROM_REGION( 0x10000, REGION_CPU1, 0 )	/* 64k for code */
	ROM_LOAD( "btc1.bin",   0x4000, 0x0800, 0x0bb8e049 )
	ROM_LOAD( "btd1.bin",   0x4800, 0x0800, 0x9e0566d4 )
	ROM_LOAD( "bte1.bin",   0x5000, 0x0800, 0x64ee6a42 )
	ROM_LOAD( "bth1.bin",   0x5800, 0x0800, 0xbaab67be )
	ROM_LOAD( "btj1.bin",   0x6000, 0x0800, 0x036adde4 )
	ROM_LOAD( "btk1.bin",   0x6800, 0x0800, 0xf5c2904e )
	ROM_LOAD( "btlm.bin",   0x7000, 0x0800, 0x7d0313bf )
	ROM_LOAD( "btn1.bin",   0x7800, 0x0800, 0x182c8c64 )
	ROM_RELOAD(             0xf800, 0x0800 )	/* for reset/interrupt vectors */
	/* Mathbox ROMs */
	ROM_LOAD( "btb3.bin",   0x3000, 0x0800, 0x88206304 )
	ROM_LOAD( "bta3.bin",   0x3800, 0x0800, 0xd669d796 )
ROM_END

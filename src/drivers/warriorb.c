...
INPUT_PORTS_START( warriorb )
	...
	/* IN0 */
	WARRIORB_SYSTEM_INPUT
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_CHEAT PORT_PLAYER(1)	/* Japanese version actually doesn't */
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_CHEAT PORT_PLAYER(2)	/* have the third button */

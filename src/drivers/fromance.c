...
#define FROMANCE_KEYMATRIX2 \
	...
	PORT_BIT(0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Bet") PORT_CODE(KEYCODE_2) \
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN ) \
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN ) \
...
#define FROMANCE_KEYMATRIX5 \
	...
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Flip") PORT_CODE(KEYCODE_X) \
...
INPUT_PORTS_START( idolmj )
	...
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_SERVICE ) PORT_NAME( DEF_STR( Service_Mode )) PORT_CODE(KEYCODE_F2)	// TEST
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )

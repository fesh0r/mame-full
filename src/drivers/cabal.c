...
*/
	...
	PORT_BIT( 0,         0x0000, IPT_DIPSWITCH_SETTING ) PORT_NAME("121") PORT_CHEAT
	...
	PORT_START
	PORT_BIT( 0x0fff, 0x0000, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(30) PORT_PLAYER(1)

	PORT_START
	PORT_BIT( 0x0fff, 0x0000, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(30) PORT_REVERSE PORT_PLAYER(1)

	PORT_START
	PORT_BIT( 0x0fff, 0x0000, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(30) PORT_PLAYER(2)

	PORT_START
	PORT_BIT( 0x0fff, 0x0000, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(30) PORT_PLAYER(2)
INPUT_PORTS_END

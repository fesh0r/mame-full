...
INPUT_PORTS_START( moonwar )
	...
	PORT_BIT( 0xff, 0x00, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10) PORT_CENTER

	PORT_START
	PORT_BIT( 0xff, 0x00, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10) PORT_CENTER PORT_COCKTAIL
INPUT_PORTS_END
...
INPUT_PORTS_START( darkplnt )
	...
	PORT_DIPSETTING(    0x00, "3" )
	PORT_DIPSETTING(    0x02, "5" )
	PORT_BIT( 0xfc, 0x00, IPT_DIAL ) PORT_MINMAX(0,0) PORT_SENSITIVITY(25) PORT_KEYDELTA(10)	/* scrambled dial */
...
INPUT_PORTS_START( losttomb )
	...
	PORT_DIPSETTING(    0x02, "5" )
	PORT_DIPSETTING(    0x03, DEF_STR( Free_Play ) )
	PORT_BIT( 0,       0x00, IPT_DIPSWITCH_SETTING ) PORT_NAME("Invulnerability") PORT_CHEAT
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_UP ) PORT_8WAY
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_DOWN ) PORT_8WAY
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_RIGHT) PORT_8WAY
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_LEFT ) PORT_8WAY
...
INPUT_PORTS_START( hustler )
	...
	PORT_BIT(    0x02, 0x00, IPT_DIPSWITCH_NAME ) PORT_NAME("Infinite Lives") PORT_CHEAT
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x02, DEF_STR( On ) )
...
INPUT_PORTS_START( mimonkey )
	...
	PORT_DIPSETTING(    0x08, DEF_STR( Cocktail ) )
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_8WAY
	PORT_BIT(    0x20, 0x00, IPT_DIPSWITCH_NAME ) PORT_NAME("Infinite Lives") PORT_CHEAT
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )

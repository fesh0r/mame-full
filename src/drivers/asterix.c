...
static ADDRESS_MAP_START( readmem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x100000, 0x107fff) AM_READ(MRA16_RAM)			// Main RAM.
	AM_RANGE(0x180000, 0x1807ff) AM_READ(K053245_word_r)		// Sprites
	AM_RANGE(0x180800, 0x180fff) AM_READ(MRA16_RAM)
	AM_RANGE(0x200000, 0x20000f) AM_READ(K053244_word_r)
	AM_RANGE(0x280000, 0x280fff) AM_READ(MRA16_RAM)
	AM_RANGE(0x300000, 0x30001f) AM_READ(K053244_lsb_r)
...
static ADDRESS_MAP_START( writemem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x180000, 0x1807ff) AM_WRITE(K053245_word_w)
	AM_RANGE(0x180800, 0x180fff) AM_WRITE(MWA16_RAM)	// extra RAM, or mirror for the above?
	AM_RANGE(0x200000, 0x20000f) AM_WRITE(K053244_word_w)
	AM_RANGE(0x280000, 0x280fff) AM_WRITE(paletteram16_xBBBBBGGGGGRRRRR_word_w) AM_BASE(&paletteram16)
	AM_RANGE(0x300000, 0x30001f) AM_WRITE(K053244_lsb_w)
	AM_RANGE(0x380100, 0x380101) AM_WRITE(control2_w)
	AM_RANGE(0x380200, 0x380203) AM_WRITE(K053260_0_lsb_w)

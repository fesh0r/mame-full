...
INPUT_PORTS_START( mayumi )
	...
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P1 Chii") PORT_CODE(KEYCODE_SPACE)
	...
	PORT_START	/* P2 IN0 (7) */ \
	PORT_BIT(0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 A")
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 E")
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 I")
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 M")
	PORT_BIT(0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Kan")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START2 )
	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* P2 IN1 (8) */
	PORT_BIT(0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 B")
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 F")
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 J")
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 N")
	PORT_BIT(0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Reach")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* P2 IN2 (9) */
	PORT_BIT(0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 C")
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 G")
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 K")
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Chii")
	PORT_BIT(0x02, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Ron")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START	/* P2 IN3 (10) */
	PORT_BIT(0x20, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 D")
	PORT_BIT(0x10, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 H")
	PORT_BIT(0x08, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 L")
	PORT_BIT(0x04, IP_ACTIVE_LOW, 0 ) PORT_NAME("P2 Pon")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN )
	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED )

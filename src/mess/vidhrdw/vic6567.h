...
extern void vic6567_init(int(*dma_read)(int),int(*dma_read_color)(int),
			 void(*irq)(int));
extern void vic6569_init(int(*dma_read)(int),int(*dma_read_color)(int),
			 void(*irq)(int));
...
extern void vic2_port_w(int offset, int data);
/* to be called when reading from port */
extern int vic2_port_r(int offset);

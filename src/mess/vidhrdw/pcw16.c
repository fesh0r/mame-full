...
{
	char *pScanLine = pcw16_ram + 0x0fc00;	//0x03c00;	//0x020FC00;
	...
	else
	{
		...
		for (y=0; y<PCW16_DISPLAY_HEIGHT; y++)
		{
			...
			plot_pixel(bitmap, 0, plot_y, border_colour_loc);
			plot_pixel(bitmap, 1, plot_y, border_colour_loc);
			plot_pixel(bitmap, 2, plot_y, border_colour_loc);
			plot_pixel(bitmap, 3, plot_y, border_colour_loc);
			plot_pixel(bitmap, 4, plot_y, border_colour_loc);
			plot_pixel(bitmap, 5, plot_y, border_colour_loc);
			plot_pixel(bitmap, 6, plot_y, border_colour_loc);
			plot_pixel(bitmap, 7, plot_y, border_colour_loc);

			plot_pixel(bitmap, (PCW16_DISPLAY_WIDTH+PCW16_BORDER_WIDTH), plot_y, border_colour_loc);
			plot_pixel(bitmap, (PCW16_DISPLAY_WIDTH+PCW16_BORDER_WIDTH)+1, plot_y, border_colour_loc);
			plot_pixel(bitmap, (PCW16_DISPLAY_WIDTH+PCW16_BORDER_WIDTH)+2, plot_y, border_colour_loc);
			plot_pixel(bitmap, (PCW16_DISPLAY_WIDTH+PCW16_BORDER_WIDTH)+3, plot_y, border_colour_loc);
			plot_pixel(bitmap, (PCW16_DISPLAY_WIDTH+PCW16_BORDER_WIDTH)+4, plot_y, border_colour_loc);
			plot_pixel(bitmap, (PCW16_DISPLAY_WIDTH+PCW16_BORDER_WIDTH)+5, plot_y, border_colour_loc);
			plot_pixel(bitmap, (PCW16_DISPLAY_WIDTH+PCW16_BORDER_WIDTH)+6, plot_y, border_colour_loc);
			plot_pixel(bitmap, (PCW16_DISPLAY_WIDTH+PCW16_BORDER_WIDTH)+7, plot_y, border_colour_loc);
		}
		...
		for (y=0; y<PCW16_DISPLAY_HEIGHT; y++)
		{
			...
			/* get line address */
			ScanLineAddr = pScanLine[0] | (pScanLine[1]<<8);

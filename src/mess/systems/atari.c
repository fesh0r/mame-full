...
INPUT_PORTS_START( a5200 )
	...
	PORT_START	/* IN8 analog in #1 */
	PORT_ANALOG(0xff, 0x80, IPT_AD_STICK_X | IPF_PLAYER1, 30, 10, 0, 0x10, 0xf0)

	PORT_START	/* IN9 analog in #2 */
	PORT_ANALOG(0xff, 0x80, IPT_AD_STICK_Y | IPF_PLAYER1, 30, 10, 0, 0x10, 0xf0)

	PORT_START	/* IN10 analog in #3 */
	PORT_ANALOG(0xff, 0x80, IPT_AD_STICK_X | IPF_PLAYER2, 30, 10, 0, 0x10, 0xf0)

	PORT_START	/* IN11 analog in #4 */
	PORT_ANALOG(0xff, 0x80, IPT_AD_STICK_Y | IPF_PLAYER2, 30, 10, 0, 0x10, 0xf0)

	PORT_START	/* IN12 analog in #5 */
	PORT_ANALOG(0xff, 0x80, IPT_AD_STICK_X | IPF_PLAYER3, 30, 10, 0, 0x10, 0xf0)

	PORT_START	/* IN13 analog in #6 */
	PORT_ANALOG(0xff, 0x80, IPT_AD_STICK_Y | IPF_PLAYER3, 30, 10, 0, 0x10, 0xf0)

	PORT_START	/* IN14 analog in #7 */
	PORT_ANALOG(0xff, 0x80, IPT_AD_STICK_X | IPF_PLAYER4, 30, 10, 0, 0x10, 0xf0)

	PORT_START	/* IN15 analog in #8 */
	PORT_ANALOG(0xff, 0x80, IPT_AD_STICK_Y | IPF_PLAYER4, 30, 10, 0, 0x10, 0xf0)
INPUT_PORTS_END

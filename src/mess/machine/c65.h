...
#define C65_KEY_STOP (input_port_13_r(0)&0x8000)
#define C65_KEY_ESCAPE (input_port_13_r(0)&0x4000)
#define C65_KEY_ALT (input_port_13_r(0)&0x2000)
#define C65_KEY_DIN (input_port_13_r(0)&0x1000)
#define C65_KEY_NOSCRL (input_port_13_r(0)&0x0800)
#define C65_KEY_F1 (input_port_13_r(0)&0x0400)
#define C65_KEY_F3 (input_port_13_r(0)&0x0200)
#define C65_KEY_F5 (input_port_13_r(0)&0x0100)
#define C65_KEY_F7 (input_port_13_r(0)&0x0080)
#define C65_KEY_F9 (input_port_13_r(0)&0x0040)
#define C65_KEY_F11 (input_port_13_r(0)&0x0020)

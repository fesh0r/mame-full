...
enum {
	...
	SH2_R8, SH2_R9, SH2_R10, SH2_R11, SH2_R12, SH2_R13, SH2_R14, SH2_EA
};
...
extern unsigned sh2_get_pc (void);			  /* Get program counter */
extern void sh2_set_pc (unsigned val);		  /* Set program counter */
extern unsigned sh2_get_sp (void);			  /* Get stack pointer */
extern void sh2_set_sp (unsigned val);		  /* Set stack pointer */

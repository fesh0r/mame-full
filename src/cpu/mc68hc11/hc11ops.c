...
{
	UINT16 r = hc11.a + hc11.b;
	CLEAR_HNZVC();
	SET_H(r, hc11.b, hc11.a);
	SET_N8(r);
	SET_Z8(r);
	SET_V_ADD8(r, hc11.b, hc11.a);
	SET_C8(r);
	hc11.a = (UINT8)r;
	CYCLES(2);
}

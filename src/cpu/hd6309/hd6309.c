...
int hd6309_execute(int cycles)	/* NS 970908 */
{
	...
	else
	{
		do
		{
			...
			{
				static void (* opcode_table[256])(void) =
				{
					neg_di,  oim_di,  aim_di,  com_di,  lsr_di,  eim_di,  ror_di,  asr_di,
					asl_di,  rol_di,  dec_di,  tim_di,  inc_di,  tst_di,  jmp_di,  clr_di,
					pref10,  pref11,  nop,     sync,    sexw,    illegl2, lbra,    lbsr,
					illegl2, daa,     orcc,    illegl2, andcc,   sex,     exg,     tfr,
					bra,     brn,     bhi,     bls,     bcc,     bcs,     bne,     beq,
					bvc,     bvs,     bpl,     bmi,     bge,     blt,     bgt,     ble,
					leax,    leay,    leas,    leau,    pshs,    puls,    pshu,    pulu,
					illegl2, rts,     abx,     rti,     cwai,    mul,     illegl2, swi,
					nega,    illegl2, illegl2, coma,    lsra,    illegl2, rora,    asra,
					asla,    rola,    deca,    illegl2, inca,    tsta,    illegl2, clra,
					negb,    illegl2, illegl2, comb,    lsrb,    illegl2, rorb,    asrb,
					aslb,    rolb,    decb,    illegl2, incb,    tstb,    illegl2, clrb,
					neg_ix,  oim_ix,  aim_ix,  com_ix,  lsr_ix,  eim_ix,  ror_ix,  asr_ix,
					asl_ix,  rol_ix,  dec_ix,  tim_ix,  inc_ix,  tst_ix,  jmp_ix,  clr_ix,
					neg_ex,  oim_ex,  aim_ex,  com_ex,  lsr_ex,  eim_ex,  ror_ex,  asr_ex,
					asl_ex,  rol_ex,  dec_ex,  tim_ex,  inc_ex,  tst_ex,  jmp_ex,  clr_ex,
					suba_im, cmpa_im, sbca_im, subd_im, anda_im, bita_im, lda_im,  illegl2,
					eora_im, adca_im, ora_im,  adda_im, cmpx_im, bsr,     ldx_im,  illegl2,
					...
					subb_im, cmpb_im, sbcb_im, addd_im, andb_im, bitb_im, ldb_im,  illegl2,
					eorb_im, adcb_im, orb_im,  addb_im, ldd_im,  ldq_im /* in m6809 was std_im */, ldu_im, illegl2,

...
static  byte    first_fdc_access = 1;
static  byte    motor_drive = 0;                /* currently running drive */
static  short   motor_count = 0;                /* time out for motor in frames */
static  byte    tracks[4] = {0, };              /* total tracks count per drive */
static  byte    heads[4] = {0, };               /* total heads count per drive */
static  byte    s_p_t[4] = {0, };               /* sector per track count per drive */
static  byte    track[4] = {0, };               /* current track per drive */
static  byte    head[4] = {0, };                /* current head per drive */
static  byte    sector[4] = {0, };              /* current sector per drive */

...
extern UINT8 * 	CD_info_ptr;			// info transfer buffer pointer
...
extern UINT8	cdb_sat_file_info[254 * 12];	// current file info
extern UINT8 cdb_sat_subq[5 * 2];		// current subcode q
extern UINT8 cdb_sat_subrw[12 * 2];		// current subcode r~w
extern UINT8 CD_sat_subq[5 * 2];			// current subcode q
extern UINT8 CD_sat_subrw[12 * 2];		// current subcode r~w
...
extern UINT8	CD_sat_toc[408];	// current cdrom toc

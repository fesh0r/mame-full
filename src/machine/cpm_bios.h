...
typedef struct {
	word xlat;				/* sector translation table */
	word scr1;				/* scratch memory 1 		*/
	word scr2;				/* scratch memory 2 		*/
	word scr3;				/* scratch memory 3 		*/
	word dirbuf;			/* directory buffer 		*/
	word dpb;				/* drive parameter block	*/
	word csv;				/* check sector vector		*/
	word alv;				/* allocation vector		*/
} cpm_dph;
